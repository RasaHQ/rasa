...
_SAMPLINGSTRATEGYTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='RATE_LIMITING', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_PROBABILISTICSAMPLINGSTRATEGY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='samplingRate', full_name='jaeger.api_v2.ProbabilisticSamplingStrategy.samplingRate', index=0,
...
_RATELIMITINGSAMPLINGSTRATEGY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='maxTracesPerSecond', full_name='jaeger.api_v2.RateLimitingSamplingStrategy.maxTracesPerSecond', index=0,
...
_OPERATIONSAMPLINGSTRATEGY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='operation', full_name='jaeger.api_v2.OperationSamplingStrategy.operation', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='probabilisticSampling', full_name='jaeger.api_v2.OperationSamplingStrategy.probabilisticSampling', index=1,
...
_PEROPERATIONSAMPLINGSTRATEGIES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='defaultSamplingProbability', full_name='jaeger.api_v2.PerOperationSamplingStrategies.defaultSamplingProbability', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='defaultLowerBoundTracesPerSecond', full_name='jaeger.api_v2.PerOperationSamplingStrategies.defaultLowerBoundTracesPerSecond', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='perOperationStrategies', full_name='jaeger.api_v2.PerOperationSamplingStrategies.perOperationStrategies', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='defaultUpperBoundTracesPerSecond', full_name='jaeger.api_v2.PerOperationSamplingStrategies.defaultUpperBoundTracesPerSecond', index=3,
...
_SAMPLINGSTRATEGYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='strategyType', full_name='jaeger.api_v2.SamplingStrategyResponse.strategyType', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='probabilisticSampling', full_name='jaeger.api_v2.SamplingStrategyResponse.probabilisticSampling', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rateLimitingSampling', full_name='jaeger.api_v2.SamplingStrategyResponse.rateLimitingSampling', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='operationSampling', full_name='jaeger.api_v2.SamplingStrategyResponse.operationSampling', index=3,
...
_SAMPLINGSTRATEGYPARAMETERS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='serviceName', full_name='jaeger.api_v2.SamplingStrategyParameters.serviceName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OPERATIONSAMPLINGSTRATEGY.fields_by_name['probabilisticSampling'].message_type = _PROBABILISTICSAMPLINGSTRATEGY
_PEROPERATIONSAMPLINGSTRATEGIES.fields_by_name['perOperationStrategies'].message_type = _OPERATIONSAMPLINGSTRATEGY
_SAMPLINGSTRATEGYRESPONSE.fields_by_name['strategyType'].enum_type = _SAMPLINGSTRATEGYTYPE
_SAMPLINGSTRATEGYRESPONSE.fields_by_name['probabilisticSampling'].message_type = _PROBABILISTICSAMPLINGSTRATEGY
_SAMPLINGSTRATEGYRESPONSE.fields_by_name['rateLimitingSampling'].message_type = _RATELIMITINGSAMPLINGSTRATEGY
_SAMPLINGSTRATEGYRESPONSE.fields_by_name['operationSampling'].message_type = _PEROPERATIONSAMPLINGSTRATEGIES
DESCRIPTOR.message_types_by_name['ProbabilisticSamplingStrategy'] = _PROBABILISTICSAMPLINGSTRATEGY
DESCRIPTOR.message_types_by_name['RateLimitingSamplingStrategy'] = _RATELIMITINGSAMPLINGSTRATEGY
DESCRIPTOR.message_types_by_name['OperationSamplingStrategy'] = _OPERATIONSAMPLINGSTRATEGY
DESCRIPTOR.message_types_by_name['PerOperationSamplingStrategies'] = _PEROPERATIONSAMPLINGSTRATEGIES
DESCRIPTOR.message_types_by_name['SamplingStrategyResponse'] = _SAMPLINGSTRATEGYRESPONSE
DESCRIPTOR.message_types_by_name['SamplingStrategyParameters'] = _SAMPLINGSTRATEGYPARAMETERS
DESCRIPTOR.enum_types_by_name['SamplingStrategyType'] = _SAMPLINGSTRATEGYTYPE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ProbabilisticSamplingStrategy = _reflection.GeneratedProtocolMessageType('ProbabilisticSamplingStrategy', (_message.Message,), {
...
RateLimitingSamplingStrategy = _reflection.GeneratedProtocolMessageType('RateLimitingSamplingStrategy', (_message.Message,), {
...
OperationSamplingStrategy = _reflection.GeneratedProtocolMessageType('OperationSamplingStrategy', (_message.Message,), {
...
PerOperationSamplingStrategies = _reflection.GeneratedProtocolMessageType('PerOperationSamplingStrategies', (_message.Message,), {
...
SamplingStrategyResponse = _reflection.GeneratedProtocolMessageType('SamplingStrategyResponse', (_message.Message,), {
...
SamplingStrategyParameters = _reflection.GeneratedProtocolMessageType('SamplingStrategyParameters', (_message.Message,), {
