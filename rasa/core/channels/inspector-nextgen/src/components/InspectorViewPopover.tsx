...
import { Brain, ClockRotateLeft, Icon, Share, Sliders } from "../Icon";
    ...
    >
      ...
      >
        <PopoverMenuItem
          ...
          onClick={() => { setInspectorView(InspectorView.ActiveFlow); }}
        ...
        <PopoverMenuItem
          ...
          onClick={() => { setInspectorView(InspectorView.History); }}
        ...
        <PopoverMenuItem
          ...
          onClick={() => { setInspectorView(InspectorView.Memory); }}
