...
#          Please don't do any changes in this module and rather adapt SingleStateFeaturizer from
#          the regular `rasa.core.featurizers.single_state_featurizer` module. This module is a workaround
