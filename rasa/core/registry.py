...
def message_data_featurizer_from_module_path(
    module_path: Text,
) -> Type["StateFeaturizer"]:
    ...
    Returns:
        a :class:`rasa.core.featurizers.message_data_featurizer.SingleStateFeaturizer`
    """
    try:
        return rasa.shared.utils.common.class_from_module_path(
            module_path, lookup_path="rasa.core.featurizers.message_data_featurizer"
        )
    except ImportError:
        raise ImportError(f"Cannot retrieve featurizer from path '{module_path}'")
