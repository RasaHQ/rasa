...
class MessageProcessor:
    ...
    async def parse_message(
        self, message: UserMessage,
        tracker: DialogueStateTracker, only_output_properties: bool = True
    ) -> Dict[Text, Any]:
        """Interprets the passed message.

        Args:
            message: Message to handle.
            tracker: Tracker containing conversation state
        ...
        if self.http_interpreter:
            ...
            parse_data = self._parse_message_with_graph(message, tracker,
                                                        only_output_properties)
