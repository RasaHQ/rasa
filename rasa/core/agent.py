...
class Agent:
    ...
    async def handle_message(
        ...
        **kwargs,
        ...
        with start_span("lock_store", attributes={"channel": message.input_channel, "sender_id": message.sender_id, "message_id": message.message_id}):
            async with self.lock_store.lock(message.sender_id):
                with start_span("handle_message"):
