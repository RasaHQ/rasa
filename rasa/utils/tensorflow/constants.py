...
UTTERANCE_TRANSFORMER_SIZE = "utterance_transformer_size"
UTTERANCE_NUM_TRANSFORMER_LAYERS = "number_of_utterance_transformer_layers"
UTTERANCE_NUM_HEADS = "number_of_attention_heads_utterance_transformer"
