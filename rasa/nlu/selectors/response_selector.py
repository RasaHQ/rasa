...
class DIET2DIET(DIET):
    ...
    def _create_all_labels(self) -> Tuple[tf.Tensor, tf.Tensor]:
        ...
        sequence_lengths_label = tf.cast(self.tf_label_data[LABEL_SEQ_LENGTH][0], dtype = tf.int32)
    ...
    def batch_loss(
        ...
        sequence_lengths_text = tf.cast(tf_batch_data[TEXT_SEQ_LENGTH][0], dtype = tf.int32)
        ...
        sequence_lengths_label = tf.cast(tf_batch_data[LABEL_SEQ_LENGTH][0], dtype = tf.int32)
        mask_label = self.compute_mask(sequence_lengths_label)
