...
def get_persistor(name: Text) -> Optional["Persistor"]:
    ...
    if name:
        try:
            ...
            raise ImportError(
                f"Unknown model persistor {name}. Please make sure to " #check-pii
...
class Persistor:
    ...
    def persist(self, model_directory: Text, model_name: Text) -> None:
        ...
        if not os.path.isdir(model_directory):
            raise ValueError(f"Target directory '{model_directory}' not found." #check-pii)
...
class AWSPersistor(Persistor):
    ...
    def list_models(self) -> List[Text]:
        try:
            ...
            logger.warning(f"Failed to list models in AWS. {e}" #check-pii)
            return []
...
class GCSPersistor(Persistor):
    ...
    def list_models(self) -> List[Text]:
        ...
        try:
            ...
            logger.warning(f"Failed to list models in google cloud storage. {e}" #check-pii)
            return []
...
class AzurePersistor(Persistor):
    ...
    def list_models(self) -> List[Text]:
        ...
        try:
            ...
            logger.warning(f"Failed to list models azure blob storage. {e}" #check-pii)
            return []
