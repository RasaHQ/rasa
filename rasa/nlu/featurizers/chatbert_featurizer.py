...
class ChatBERTFeaturizer(Featurizer):
    ...
    defaults = {
        ...
        "model_path": "/Users/daksh/work/research/conv_embed/models/run41/pytorch_model",
    }

    def _load_transformers_params(self):

        self.lm_key = self.component_config["lm_key"]
        self.model_path = self.component_config["model_path"]
        ...
        self.model = model_dictionary[self.lm_key].from_pretrained(self.model_path)
    ...
    def __init__(self, component_config: Dict[Text, Any] = None) -> None:
        ...
        super(ChatBERTFeaturizer, self).__init__(component_config)
    ...
    def _extract_nonpadded_embeddings(self, embeddings, actual_seq_lengths):
        ...
        for index, embedding in enumerate(embeddings):
            unmasked_embedding = embedding[1 : actual_seq_lengths[index] - 1]
            unmasked_embedding = np.mean(unmasked_embedding, axis=0)
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        message.set(
            ...
            self._combine_with_existing_features(
                message, feats[0], MESSAGE_VECTOR_FEATURE_NAMES[MESSAGE_TEXT_ATTRIBUTE]
            ),
        )
