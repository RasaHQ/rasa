...
class BERTTokenFeaturizer(Featurizer):
    ...
    def _load_transformers_params(self):
        ...
        self.lm_key = self.component_config["model_key"]
    ...
    def __init__(self, component_config: Dict[Text, Any] = None) -> None:
        ...
        super(BERTTokenFeaturizer, self).__init__(component_config)
    ...
    def _compute_input_ids(self, batch_examples):
        ...
        for example in batch_examples:
            ...
            example_input_ids = np.array(
                self.tokenizer.encode(
                    example, add_special_tokens=self.contains_special_token
                )
            )

            # print(example_input_ids, example_input_ids.shape)
            batch_input_ids.append(np.reshape(example_input_ids, (-1, 1)))
    ...
    def _compute_features(self, batch_inputs):
        ...
        batch_model_inputs = self._compute_input_ids(batch_inputs)
