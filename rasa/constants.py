...
DEFAULT_OPEN_UTTERANCE_TYPE_KEY = "respond_default"
DEFAULT_OPEN_UTTERANCE_TYPE_KEY_RANKING = DEFAULT_OPEN_UTTERANCE_TYPE_KEY + "_ranking"

MINIMUM_COMPATIBLE_VERSION = "1.3.0a1"
