...
RASA_DEFAULT_INTENT_PREFIX = "rasa_"
CORRECTION_INTENT = RASA_DEFAULT_INTENT_PREFIX + "correction"
CANCEL_FLOW_INTENT = RASA_DEFAULT_INTENT_PREFIX + "cancel_flow"
COMMENT_INTENT = RASA_DEFAULT_INTENT_PREFIX + "comment"
INFORM_INTENT = RASA_DEFAULT_INTENT_PREFIX + "inform"
TOO_COMPLEX_INTENT = RASA_DEFAULT_INTENT_PREFIX + "too_complex"
OPENAI_ERROR_INTENT = RASA_DEFAULT_INTENT_PREFIX + "openai_error"
