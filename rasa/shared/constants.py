...
CONFIG_MANDATORY_COMMON_KEYS = ["assistant_project_id"]
CONFIG_AUTOCONFIGURABLE_KEYS_CORE = ["policies"] + CONFIG_MANDATORY_COMMON_KEYS
CONFIG_AUTOCONFIGURABLE_KEYS_NLU = ["pipeline"] + CONFIG_MANDATORY_COMMON_KEYS
