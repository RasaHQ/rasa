...
def read_json_file(filename: Union[Text, Path]) -> Any:
    ...
    try:
        ...
        raise ValueError(
            ...
            "{}".format(os.path.abspath(filename)  # TODO: PII check, e)
        )
...
def list_directory(path: Text) -> List[Text]:
    ...
    if not isinstance(path, str):
        raise ValueError(
            ...
            "Got `{}` instead".format(type(path)  # TODO: PII check)
        )
    ...
    if os.path.isfile(path):
        ...
        raise ValueError(
            "Could not locate the resource '{}'.".format(os.path.abspath(path)  # TODO: PII check)
        )
    ...
    def env_var_constructor(loader, node):
        ...
        if "$" in expanded_vars:
            ...
            raise ValueError(
                ...
                " variables: '{}'.".format(value, not_expanded)  # TODO: PII check
            )
