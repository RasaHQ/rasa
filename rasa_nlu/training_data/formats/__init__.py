from dialogflow import DialogflowReader
from luis import LuisReader
from wit import WitReader
from markdown import MarkdownWriter, MarkdownReader
...
class TrainingDataReader(object):
    def read(self, filename):
        ...
        return self.reads(utils.read_file(filename))
