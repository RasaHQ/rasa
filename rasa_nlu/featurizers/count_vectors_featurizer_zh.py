...
class CountVectorsFeaturizerZH(Featurizer):
    ...
    name = "intent_featurizer_count_vectors_zh"
    ...
    def __init__(self, component_config=None):
        ...
        super(CountVectorsFeaturizerZH, self).__init__(component_config)
    ...
    def train(self, training_data, cfg=None, **kwargs):
        ...
        for example in training_data.intent_examples:
            ...
            token_str = []
            for token in tokens:
                token_str.append(token.text)
            token_list.append(' '.join(token_str))
        lem_exs = token_list
    ...
    def load(cls,
        ...
        if model_dir and meta.get("featurizer_file"):
            ...
            return CountVectorsFeaturizerZH(meta)
