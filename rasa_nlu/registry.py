...
from rasa_nlu.classifiers.intent_threshold import IntentThreshold
from rasa_nlu.classifiers.intent_2_stage import Intent2Stage
...
component_classes = [
    ...
    IntentThreshold, Intent2Stage, Intent2Stage1C
]
