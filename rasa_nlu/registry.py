...
from rasa_nlu.classifiers.twostage_intent_classifier import \
    TwostageIntentClassifier
...
component_classes = [
    ...
    SklearnIntentClassifier, TwostageIntentClassifier, MitieIntentClassifier, KeywordIntentClassifier,
]
