...
documentation, a manual run through all subclasses of
`transformers.tokenization_utils.PretrainedTokenizer` is necessary. This will return
the actual tokenizer classes, for which a model of pretrained weights has to be
identified and added to the list below.
"""
