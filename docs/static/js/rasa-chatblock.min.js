  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var r = n(21),
        ...
        c = n(16),
        s = n(6),
        f = Object(i.createContext)('undefined' != typeof HTMLElement ? Object(a.a)() : null),
        ...
        v = function (e, t, n, r) {
          ...
          'string' == typeof t.className
            ? (s = Object(l.a)(e.registered, c, t.className))
            : null != t.className && (s = t.className + ' ');
          var f = Object(u.a)(c);
          Object(l.b)(e, f, 'string' == typeof a);
          s += e.key + '-' + f.name;
          var p = {};
          for (var d in t) g.call(t, d) && 'css' !== d && d !== m && (p[d] = t[d]);
          return (p.ref = r), (p.className = s), Object(i.createElement)(a, p);
        },
        b = h(function (e, t, n) {
      ...
      var y = function (e, t) {
          ...
          o[0] = b;
          var a = {};
          for (var l in t) g.call(t, l) && (a[l] = t[l]);
          (a[m] = e), (o[1] = a);
    ...
    function (e, t, n) {
      ...
      var r = n(4),
        ...
        i = function (e, t) {
          ...
          for (var r in e) {
            var i;
            e[r] && 'object' == typeof t[r] && o()(n, (((i = {})[r] = o()(e[r], t[r])), i));
          }
          return n;
        },
        a = {
        ...
        c = function (e, t, n, r, o) {
          for (t = t && t.split ? t.split('.') : [t], r = 0; r < t.length; r++) e = e ? e[t[r]] : o;
          return e === o ? n : e;
        },
        s = function e(t) {
          var n = {},
            r = function (e) {
              ...
              for (var m in e)
                if (t[m]) {
                  var g = t[m],
                    v = e[m],
                    b = c(e.theme, g.scale, g.defaults);
                  if ('object' != typeof v) o()(s, g(v, b, e));
                  else {
                    if (
                      ((n.breakpoints = (!h && n.breakpoints) || c(e.theme, 'breakpoints', a.breakpoints)),
                      Array.isArray(v))
                    ) {
                      (n.media = (!h && n.media) || [null].concat(n.breakpoints.map(l))),
                        (s = i(s, f(n.media, g, b, v, e)));
                      continue;
                    }
                    null !== v && ((s = i(s, p(n.breakpoints, g, b, v, e))), (d = !0));
                  }
                }
              return (
                d &&
        ...
        h = function (e) {
          ...
          return (
            Object.keys(e).forEach(function (n) {
              var r = e[n];
              t[n] = !0 !== r ? ('function' != typeof r ? d(r) : r) : d({ property: n, scale: n });
            }),
            s(t)
          );
        },
      ...
      var y = h(b),
        ...
        O = h({
          ...
          gridColumnGap: { property: 'gridColumnGap', scale: 'space', defaultScale: S.space },
          gridRowGap: { property: 'gridRowGap', scale: 'space', defaultScale: S.space },
          gridColumn: !0,
          gridRow: !0,
          gridAutoFlow: !0,
          gridAutoColumns: !0,
      ...
      (_.borderTopLeftRadius = { property: 'borderTopLeftRadius', scale: 'radii' }),
        (_.borderTopRightRadius = { property: 'borderTopRightRadius', scale: 'radii' }),
        (_.borderBottomWidth = { property: 'borderBottomWidth', scale: 'borderWidths' }),
        (_.borderBottomColor = { property: 'borderBottomColor', scale: 'colors' }),
        (_.borderBottomStyle = { property: 'borderBottomStyle', scale: 'borderStyles' }),
        (_.borderBottomLeftRadius = { property: 'borderBottomLeftRadius', scale: 'radii' }),
        (_.borderBottomRightRadius = { property: 'borderBottomRightRadius', scale: 'radii' }),
        (_.borderLeftWidth = { property: 'borderLeftWidth', scale: 'borderWidths' }),
        (_.borderLeftColor = { property: 'borderLeftColor', scale: 'colors' }),
        (_.borderLeftStyle = { property: 'borderLeftStyle', scale: 'borderStyles' }),
        (_.borderRightWidth = { property: 'borderRightWidth', scale: 'borderWidths' }),
        (_.borderRightColor = { property: 'borderRightColor', scale: 'colors' }),
        (_.borderRightStyle = { property: 'borderRightStyle', scale: 'borderStyles' });
      var P = h(_),
        A = P,
        M = {
          background: !0,
      ...
      var z = h(M),
        ...
        j = h({
          ...
          top: { property: 'top', scale: 'space', defaultScale: D.space },
          right: { property: 'right', scale: 'space', defaultScale: D.space },
          bottom: { property: 'bottom', scale: 'space', defaultScale: D.space },
          left: { property: 'left', scale: 'space', defaultScale: D.space },
        }),
        L = j,
        ...
        V = {};
      (V.margin = {
        margin: { property: 'margin', scale: 'space', transform: N, defaultScale: R.space },
        marginTop: { property: 'marginTop', scale: 'space', transform: N, defaultScale: R.space },
        marginRight: { property: 'marginRight', scale: 'space', transform: N, defaultScale: R.space },
        marginBottom: { property: 'marginBottom', scale: 'space', transform: N, defaultScale: R.space },
        marginLeft: { property: 'marginLeft', scale: 'space', transform: N, defaultScale: R.space },
        marginX: {
        ...
        (V.padding = {
          padding: { property: 'padding', scale: 'space', defaultScale: R.space },
          paddingTop: { property: 'paddingTop', scale: 'space', defaultScale: R.space },
          paddingRight: { property: 'paddingRight', scale: 'space', defaultScale: R.space },
          paddingBottom: { property: 'paddingBottom', scale: 'space', defaultScale: R.space },
          paddingLeft: { property: 'paddingLeft', scale: 'space', defaultScale: R.space },
          paddingX: { properties: ['paddingLeft', 'paddingRight'], scale: 'space', defaultScale: R.space },
          paddingY: { properties: ['paddingTop', 'paddingBottom'], scale: 'space', defaultScale: R.space },
        }),
      ...
      var B = h(V.margin),
        ...
        Q = function (e) {
          ...
          ((n = Object.keys(l).length
            ? function (e, t, n) {
                return Object(Y.default)(c(t, e, null))(n.theme);
              }
            : function (e, t) {
                return c(t, e, null);
              }).scale = r || u),
        ...
        G = Q({ key: 'buttons' }),
        X = Q({ key: 'textStyles', prop: 'textStyle' }),
        q = Q({ key: 'colorStyles', prop: 'colors' }),
        K = v.width,
        Z = v.height,
        J = v.minWidth,
        ee = v.minHeight,
        ...
        De = T.gridRow,
        je = T.gridAutoFlow,
        Le = T.gridAutoColumns,
        Re = T.gridAutoRows,
        Ie = T.gridTemplateColumns,
        Ne = T.gridTemplateRows,
        Ve = T.gridTemplateAreas,
        Be = T.gridArea,
        He = A.borderWidth,
        We = A.borderStyle,
        Ue = A.borderColor,
        ...
        Ge = A.borderLeft,
        Xe = A.borderRadius,
        qe = F.backgroundImage,
        Ke = F.backgroundSize,
        Ze = F.backgroundPosition,
        Je = F.backgroundRepeat,
        et = L.zIndex,
        tt = L.top,
        nt = L.right,
        rt = L.bottom,
        ...
        it = function (e) {
          var t = e.prop,
            ...
            u = {};
          return (
            (u[t] = d({ properties: l, property: n || t, scale: o, defaultScale: a, transform: i })),
            r && (u[r] = u[t]),
            s(u)
          );
        };
...
*/ var r = Object.getOwnPropertySymbols,
      ...
      var o = function (e, t, n, r, o) {
              ...
              if (null != u)
                if (Array.isArray(u))
                  for (var c = 0; c < u.slice(0, a.length).length; c++) {
                    var s = a[c];
                    s ? ((n[s] = n[s] || {}), null != u[c] && (n[s][l] = u[c])) : (n[l] = u[c]);
                  }
                else n[l] = u;
            }
            return n;
        ...
        d = function e(t) {
          return function (n) {
            ...
            var i = r({}, a, {}, n.theme || n),
              s = {},
              d = 'function' == typeof t ? t(i) : t,
              h = p(d)(i);
            for (var m in h) {
              var g = h[m],
                v = 'function' == typeof g ? g(i) : g;
              if ('variant' !== m)
                if (v && 'object' == typeof v) s[m] = e(v)(i);
                else {
                  var b = o(l, m, m),
                    y = o(c, b),
                    w = o(i, y, o(i, b, {})),
                    x = o(f, b, o)(w, v, v);
                  if (u[b]) for (var E = u[b], C = 0; C < E.length; C++) s[E[C]] = x;
                  else s[b] = x;
                }
              else s = r({}, s, {}, e(o(i, v))(i));
            }
            return s;
          };
        };
    ...
    function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.Flex = t.Box = void 0);
      u(n(0));
      var r = u(n(11)),
        o = n(3),
        i = (function (e) {
      ...
      var c = (0, r.default)('div', { shouldForwardProp: a.default })(
        ...
        function (e) {
          ...
          return (0, i.default)((0, i.get)(t, o + '.' + n, (0, i.get)(t, n)))(t);
        },
        function (e) {
    ...
    function (e, t, n) {
            ...
            return (function (e, t, n) {
              ...
              if (Array.isArray(n)) for (var o = 0; o < n.length; o++) r += p(e, t, n[o], !1);
                ...
                for (var i in n) {
                  ...
                  } else for (var u = 0; u < a.length; u++) c(a[u]) && (r += s(i) + ':' + f(i, a[u]) + ';');
                }
              return r;
            })(e, t, n);
          case 'function':
      ...
      var m = function (e, t, n) {
        ...
        for (var l = 1; l < e.length; l++)
          (i += p(n, t, e[l], 46 === i.charCodeAt(i.length - 1))), o && (i += a[l]);
        h.lastIndex = 0;
    ...
    function (e, t, n) {
      ...
      var m = function e(t, n) {
        ...
        return function () {
          ...
          if ((void 0 !== r && v.push('label:' + r + ';'), null == g[0] || void 0 === g[0].raw))
            v.push.apply(v, g);
          else {
            0, v.push(g[0][0]);
          ...
          var w = Object(l.f)(function (e, t, n) {
            return Object(i.createElement)(l.c.Consumer, null, function (r) {
              ...
              var y = Object(c.a)(v.concat(h), t.registered, g);
              Object(u.b)(t, y, 'string' == typeof l);
              (s += t.key + '-' + y.name), void 0 !== a && (s += ' ' + a);
              var w = m && void 0 === o ? p(l) : d,
                x = {};
              for (var E in e) (m && 'as' === E) || (w(E) && (x[E] = e[E]));
              return (x.className = s), (x.ref = n || e.innerRef), Object(i.createElement)(l, x);
            });
          });
          return (
            (w.displayName =
            ...
            (w.withComponent = function (t, r) {
              return e(t, void 0 !== r ? h({}, n || {}, {}, r) : n).apply(void 0, v);
            }),
            w
          );
        };
    ...
    function (e, t, n) {
      ...
      (function (e, r) {
        ...
        function j(e) {
          ...
          L(i, r) || ('fulfilled' === n && R(i, r), 'rejected' === n && N(i, r));
        }
        function L(e, t) {
          var n;
          try {
        ...
        function I(e, t) {
          'pending' === e._state && ((e._state = 'settled'), (e._data = t), D(B, e));
        }
        function N(e, t) {
          'pending' === e._state && ((e._state = 'settled'), (e._data = t), D(H, e));
        }
        function V(e) {
        ...
        function H(t) {
          (t._state = 'rejected'), V(t), !t._handled && A && e.process.emit('unhandledRejection', t._data, t);
        }
        function W(t) {
        ...
        (U.prototype = {
          ...
          then: function (e, t) {
            ...
            return (
              (!t && !e) ||
                this._handled ||
                ((this._handled = !0), 'rejected' === this._state && A && D(W, this)),
              'fulfilled' === this._state || 'rejected' === this._state ? D(j, n) : this._then.push(n),
              n.then
            );
          },
          catch: function (e) {
          ...
          (U.resolve = function (e) {
            return e && 'object' === o(e) && e.constructor === U
              ? e
              : new U(function (t) {
                  t(e);
                });
        ...
        function q(e) {
          return (
            e.size !== $.size || e.x !== $.x || e.y !== $.y || e.rotate !== $.rotate || e.flipX || e.flipY
          );
        }
        function K(e) {
          var t = e.transform,
        ...
        function ee(e) {
          var t = e.icons,
            ...
            y = [k.replacementClass, i ? ''.concat(k.familyPrefix, '-').concat(i) : '', b]
              .filter(function (e) {
              ...
              r.found && n.found
                ? (function (e) {
                    var t,
                      ...
                      m = s.children ? { children: s.children.map(J) } : {},
                      g = {
                        tag: 'g',
                        attributes: l({}, d.inner),
                        children: [J(l({ tag: s.tag, attributes: l({}, s.attributes, d.path) }, m))],
                      },
                      v = { tag: 'g', attributes: l({}, d.outer), children: [g] },
                      b = 'mask-'.concat(a || Q()),
                      y = 'clip-'.concat(a || Q()),
                      w = {
                        tag: 'mask',
        ...
        var te = function () {},
          ne =
            (k.measurePerformance && v && v.mark && v.measure,
            function (e, t, n, r) {
              var o,
                i,
                a,
        ...
        function re(e, t) {
          ...
          'function' != typeof O.hooks.addPack || o
          ...
          ke =
            ((we = function (e) {
              ...
              if (e) {
                var x = e.prefix,
                  E = e.iconName,
                  C = e.icon;
                return be(l({ type: 'icon' }, e), function () {
                  return (
                    ve(),
                    k.autoA11y &&
                      (p
                        ? (b['aria-labelledby'] = ''.concat(k.replacementClass, '-title-').concat(h || Q()))
            ...
            function (e) {
              var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                n = (e || {}).icon ? e : ye(e || {}),
                r = t.mask;
              return r && (r = (r || {}).icon ? r : ye(r || {})), we(n, l({}, t, { mask: r }));
            });
      }.call(this, n(19), n(36).setImmediate));
    },
    function (e, t) {
    ...
    function (e, t, n) {
      ...
      var o = function (e) {
        ...
        function r(e, t, n, i) {
          ...
          switch (l) {
            ...
            case 1e3:
              switch (
                ((t = (u = a.substring(13).trim()).indexOf('-') + 1), u.charCodeAt(0) + u.charCodeAt(t))
              ) {
                case 226:
                  u = a.replace(y, 'tb');
                  break;
            ...
            case 938:
              if (45 === a.charCodeAt(5))
                switch (a.charCodeAt(6)) {
                  case 105:
                    return (
                      (u = a.replace('-items', '')), '-webkit-' + a + '-webkit-box-' + u + '-ms-flex-' + u + a
                    );
                  case 115:
        ...
        function a(e, t, n, r, o, i, a, l, c, s) {
          for (var f, p = 0, d = t; p < z; ++p)
            switch ((f = M[p].call(u, e, d, n, r, o, i, a, l, c, s))) {
              case void 0:
              case !1:
              case !0:
              case null:
        ...
        function l(e) {
          return (
            void 0 !== (e = e.prefix) &&
              ((F = null), e ? ('function' != typeof e ? (P = 1) : ((P = 2), (F = e))) : (P = 0)),
            l
          );
        }
        function u(e, n) {
          ...
          var f = (function e(n, l, u, f, p) {
            for (
              ...
              if (
                ...
                L === B &&
                  0 !== C + S + k + E &&
                  (0 !== C && (h = 47 === C ? 10 : 47), (S = k = E = 0), V++, B++),
                0 === C + S + k + E)
              ) {
                if (L === B && (0 < R && (H = H.replace(s, '')), 0 < H.trim().length)) {
                  switch (h) {
                    case 32:
                    case 9:
                    case 59:
                ...
                switch (h) {
                  case 123:
                    for (d = (H = H.trim()).charCodeAt(0), m = 1, N = ++L; L < V; ) {
                              ...
                              e: {
                                for (j = L + 1; j < B; ++j)
                                  switch (u.charCodeAt(j)) {
                                    case 47:
                                      if (42 === h && 42 === u.charCodeAt(j - 1) && L + 2 !== j) {
                                        L = j + 1;
                                        break e;
                                      }
                                      break;
                    ...
                    switch (
                      ...
                      case 64:
                        ...
                        if (
                          ((N = (m = e(l, R, m, h, p + 1)).length),
                          0 < z &&
                            ((x = a(3, m, (R = t(A, H, I)), l, T, O, N, h, p, f)),
                            (H = R.join('')),
                            void 0 !== x && 0 === (N = (m = x.trim()).length) && ((h = 0), (m = ''))),
                          0 < N)
                        )
                          switch (h) {
                            case 115:
                        ...
                        break;
                      default:
                        m = e(l, t(l, H, I), m, f, p + 1);
                    }
                    (U += m), (m = I = R = j = d = 0), (H = ''), (h = u.charCodeAt(++L));
                    break;
                  case 125:
                  case 59:
                    if (1 < (N = (H = (0 < R ? H.replace(s, '') : H).trim()).length))
                      switch (
                        (0 === j &&
                          ((d = H.charCodeAt(0)), 45 === d || (96 < d && 123 > d)) &&
                          (N = (H = H.replace(' ', ':')).length),
                        0 < z &&
                          void 0 !== (x = a(1, H, l, n, T, O, W.length, f, p, f)) &&
                          0 === (N = (H = x.trim()).length) &&
                          (H = '\0\0'),
                        (d = H.charCodeAt(0)),
                        (h = H.charCodeAt(1)),
                    ...
                    (I = R = j = d = 0), (H = ''), (h = u.charCodeAt(++L));
                }
              }
              switch (h) {
                case 13:
                case 10:
                  47 === C ? (C = 0) : 0 === 1 + d && 107 !== f && 0 < H.length && ((R = 1), (H += '\0')),
                    0 < z * D && a(0, H, l, n, T, O, W.length, f, p, f),
                    (O = 1),
                    T++;
                  break;
                case 59:
                        ...
                        switch (C) {
                          ...
                          case 42:
                            47 === h &&
                              42 === M &&
                              N + 2 !== L &&
                              (33 === u.charCodeAt(N + 2) && (W += u.substring(N, L + 1)), (y = ''), (C = 0));
                        }
                  }
                  0 === C && (H += y);
              }
            ...
            if (0 < (N = W.length)) {
              if (
                ((R = l), 0 < z && void 0 !== (x = a(2, W, R, n, T, O, N, f, p, f)) && 0 === (W = x).length)
              )
                return $ + W + U;
              if (((W = R.join(',') + '{' + W + '}'), 0 != P * _)) {
                switch ((2 !== P || o(W, 2) || (_ = 0), _)) {
                  case 111:
          ...
          return (
            0 < z && void 0 !== (u = a(-2, f, l, l, T, O, f.length, 0, 0, 0)) && (f = u),
            '',
            (_ = 0),
            (O = T = 1),
            f
      ...
      var a = { current: null },
        l = function (e, t, n, r, o, l, u, c, s, f) {
          switch (e) {
            case 1:
      ...
      t.a = function (e) {
        ...
        var p = {
          key: n,
          sheet: new r.a({ key: n, container: u, nonce: e.nonce, speedy: e.speedy }),
          nonce: e.nonce,
          inserted: c,
          registered: {},
          insert: s,
                ...
                value: function () {
                  ...
                  return (
                    ...
                    a.default.createElement(
                      ...
                      a.default.createElement('div', { ref: this.sizerRef, style: c }, e),
                      this.props.placeholder
                        ? a.default.createElement(
                            'div',
...
*/ !(function () {
    ...
    function (e, t, n) {
      ...
      var r,
        ...
        u =
          ...
          function (e) {
            if (e && e.__esModule) return e;
            var t = {};
            if (null != e) for (var n in e) 'default' !== n && Object.hasOwnProperty.call(e, n) && a(t, e, n);
            return l(t, e), t;
          },
        c =
          (this && this.__rest) ||
      ...
      var m = (function (e) {
        function t() {
          ...
          return (
            (t.lastHtml = t.props.html),
            (t.el = 'function' == typeof t.props.innerRef ? { current: null } : f.createRef()),
            (t.getEl = function () {
              return (t.props.innerRef && 'function' != typeof t.props.innerRef ? t.props.innerRef : t.el)
                .current;
            }),
            (t.emitChange = function (e) {
              ...
              if (n) {
                ...
                if (t.props.onChange && r !== t.lastHtml) {
                  var o = Object.assign({}, e, { target: { value: r } });
                  t.props.onChange(o);
                }
                t.lastHtml = r;
              }
        ...
        return (
          ...
          (t.prototype.shouldComponentUpdate = function (e) {
            ...
            return (
              !n ||
              h(e.html) !== h(n.innerHTML) ||
              t.disabled !== e.disabled ||
              t.tagName !== e.tagName ||
              t.className !== e.className ||
              t.innerRef !== e.innerRef ||
              !p.default(t.style, e.style)
            );
          }),
          (t.prototype.componentDidUpdate = function () {
            var e = this.getEl();
            e &&
              (this.props.html !== e.innerHTML && (e.innerHTML = this.props.html),
    ...
    function (e, t, n) {
      ...
      function R(e, t, n, r, o) {
        var i = '';
        null != n && (i = ('' + n).replace(P, '$&/') + '/'), F(e, L, (t = M(t, i, r, o))), z(t);
      }
      var I = { current: null };
      function N() {
        var e = I.current;
      ...
      (t.Children = {
        ...
        (t.cloneElement = function (e, t, n) {
          ...
          if (null != t) {
            ...
            for (s in t)
              S.call(t, s) && !O.hasOwnProperty(s) && (o[s] = void 0 === t[s] && void 0 !== c ? c[s] : t[s]);
          }
    ...
    function (e, t, n) {
      ...
      function K(e, t, n, r) {
        ...
        (null !== o
          ...
          r || null === o
            ? (function (e) {
                return !!W.call($, e) || (!W.call(U, e) && (H.test(e) ? ($[e] = !0) : ((U[e] = !0), !1)));
      ...
      function xe(e) {
        ...
        var n = t.getValue(),
          r = '';
        return (
          e && (r = ye(e) ? (e.checked ? 'true' : 'false') : e.value), (e = r) !== n && (t.setValue(e), !0)
        );
      }
      function Ee(e, t) {
        var n = t.checked;
      ...
      function At(e, t, n, r, o, i) {
        return null === e || e.nativeEvent !== i
          ? ((e = _t(t, n, r, o, i)), null !== t && null !== (t = _n(t)) && gt(t), e)
      ...
      function jt(e, t) {
        e.blockedOn === t &&
          ((e.blockedOn = null),
          bt || ((bt = !0), i.unstable_scheduleCallback(i.unstable_NormalPriority, Dt)));
      }
      function Lt(e) {
        function t(t) {
          return jt(t, e);
      ...
      function qt(e, t, n, r) {
        $t(Ut, Kt.bind(null, e, t, n, r));
      }
      function Kt(e, t, n, r) {
        if (Yt)
          if (0 < yt.length && -1 < Ot.indexOf(e)) (e = _t(null, e, t, n, r)), yt.push(e);
          else {
            var o = Zt(e, t, n, r);
            if (null === o) Pt(e, r);
            else if (-1 < Ot.indexOf(e)) (e = _t(o, e, t, n, r)), yt.push(e);
            else if (
              !(function (e, t, n, r, o) {
                switch (t) {
                  case 'focus':
                  ...
                  case 'pointerover':
                    var i = o.pointerId;
                    return Ct.set(i, At(Ct.get(i) || null, e, t, n, r, o)), !0;
                  case 'gotpointercapture':
      ...
      function _n(e) {
        return !(e = e[kn] || e[On]) || (5 !== e.tag && 6 !== e.tag && 13 !== e.tag && 3 !== e.tag)
          ? null
          : e;
      }
      function Pn(e) {
          ...
          extractEvents: function (e, t, n, r) {
            ...
            return (
              i
                ? (er &&
                    ...
                    (ar || i !== nr.compositionStart
                      ...
                      : ((Nn = 'value' in (In = r) ? In.value : In.textContent), (ar = !0))),
              ...
              (e = Jn
                ...
                ? (((t = Xn.getPooled(nr.beforeInput, t, n, r)).data = e), Rn(t))
                : (t = null),
      ...
      function fr(e, t, n) {
        return ((e = Un.getPooled(sr.change, e, t, n)).type = 'change'), z(n), Rn(e), e;
      }
      var pr = null,
        dr = null;
      function hr(e) {
      ...
      T && (vr = ct('input') && (!document.documentMode || 9 < document.documentMode));
      var kr = {
          eventTypes: sr,
      ...
      var Pr = 0,
        ...
        Fr = Sr.extend({
          ...
          movementY: function (e) {
            ...
            var t = Ar;
            return (Ar = e.screenY), zr ? ('mousemove' === e.type ? e.screenY - t : 0) : ((zr = !0), 0);
          },
        }),
        Dr = Fr.extend({
          pointerId: null,
      ...
      function Nr(e, t) {
        ...
        for (r = 0; r < n.length; r++) if (!Ir.call(t, n[r]) || !Rr(e[n[r]], t[n[r]])) return !1;
        return !0;
      }
      ...
      var Qr = {
          ...
          extractEvents: function (e, t, n, r, o, i) {
            ...
            switch (((o = t ? Pn(t) : window), e)) {
              case 'focus':
                (cr(o) || 'true' === o.contentEditable) && ((Hr = o), (Wr = t), (Ur = null));
                break;
              case 'blur':
                Ur = Wr = Hr = null;
                break;
        ...
        Gr = Un.extend({ animationName: null, elapsedTime: null, pseudoElement: null }),
        Xr = Un.extend({
      ...
      function xo(e, t, n) {
        ...
        n
          ? ((e = yo(e, t, ho)), (r.__reactInternalMemoizedMergedChildContext = e), uo(po), uo(fo), co(fo, e))
          : uo(po),
          co(po, n);
      }
      ...
      function $o(e) {
        return null === Lo ? ((Lo = [e]), (Ro = Co(_o, Qo))) : Lo.push(e), Fo;
      }
      function Yo() {
        if (null !== Ro) {
          var e = Ro;
      ...
      function Qo() {
        if (!Io && null !== Lo) {
          ...
          try {
            ...
            throw (null !== Lo && (Lo = Lo.slice(e + 1)), Co(_o, Yo), t);
          } finally {
            Io = !1;
          }
        }
      ...
      function oi(e, t) {
        if (Jo !== e && !1 !== t && 0 !== t)
          if (
            ...
            (Zo = t), (Ko.dependencies = { expirationTime: 0, firstContext: t, responders: null });
          } else Zo = Zo.next = t;
              ...
              if ((l = h.expirationTime) < r) {
                ...
                e: {
                  ...
                  switch (((l = t), (m = n), v.tag)) {
                    ...
                    case 0:
                      if (null == (l = 'function' == typeof (g = v.payload) ? g.call(m, c, l) : g)) break e;
                      c = o({}, c, l);
                      break e;
                    case 2:
                      ii = !0;
      ...
      var gi = {
        ...
        enqueueSetState: function (e, t, n) {
          ...
          var r = Yl(),
            o = di.suspense;
          ((o = ui((r = Ql(r, e, o)), o)).payload = t), null != n && (o.callback = n), ci(e, o), Gl(e, r);
        },
        ...
        enqueueForceUpdate: function (e, t) {
          ...
          var n = Yl(),
            r = di.suspense;
          ((r = ui((n = Ql(n, e, r)), r)).tag = 2), null != t && (r.callback = t), ci(e, r), Gl(e, n);
        },
      };
      ...
      function bi(e, t, n) {
        ...
        return (
          'object' == typeof i && null !== i
            ? (i = oi(i))
            : ((o = go(t) ? ho : fo.current), (i = (r = null != (r = t.contextTypes)) ? mo(e, o) : so)),
          (t = new t(n, i)),
      ...
      function ki(e) {
        ...
        function c(e, t, n, r) {
          return null !== t && t.elementType === n.type
            ...
            : (((r = Tu(n.type, n.key, n.props, null, e.mode, r)).ref = Ei(e, t, n)), (r.return = e), r);
        }
        function s(e, t, n, r) {
          return null === t ||
            4 !== t.tag ||
        ...
        function p(e, t, n) {
          ...
          if ('object' == typeof t && null !== t) {
            switch (t.$$typeof) {
              case ee:
                return (
                  ((n = Tu(t.type, t.key, t.props, null, e.mode, n)).ref = Ei(e, null, t)), (n.return = e), n
                );
              case te:
        ...
        function g(o, l, u, c) {
          ...
          for (
            var f = (s = null), m = l, g = (l = 0), v = null, b = u.next();
            null !== m && !b.done;
            g++, b = u.next()
          ) {
            m.index > g ? ((v = m), (m = null)) : (v = m.sibling);
            var y = d(o, m, b.value, c);
            if (null === y) {
              null === m && (m = v);
              break;
            }
          ...
          if (null === m) {
            for (; !b.done; g++, b = u.next())
              null !== (b = p(o, b.value, c)) &&
                ((l = i(b, l, g)), null === f ? (s = b) : (f.sibling = b), (f = b));
            return s;
          }
          for (m = r(o, m); !b.done; g++, b = u.next())
              ...
              case ee:
                e: {
                  ...
                  i.type === ne
                    ...
                    : (((u = Tu(i.type, i.key, i.props, null, e.mode, u)).ref = Ei(e, r, i)),
                      (u.return = e),
                      (e = u));
                }
                return l(e);
      ...
      function zi(e, t) {
        switch ((co(Ai, t), co(Pi, e), co(_i, Ti), (e = t.nodeType))) {
          case 9:
          case 11:
      ...
      function Gi(e, t, n, r, o, i) {
        if (
          ...
          (t.updateQueue = null),
          (t.expirationTime = 0),
          (Ni.current = null === e || null === e.memoizedState ? va : ba),
          (e = n(r, o)),
          t.expirationTime === Bi)
        ) {
          i = 0;
          do {
            ...
            (i += 1), (Ui = Wi = null), (t.updateQueue = null), (Ni.current = ya), (e = n(r, o));
      ...
      function Xi() {
        ...
        return null === Ui ? (Hi.memoizedState = Ui = e) : (Ui = Ui.next = e), Ui;
      }
      function qi() {
        if (null === Wi) {
          var e = Hi.alternate;
        ...
        var t = null === Ui ? Hi.memoizedState : Ui.next;
        if (null !== t) (Ui = t), (Wi = e);
        else {
          ...
          (e = {
            ...
            null === Ui ? (Hi.memoizedState = Ui = e) : (Ui = Ui.next = e);
        }
        return Ui;
      }
      function Ki(e, t) {
      ...
      function ea(e) {
        ...
        return (
          ...
          (e = (e = t.queue =
            { pending: null, dispatch: null, lastRenderedReducer: Ki, lastRenderedState: e }).dispatch =
            ma.bind(null, Hi, e)),
          [t.memoizedState, e]
        );
      }
      ...
      function ma(e, t, n) {
        ...
        if (
          ...
          ($i = !0), (o.expirationTime = Bi), (Hi.expirationTime = Bi);
        else {
          if (
            0 === e.expirationTime &&
      ...
      function Fa(e, t, n, r, o, i) {
        if (null === e) {
          ...
          return 'function' != typeof a ||
            ...
            ? (((e = Tu(n.type, null, r, null, t.mode, i)).ref = t.ref), (e.return = t), (t.child = e))
            : ((t.tag = 15), (t.type = a), Da(e, t, a, r, o, i));
        }
        return (
          (a = e.child),
          o < i && ((o = a.memoizedProps), (n = null !== (n = n.compare) ? n : Nr)(o, r) && e.ref === t.ref)
            ? Ga(e, t, i)
            : ((t.effectTag |= 1), ((e = Ou(a, r)).ref = t.ref), (e.return = t), (t.child = e))
        );
      }
      function Da(e, t, n, r, o, i) {
        return null !== e && Nr(e.memoizedProps, r) && e.ref === t.ref && ((Aa = !1), o < i)
          ...
          switch (o) {
            case 'forwards':
              for (n = t.child, o = null; null !== n; )
                null !== (e = n.alternate) && null === Ri(e) && (o = n), (n = n.sibling);
              ...
              if (((e = Mi(_i.current)), Ta(t))) {
                ...
                switch (((r[kn] = t), (r[Sn] = l), i)) {
                  ...
                  case 'details':
                    ...
                    break;
                  case 'input':
                    Ce(r, l), Qt('invalid', r), un(n, 'onChange');
                    break;
                  case 'select':
                ...
                switch (
                  ...
                  case 'details':
                    ...
                    break;
                  case 'input':
                    Ce(e, r), (c = Ee(e, r)), Qt('invalid', e), un(n, 'onChange');
                    break;
                  case 'option':
                    c = _e(e, r);
                    break;
                  case 'select':
                    ...
                    break;
                  case 'textarea':
                    Me(e, r), (c = Ae(e, r)), Qt('invalid', e), un(n, 'onChange');
                    break;
                  default:
                    c = r;
                }
                ...
                : ((n = null !== r),
                  ...
                  n &&
                    ...
                    0 != (1 & Li.current)
                      ? Tl === wl && (Tl = xl)
                      : ((Tl !== wl && Tl !== xl) || (Tl = El),
                        0 !== zl && null !== kl && (Fu(kl, Ol), Du(kl, zl)))),
                  (n || r) && (t.effectTag |= 4),
                  null)
            );
          case 4:
      ...
      function Ka(e) {
        switch (e.tag) {
          ...
          case 3:
            if ((Fi(), uo(po), uo(fo), 0 != (64 & (t = e.effectTag)))) throw Error(a(285));
      ...
      function fl(e, t) {
        switch (t.tag) {
          ...
          case 13:
            if (
              ((n = t),
              null === t.memoizedState ? (r = !1) : ((r = !0), (n = t.child), (Dl = Vo())),
              null !== n)
            )
              e: for (e = n; ; ) {
                if (5 === e.tag)
      ...
      function Gl(e, t) {
        ...
        if (null !== (e = Xl(e, t))) {
          var n = Bo();
          1073741823 === t ? (0 != (8 & Cl) && 0 == (48 & Cl) ? Jl(e) : (Kl(e), 0 === Cl && Yo())) : Kl(e),
            0 == (4 & Cl) ||
              (98 !== n && 99 !== n) ||
              (null === Hl
                ? (Hl = new Map([[e, t]]))
      ...
      function Xl(e, t) {
        ...
        return null !== o && (kl === o && (au(t), Tl === El && Fu(o, Ol)), Du(o, t)), o;
      }
      function ql(e) {
          ...
          if (0 === t)
            ...
            (e.callbackExpirationTime = t),
              ...
              (t =
                1073741823 === t
                  ? $o(Jl.bind(null, e))
                  : Uo(r, Zl.bind(null, e), { timeout: 10 * (1073741821 - t) - Vo() })),
              (e.callbackNode = t);
          }
        }
      }
      function Zl(e, t) {
        if ((($l = 0), t)) return ju(e, (t = Yl())), Kl(e), null;
        var n = ql(e);
        if (0 !== n) {
          if (((t = e.callbackNode), 0 != (48 & Cl))) throw Error(a(327));
          if ((mu(), (e === kl && n === Ol) || nu(e, n), null !== Sl)) {
            var r = Cl;
            Cl |= 16;
            for (var o = ou(); ; )
              try {
            ...
            if ((ei(), (Cl = r), (bl.current = o), 1 === Tl)) throw ((t = _l), nu(e, n), Fu(e, n), Kl(e), t);
            if (null === Sl)
              switch (
                  ...
                  if (1073741823 !== Pl && null !== Ml) {
                    ...
                    if (
                      (0 >= (r = 0 | l.busyMinDurationMs)
                        ...
                        : ((o = 0 | l.busyDelayMs),
                          (r =
                            (i = Vo() - (10 * (1073741821 - i) - (0 | l.timeoutMs || 5e3))) <= o
                              ? 0
                              : o + r - i)),
                      10 < r)
                    ) {
                      Fu(e, n), (e.timeoutHandle = yn(pu.bind(null, e), r));
                      break;
                    }
                  }
                  pu(e);
      ...
      function Jl(e) {
        ...
        if ((mu(), (e === kl && t === Ol) || nu(e, t), null !== Sl)) {
          var n = Cl;
          Cl |= 16;
          for (var r = ou(); ; )
            try {
          ...
          if ((ei(), (Cl = n), (bl.current = r), 1 === Tl)) throw ((n = _l), nu(e, t), Fu(e, t), Kl(e), n);
      ...
      function ru(e, t) {
        for (;;) {
          try {
            if ((ei(), (Ni.current = ga), $i))
              for (var n = Hi.memoizedState; null !== n; ) {
                var r = n.queue;
                null !== r && (r.pending = null), (n = n.next);
              }
            if (((Bi = 0), (Ui = Wi = Hi = null), ($i = !1), null === Sl || null === Sl.return))
              return (Tl = 1), (_l = t), (Sl = null);
            e: {
              var o = e,
                i = Sl.return,
                a = Sl,
      ...
      function su(e) {
        ...
        do {
          ...
          if (((e = Sl.return), 0 == (2048 & Sl.effectTag))) {
            if (((t = qa(t, Sl, Ol)), 1 === Ol || 1 !== Sl.childExpirationTime)) {
            ...
            if (null !== (t = Ka(Sl))) return (t.effectTag &= 2047), t;
      ...
      function du(e, t) {
        ...
        if (
          ...
          (gn = { activeElementDetached: null, focusedElem: l, selectionRange: u }), (Yt = !1), (jl = o);
          do {
            try {
              hu();
            } catch (e) {
              if (null === jl) throw Error(a(330));
              bu(jl, e), (jl = jl.nextEffect);
            }
          } while (null !== jl);
          jl = o;
          do {
          ...
          (Yt = !!mn), (gn = mn = null), (e.current = n), (jl = o);
          do {
            try {
              for (w = e; null !== jl; ) {
                var C = jl.effectTag;
                if ((36 & C && il(w, jl.alternate, jl), 128 & C)) {
                  x = void 0;
                  var k = jl.ref;
                  if (null !== k) {
                    var S = jl.stateNode;
        ...
        if (Nl) (Nl = !1), (Vl = e), (Bl = t);
        else for (jl = o; null !== jl; ) (t = jl.nextEffect), (jl.nextEffect = null), (jl = t);
        if (
          (0 === (t = e.firstPendingTime) && (Il = null),
          1073741823 === t ? (e === Ul ? Wl++ : ((Wl = 0), (Ul = e))) : (Wl = 0),
          'function' == typeof xu && xu(n.stateNode, r),
          Kl(e),
          Ll)
        )
          throw ((Ll = !1), (e = Rl), (Rl = null), e);
        return 0 != (8 & Cl) || Yo(), null;
      }
      function hu() {
        for (; null !== jl; ) {
          var e = jl.effectTag;
      ...
      function gu() {
        if (null === Vl) return !1;
        var e = Vl;
        if (((Vl = null), 0 != (48 & Cl))) throw Error(a(331));
        var t = Cl;
      ...
      function vu(e, t, n) {
        ci(e, (t = hl(e, (t = Za(n, t)), 1073741823))), null !== (e = Xl(e, 1073741823)) && Kl(e);
      }
      function bu(e, t) {
        if (3 === e.tag) vu(e, e, t);
        else
          for (var n = e.return; null !== n; ) {
            ...
            if (1 === n.tag) {
              ...
              if (
                ...
                ('function' == typeof r.componentDidCatch && (null === Il || !Il.has(r)))
              ) {
                ci(n, (e = ml(n, (e = Za(t, e)), 1073741823))), null !== (n = Xl(n, 1073741823)) && Kl(n);
                break;
              }
            }
            n = n.return;
      ...
      function yu(e, t, n) {
        ...
        null !== r && r.delete(t),
          kl === e && Ol === n
            ? Tl === El || (Tl === xl && 1073741823 === Pl && Vo() - Dl < 500)
              ? nu(e, Ol)
              : (Fl = !0)
            : zu(e, n) && ((0 !== (t = e.lastPingedTime) && t < n) || ((e.lastPingedTime = n), Kl(e)));
      }
      function wu(e, t) {
        var n = e.stateNode;
        null !== n && n.delete(t),
          0 === (t = 0) && (t = Ql((t = Yl()), e, null)),
          null !== (e = Xl(e, t)) && Kl(e);
      }
      gl = function (e, t, n) {
        var r = t.expirationTime;
                ...
                case 13:
                  if (null !== t.memoizedState)
                    return 0 !== (r = t.child.childExpirationTime) && r >= n
                      ? Ua(e, t, n)
                      : (co(Li, 1 & Li.current), null !== (t = Ga(e, t, n)) ? t.sibling : null);
                  co(Li, 1 & Li.current);
                  break;
                case 19:
        ...
        switch (((t.expirationTime = 0), t.tag)) {
          ...
          case 0:
            return (
              (r = t.type), (o = t.pendingProps), La(e, t, r, (o = t.elementType === r ? o : Xo(r, o)), n)
            );
          case 1:
            return (
              (r = t.type), (o = t.pendingProps), Ra(e, t, r, (o = t.elementType === r ? o : Xo(r, o)), n)
            );
          case 3:
            if ((Na(t), (r = t.updateQueue), null === e || null === r)) throw Error(a(282));
            if (
              ((r = t.pendingProps),
          ...
          case 11:
            return (
              (r = t.type), (o = t.pendingProps), za(e, t, r, (o = t.elementType === r ? o : Xo(r, o)), n)
            );
          case 7:
      ...
      (Vu.prototype.render = function (e) {
        ...
        (gt = function (e) {
          13 === e.tag && (Gl(e, 3), Nu(e, 3));
        }),
        (vt = function (e) {
          if (13 === e.tag) {
            var t = Yl();
            Gl(e, (t = Ql(t, e, null))), Nu(e, t);
          }
        }),
        (_ = function (e, t, n) {
          switch (t) {
    ...
    function (e, t, n) {
      ...
      function N(e, n) {
        ...
        var r = F;
        try {
          for (R(n), z = O(P); null !== z && (!(z.expirationTime > n) || (e && !a())); ) {
            var l = z.callback;
            if (null !== l) {
              (z.callback = null), (F = z.priorityLevel);
              var u = l(z.expirationTime <= n);
              (n = t.unstable_now()), 'function' == typeof u ? (z.callback = u) : z === O(P) && T(P), R(n);
            } else T(P);
            z = O(P);
          }
          if (null !== z) var c = !0;
      ...
      (t.unstable_IdlePriority = 5),
        ...
        (t.unstable_scheduleCallback = function (e, n, a) {
          ...
          return (
            ...
            u > l
              ? ((e.sortIndex = u), S(A, e), null === O(P) && e === O(A) && (L ? i() : (L = !0), o(I, u - l)))
              : ((e.sortIndex = a), S(P, e), j || D || ((j = !0), r(N))),
            e
          );
        }),
      ...
      e.exports = function e(t, n) {
        ...
        if (t && n && 'object' == typeof t && 'object' == typeof n) {
          ...
          if (c && s) {
            ...
            for (a = l; 0 != a--; ) if (!e(t[a], n[a])) return !1;
            return !0;
          }
          if (c != s) return !1;
          ...
          for (a = l; 0 != a--; ) if (!i.call(n, m[a])) return !1;
          for (a = l; 0 != a--; ) if (!e(t[(u = m[a])], n[u])) return !1;
          return !0;
        }
        return t != t && n != n;
      };
    ...
    function (e, t, n) {
      ...
      var c = Object(r.forwardRef)(function (e, t) {
          return o.a.createElement(l.Box, u({ ref: t, tx: 'text' }, e));
        }),
        s = Object(r.forwardRef)(function (e, t) {
          return o.a.createElement(
            l.Box,
            u({ ref: t, as: 'h2', tx: 'text', variant: 'heading' }, e, {
              __css: { fontSize: 4, fontFamily: 'heading', fontWeight: 'heading', lineHeight: 'heading' },
            }),
          );
        }),
        f =
          (Object(r.forwardRef)(function (e, t) {
            return o.a.createElement(l.Box, u({ ref: t, as: 'a', variant: 'link' }, e));
          }),
          Object(r.forwardRef)(function (e, t) {
            return o.a.createElement(
              l.Box,
              u({ ref: t, as: 'button', tx: 'buttons', variant: 'primary' }, e, {
                __css: {
                  appearance: 'none',
                  display: 'inline-block',
                  textAlign: 'center',
        ...
        p = Object(r.forwardRef)(function (e, t) {
          return o.a.createElement(
            l.Box,
            u({ ref: t, as: 'img' }, e, { __css: { maxWidth: '100%', height: 'auto' } }),
          );
        }),
        d = Object(r.forwardRef)(function (e, t) {
          return o.a.createElement(l.Box, u({ ref: t, variant: 'card' }, e));
        }),
        h = function () {
          return (h =
            Object.assign ||
      ...
      var g = function (e) {
          var t,
            ...
            a = e.children,
            u = e.username,
            c = m(e, ['sx', 'variant', 'children', 'username']);
          return r.createElement(
            ...
            h(
              ...
              c,
              { sx: h({ textAlign: 'center', borderRadius: '50%', lineHeight: '1em' }, n || {}) },
            ),
            a ||
              ((t = u)
                ? t
      ...
      var x,
        E = function (e) {
          var t = e.showWhenDisabled,
            ...
            c = w(e, ['showWhenDisabled', 'active', 'fullWidth', 'large', 'block', 'variant']),
            s = ('icon' === u || 'headerIcon' === u) && !t,
            p = c.disabled || (!c.onClick && !c.href);
          return r.createElement(
            f,
            y(
              {
                as: 'button',
                variant: 'button.' + u,
                className: b()({ active: n, large: i, disabled: c.disabled }),
                sx: y(y({}, a ? { borderRadius: 0 } : {}), {
                  alignSelf: 'center',
                  cursor: p ? 'not-allowed' : 'pointer',
                  letterSpacing: 0,
                  position: 'relative',
                  transition: 'all .2s ease',
                  '&:disabled, &.disabled': { boxShadow: 'none', display: s ? 'none' : void 0 },
                  width: o ? '100%' : null,
                }),
              },
              c,
        ...
        P = r.memo(function (e) {
          ...
          var s = r.useCallback(
            ...
            p = r.useCallback(
              function (e) {
                '<br>' !== e.target.value ? u(e.target.value) : u('');
              },
              [u],
            );
          return r.createElement(
            l.Flex,
            {
              ...
              onKeyDown: function (e) {
                s && 'Enter' === e.key && (e.preventDefault(), s());
              },
            },
            r.createElement(
              l.Flex,
              { flex: 1, pl: 4, alignItems: 'center', sx: { overflow: 'auto' } },
              r.createElement(_, { placeholder: 'Start typing a message…', html: a, onChange: p }),
            ),
            r.createElement(
              l.Flex,
              null,
              r.createElement(
                E,
                { variant: 'headerIcon', p: '28px', onClick: f },
                r.createElement(K, { icon: 'sync' }),
              ),
              r.createElement(
                l.Box,
                null,
                r.createElement(
                  ...
                  r.createElement(K, { icon: 'paper-plane' }),
                ),
              ),
            ),
          );
      ...
      function H(e) {
        return null === e
          ? null
          : 'object' === F(e) && e.prefix && e.iconName
          ? e
      ...
      function U(e) {
        var t = e.icon,
                ...
                (function (e) {
                  var t,
                    ...
                    p =
                      ...
                      D(t, 'fa-rotate-'.concat(s), null != s),
                      D(t, 'fa-pull-'.concat(f), null != f),
          ...
          u = W('transform', 'string' == typeof e.transform ? A.c.transform(e.transform) : e.transform),
          c = W('mask', H(n)),
          s = Object(A.a)(a, L({}, l, {}, u, {}, c, { symbol: r, title: i }));
        if (!s)
          return (
            (function () {
              var e;
        ...
        return (
          Object.keys(e).forEach(function (t) {
            U.defaultProps.hasOwnProperty(t) || (p[t] = e[t]);
          }),
          $(f[0], p)
        );
      }
      (U.displayName = 'FontAwesomeIcon'),
        (U.propTypes = {
          border: z.a.bool,
          className: z.a.string,
          mask: z.a.oneOfType([z.a.object, z.a.array, z.a.string]),
          fixedWidth: z.a.bool,
          inverse: z.a.bool,
          flip: z.a.oneOf(['horizontal', 'vertical', 'both']),
          icon: z.a.oneOfType([z.a.object, z.a.array, z.a.string]),
          listItem: z.a.bool,
          pull: z.a.oneOf(['right', 'left']),
          pulse: z.a.bool,
          rotation: z.a.oneOf([90, 180, 270]),
          size: z.a.oneOf(['lg', 'xs', 'sm', '1x', '2x', '3x', '4x', '5x', '6x', '7x', '8x', '9x', '10x']),
          spin: z.a.bool,
          symbol: z.a.oneOfType([z.a.bool, z.a.string]),
          title: z.a.string,
          transform: z.a.oneOfType([z.a.string, z.a.object]),
          swapOpacity: z.a.bool,
        }),
        (U.defaultProps = {
          border: !1,
          className: '',
      ...
      var $ = function e(t, n) {
          ...
          var o = (n.children || []).map(function (n) {
            ...
            u = R(r, ['style']);
          return (
            (i.attrs.style = L({}, i.attrs.style, {}, l)),
            t.apply(void 0, [n.tag, L({}, i.attrs, {}, u)].concat(I(o)))
          );
        ...
        X = Object(C.default)(function (e) {
          e.color, e.fontSize, e.opacity;
          var t = G(e, ['color', 'fontSize', 'opacity']);
          return r.createElement(U, Q({}, t));
        })(Object(Y.compose)(Y.space, Y.color, Y.fontSize));
      function q(e) {
        var t = e.icon,
          n = G(e, ['icon']),
          o = 'string' == typeof t ? ['fal', t] : t;
        return r.createElement(X, Q({ icon: o, style: { width: '1em' } }, n));
      }
      q.defaultProps = { color: 'inherit', fontSize: 'inherit' };
      var K = q,
        Z = function () {
          return (Z =
            Object.assign ||
      ...
      var te = function (e) {
        ...
        return (
          ...
          r.createElement(r.Fragment, null, a && n ? n : r.createElement(p, Z({ src: t }, o)))
        );
      };
      var ne = function () {
          return (ne =
      ...
      var oe = function (e) {
          var t = e.sx,
            ...
            o = e.inheritColor,
            i = e.variant,
            a = void 0 === i ? 'bodyPrimary' : i,
            l = re(e, ['sx', 'loading', 'inheritColor', 'variant']);
          return r.createElement(
            c,
            ne({ as: 'code' === a ? 'code' : 'p', variant: 'text.' + a }, l, {
              sx: ne(
                ne(
                  ne(
                    {
                      display: 'block',
                      fontWeight: 400,
                      letterSpacing: n ? '0px important' : 0,
                      m: 0,
                      maxWidth: '100%',
                      overflow: 'hidden',
      ...
      function ue(e, t, n) {
        var r = [n];
        if (t && e) for (var o in t) t.hasOwnProperty(o) && t[o] && r.push('' + le(e, o));
        return r
          .filter(function (e) {
            return e;
          })
      ...
      function fe(e) {
        return se(e) ? window.pageYOffset : e.scrollTop;
      }
      function pe(e, t) {
        se(e) ? window.scrollTo(0, t) : (e.scrollTop = t);
      }
      function de(e, t, n, r) {
        void 0 === n && (n = 200), void 0 === r && (r = ae);
        var o = fe(e),
          i = t - o,
          a = 0;
        !(function t() {
          var l,
            u = i * ((l = (l = a += 10) / n - 1) * l * l + 1) + o;
          pe(e, u), a < n ? window.requestAnimationFrame(t) : r(e);
        })();
      }
      function he() {
        try {
      ...
      function we(e) {
        ...
        switch (o) {
          ...
          case 'bottom':
            ...
            if (C >= d && !a) return i && de(u, k, 160), { placement: 'bottom', maxHeight: t };
            if ((!a && C >= r) || (a && x >= r))
              return i && de(u, k, 160), { placement: 'bottom', maxHeight: a ? x - b : C - b };
            if ('auto' === o || a) {
              var O = t,
                T = a ? w : E;
              return T >= r && (O = Math.min(T - b - l.controlHeight, t)), { placement: 'top', maxHeight: O };
            }
            if ('bottom' === o) return pe(u, k), { placement: 'bottom', maxHeight: t };
            break;
          case 'top':
            if (w >= d) return { placement: 'top', maxHeight: t };
            if (E >= d && !a) return i && de(u, S, 160), { placement: 'top', maxHeight: t };
            if ((!a && E >= r) || (a && w >= r)) {
              var _ = t;
              return (
                ((!a && E >= r) || (a && w >= r)) && (_ = a ? w - y : E - y),
                i && de(u, S, 160),
            ...
            return (
              ...
              (t.getUpdatedProps = function () {
                var e = t.props.menuPlacement,
                  n = t.state.placement || xe(e);
                return be({}, t.props, { placement: n, maxHeight: t.state.maxHeight });
              }),
              t
            );
          }
      ...
      Ee.contextTypes = { getPortalPlacement: z.a.func };
      var Ce = function (e) {
          var t = e.theme,
      ...
      Oe.defaultProps = { children: 'No options' };
      var Te = function (e) {
        var t = e.children,
          n = e.className,
          r = e.cx,
      ...
      var _e = (function (e) {
        function t() {
          ...
          return (
            ...
            (t.getPortalPlacement = function (e) {
              var n = e.placement;
              n !== xe(t.props.menuPlacement) && t.setState({ placement: n });
            }),
            t
          );
        }
        ...
        return (
          ...
          (n.render = function () {
            ...
            var c = this.state.placement || xe(o),
              s = (function (e) {
              ...
              p = { offset: s[c] + f, position: a, rect: s },
              d = Object(ie.d)('div', { css: l('menuPortal', p) }, n);
            return t ? Object(i.createPortal)(d, t) : d;
          }),
          t
        );
      })(r.Component);
      _e.childContextTypes = { getPortalPlacement: z.a.func };
        ...
        try {
          return (function e(t, n) {
            ...
            if (t && n && 'object' == typeof t && 'object' == typeof n) {
              ...
              if (s != f) return !1;
              if (s && f) return t.toString() == n.toString();
              var p = Ae(t);
              if ((o = p.length) !== Ae(n).length) return !1;
              for (r = o; 0 != r--; ) if (!Me.call(n, p[r])) return !1;
              for (r = o; 0 != r--; )
      ...
      var Le = {
        ...
        Ue = function (e) {
          var t = e.delay,
            n = e.offset;
          return Object(ie.d)('span', {
            css: Object(me.a)(
              {
                animation: We + ' 1s ease-in-out ' + t + 'ms infinite;',
        ...
        $e = function (e) {
          ...
          return Object(ie.d)(
            ...
            Object(ie.d)(Ue, { delay: 0, offset: i }),
            Object(ie.d)(Ue, { delay: 160, offset: !0 }),
            Object(ie.d)(Ue, { delay: 320, offset: !i }),
          );
        };
      function Ye() {
        return (Ye =
      ...
      var et = function (e) {
        var t = e.children,
          ...
          p = r.Label,
          d = r.Remove;
        return Object(ie.d)(ie.b, null, function (r) {
          var h = r.css,
            m = r.cx;
          return Object(ie.d)(
            f,
      ...
      et.defaultProps = { cropWithEllipsis: !0 };
      function nt() {
        return (nt =
          Object.assign ||
          function (e) {
      ...
      var it = {
        ...
        Group: function (e) {
          ...
          return Object(ie.d)(
            ...
            Object(ie.d)(i, Qe({}, a, { selectProps: c, theme: u, getStyles: o, cx: r }), l),
            Object(ie.d)('div', null, t),
          );
        },
        GroupHeading: function (e) {
          ...
          return Object(ie.d)(
            'div',
            Qe({ css: r('groupHeading', Qe({ theme: o }, i)), className: n({ 'group-heading': !0 }, t) }, i),
          );
        },
        IndicatorsContainer: function (e) {
          ...
          return Object(ie.d)(
            'div',
            { css: o('indicatorsContainer', e), className: r({ indicators: !0 }, n) },
            t,
          );
        },
        IndicatorSeparator: function (e) {
          ...
          return Object(ie.d)(
            'span',
            je({}, o, { css: r('indicatorSeparator', e), className: n({ 'indicator-separator': !0 }, t) }),
          );
        },
        Input: function (e) {
          var t = e.className,
          ...
          return Object(ie.d)(
            'div',
            { css: r('input', Ge({ theme: l }, u)) },
            Object(ie.d)(
              ve.a,
              Ge({ className: n({ input: !0 }, t), inputRef: o, inputStyle: Xe(i), disabled: a }, u),
            ),
          );
        },
        LoadingIndicator: $e,
        Menu: function (e) {
          ...
          return Object(ie.d)(
            'div',
            be({ css: o('menu', e), className: r({ menu: !0 }, n) }, a, { ref: i }),
            t,
          );
        },
        MenuList: function (e) {
          ...
          return Object(ie.d)(
            'div',
            { css: o('menuList', e), className: r({ 'menu-list': !0, 'menu-list--is-multi': i }, n), ref: a },
            t,
          );
        },
        MenuPortal: _e,
        ...
        NoOptionsMessage: Oe,
        MultiValue: et,
        MultiValueContainer: Ze,
        MultiValueLabel: Je,
        MultiValueRemove: function (e) {
          var t = e.children,
            n = e.innerProps;
          return Object(ie.d)('div', n, t || Object(ie.d)(Ie, { size: 14 }));
        },
        Option: function (e) {
          var t = e.children,
            n = e.className,
            ...
            tt(
              {
                css: o('option', e),
                className: r(
                  { option: !0, 'option--is-disabled': i, 'option--is-focused': a, 'option--is-selected': l },
                  n,
                ),
                ref: u,
              },
        ...
        Placeholder: function (e) {
          ...
          return Object(ie.d)(
            'div',
            nt({ css: o('placeholder', e), className: r({ placeholder: !0 }, n) }, i),
            t,
          );
        },
        SelectContainer: function (e) {
          ...
          return Object(ie.d)(
            'div',
            Fe({ css: o('container', e), className: r({ '--is-disabled': a, '--is-rtl': l }, n) }, i),
            t,
          );
        },
        ...
        ValueContainer: function (e) {
          ...
          return Object(ie.d)(
            'div',
            {
              ...
              className: r(
                { 'value-container': !0, 'value-container--is-multi': o, 'value-container--has-value': a },
                n,
              ),
            },
            t,
      ...
      var lt = function (e, t) {
        ...
        ct = function (e) {
          for (var t = 0; t < ut.length; t++) e = e.replace(ut[t].letters, ut[t].base);
          return e;
        };
      function st() {
        return (st =
      ...
      var ht = {
        ...
        mt = function (e) {
          return Object(ie.d)('span', dt({ css: ht }, e));
        };
      function gt() {
        return (gt =
          Object.assign ||
      ...
      var bt = (function (e) {
        ...
        yt = ['boxSizing', 'height', 'overflow', 'paddingRight', 'position'],
        wt = { boxSizing: 'border-box', overflow: 'hidden', position: 'relative', height: '100%' };
      function xt(e) {
        e.preventDefault();
      }
      function Et(e) {
      ...
      var St = !(!window.document || !window.document.createElement),
        Ot = 0,
        Tt = (function (e) {
          var t, n;
          function r() {
          ...
          return (
            (o.componentDidMount = function () {
              ...
              if (St) {
                ...
                o &&
                  kt() &&
                  (o.addEventListener('touchmove', xt, this.listenerOptions),
                  r &&
                    (r.addEventListener('touchstart', Ct, this.listenerOptions),
                    r.addEventListener('touchmove', Et, this.listenerOptions))),
                  (Ot += 1);
              }
            }),
            (o.componentWillUnmount = function () {
              ...
              if (St) {
                ...
                (Ot = Math.max(Ot - 1, 0)),
                  ...
                  o &&
                    kt() &&
                    (o.removeEventListener('touchmove', xt, this.listenerOptions),
                    r &&
                      (r.removeEventListener('touchstart', Ct, this.listenerOptions),
                      r.removeEventListener('touchmove', Et, this.listenerOptions)));
              }
            }),
            (o.render = function () {
              return null;
      ...
      var _t = { name: '1dsbpcp', styles: 'position:fixed;left:0;bottom:0;right:0;top:0;' },
        Pt = (function (e) {
          var t, n;
          function r() {
            for (var t, n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o];
            ...
            (r.prototype.render = function () {
              ...
              return n
                ? Object(ie.d)(
                    'div',
                    null,
                    Object(ie.d)('div', { onClick: this.blurSelectInput, css: _t }),
                    Object(ie.d)(bt, { innerRef: this.getScrollTarget }, t),
                    r ? Object(ie.d)(Tt, { touchScrollTarget: r }) : null,
                  )
                : t;
            }),
            r
      ...
      var At = (function (e) {
          ...
          return (
            ...
            (t.handleEventDelta = function (e, n) {
              ...
              h > n && t.isBottom && (i && i(e), (t.isBottom = !1)),
                ...
                d && n > h
                  ? (o && !t.isBottom && o(e), (p.scrollTop = s), (m = !0), (t.isBottom = !0))
                  : !d && -n > c && (a && !t.isTop && a(e), (p.scrollTop = 0), (m = !0), (t.isTop = !0)),
                m && t.cancelScroll(e);
            }),
        ...
        return (
          ...
          (i.render = function () {
            return o.a.createElement(bt, { innerRef: this.getScrollTarget }, this.props.children);
          }),
          r
        );
      })(r.Component);
      function Mt(e) {
        ...
        return n ? o.a.createElement(At, r) : r.children;
      }
      var zt = function (e, t) {
          void 0 === t && (t = {});
          var n = t,
      ...
      var Nt,
        Vt = {
          ...
          filterOption: function (e, t) {
            var n = st({ ignoreCase: !0, ignoreAccents: !0, stringify: pt, trim: !0, matchFrom: 'any' }, Nt),
              r = n.ignoreCase,
              o = n.ignoreAccents,
              i = n.stringify,
              a = n.trim,
        ...
        Ht = (function (e) {
          ...
          function r(t) {
            ...
            ((n = e.call(this, t) || this).state = {
              ...
              (n.cacheComponents = function (e) {
                n.components = ot({}, it, { components: e }.components);
              }),
              (n.focus = n.focusInput),
              (n.blur = n.blurInput),
              (n.onChange = function (e, t) {
                var r = n.props;
                (0, r.onChange)(e, Rt({}, t, { name: r.name }));
              }),
              ...
              (n.announceAriaLiveSelection = function (e) {
                var t = e.event,
                  r = e.context;
                n.setState({ ariaLiveSelection: Ft(t, r) });
              }),
              (n.announceAriaLiveContext = function (e) {
                var t = e.event,
                  r = e.context;
                n.setState({ ariaLiveContext: zt(t, Rt({}, r, { label: n.props['aria-label'] })) });
              }),
              ...
              (n.onScroll = function (e) {
                'boolean' == typeof n.props.closeMenuOnScroll
                  ? e.target instanceof HTMLElement && se(e.target) && n.props.onMenuClose()
                ...
                if (!(u || ('function' == typeof s && (s(e), e.defaultPrevented)))) {
                  switch (((n.blockOptionHover = !0), e.key)) {
                    ...
                    case 'Tab':
                      ...
                      if (e.shiftKey || !c || !f || !h || (p && n.isOptionSelected(h, g))) return;
                      n.selectOption(h);
                      break;
                    case 'Enter':
                ...
                var r = e.inputValue,
                  ...
                  a = function (e, r) {
                    ...
                    if (
                      ...
                      return {
                        innerProps: { id: f, onClick: s, onMouseMove: c, onMouseOver: c, tabIndex: -1 },
                        data: e,
                        isDisabled: i,
                        isSelected: a,
                        key: f,
            ...
            var r = t.value;
            (n.cacheComponents = lt(n.cacheComponents, ze).bind(It(It(n)))),
              n.cacheComponents(t.components),
              (n.instancePrefix = 'react-select-' + (n.props.instanceId || ++Bt));
            var o = ce(r);
            n.buildMenuOptions = lt(n.buildMenuOptions, function (e, t) {
              var n = e,
                r = n[0],
                o = n[1],
                i = t,
                a = i[0];
              return ze(o, i[1]) && ze(r.inputValue, a.inputValue) && ze(r.options, a.options);
            }).bind(It(It(n)));
          ...
          return (
            ...
            (i.UNSAFE_componentWillReceiveProps = function (e) {
              ...
              if (
                ...
                var a = ce(e.value),
                  ...
                  c = this.getNextFocusedOption(l.focusable);
                this.setState({ menuOptions: l, selectValue: a, focusedOption: c, focusedValue: u });
              }
            ...
            (i.componentDidUpdate = function (e) {
              ...
              ((c && !l && e.isDisabled) || (c && u && !e.menuIsOpen)) && this.focusInput(),
                this.menuListRef &&
                  ...
                  (i = n.offsetHeight / 3),
                  o.bottom + i > r.bottom
                    ? pe(t, Math.min(n.offsetTop + n.clientHeight - t.offsetHeight + i, t.scrollHeight))
                    : o.top - i < r.top && pe(t, Math.max(n.offsetTop - i, 0)),
            ...
            (i.openMenu = function (e) {
              ...
              (this.scrollToFocusedOptionOnUpdate = !(o && this.menuListRef)),
                ...
                this.setState(
                  { menuOptions: i, focusedValue: null, focusedOption: i.focusable[l] },
                  function () {
            ...
            (i.focusOption = function (e) {
              ...
              if (o.length) {
                ...
                r || ((a = -1), this.announceAriaLiveContext({ event: 'menu' })),
                  ...
                  this.announceAriaLiveContext({ event: 'menu', context: { isDisabled: Dt(o[i]) } });
              }
            }),
            (i.getTheme = function () {
            ...
            (i.constructAriaLiveMessage = function () {
              ...
              return (
                ...
                })({ inputValue: u, screenReaderMessage: c({ count: this.countOptions() }) }) +
                ' ' +
                t
              );
            }),
            ...
            (i.renderPlaceholderOrValue = function () {
              ...
              if (!this.hasValue() || !f)
                return h
                  ? null
                  : o.a.createElement(u, Rt({}, c, { key: 'placeholder', isDisabled: p, isFocused: y }), m);
              if (d)
            ...
            (i.renderClearIndicator = function () {
              ...
              return o.a.createElement(e, Rt({}, t, { innerProps: l, isFocused: a }));
            }),
            (i.renderLoadingIndicator = function () {
              ...
              return o.a.createElement(
                e,
                Rt({}, t, { innerProps: { 'aria-hidden': 'true' }, isDisabled: r, isFocused: a }),
              );
            }),
            (i.renderIndicatorSeparator = function () {
              ...
              var r = this.commonProps,
                ...
                a = this.state.isFocused;
              return o.a.createElement(n, Rt({}, r, { isDisabled: i, isFocused: a }));
            }),
            (i.renderDropdownIndicator = function () {
              ...
              return o.a.createElement(e, Rt({}, t, { innerProps: i, isDisabled: n, isFocused: r }));
            }),
              ...
              var M,
                z = function (t) {
                  ...
                  return (
                    ...
                    o.a.createElement(s, Rt({}, f, t, { isFocused: n }), e.formatOptionLabel(t.data, 'menu'))
                  );
                };
              if (this.hasOptions())
                M = h.render.map(function (t) {
                  if ('group' === t.type) {
                    t.type;
                    var i = (function (e, t) {
                        if (null == e) return {};
                ...
                var F = y({ inputValue: v });
                if (null === F) return null;
                M = o.a.createElement(u, f, F);
              } else {
                var D = _({ inputValue: v });
                if (null === D) return null;
                M = o.a.createElement(c, f, D);
              }
              var j = {
                  minMenuHeight: w,
                  maxMenuHeight: x,
                ...
                L = o.a.createElement(Ee, Rt({}, f, j), function (t) {
                  var n = t.ref,
                    r = t.placerProps,
                    l = r.placement,
                    u = r.maxHeight;
                  return o.a.createElement(
                    ...
                    o.a.createElement(
                      Mt,
                      { isEnabled: g, onTopArrive: P, onBottomArrive: A },
                      o.a.createElement(
                        Pt,
                        { isEnabled: O },
                        o.a.createElement(
                          a,
                          Rt({}, f, { innerRef: e.getMenuListRef, isLoading: b, maxHeight: u }),
                          M,
                        ),
                      ),
                    ),
            ...
            (i.renderFormField = function () {
              ...
              if (a && !r) {
                if (i) {
                  if (n) {
                    var u = l
                      ...
                      .join(n);
                    return o.a.createElement('input', { name: a, type: 'hidden', value: u });
                  }
                  var c =
                    l.length > 0
                      ? l.map(function (t, n) {
                ...
                return o.a.createElement('input', { name: a, type: 'hidden', value: s });
              }
            }),
            (i.renderLiveRegion = function () {
              return this.state.isFocused
                ? o.a.createElement(
                    mt,
                    { 'aria-live': 'polite' },
                    o.a.createElement('p', { id: 'aria-selection-event' }, ' ', this.state.ariaLiveSelection),
      ...
      var Jt = function (e, t) {
        ...
        en = Object(Kt.a)(function (e) {
          return Object(Kt.a)(function (t) {
            return Jt(e, t);
          });
        }),
        tn = function (e) {
          return Object(r.createElement)(ie.c.Consumer, null, function (t) {
            return (
              e.theme !== t && (t = en(t)(e.theme)),
              Object(r.createElement)(ie.c.Provider, { value: t }, e.children)
            );
          });
        };
      n(5);
      var nn = function () {
        ...
        rn = Object(C.default)(d)(Y.borderRadius);
      function on(e) {
        return r.createElement(rn, nn({}, e));
      }
      on.defaultProps = { bg: 'neutral_0', borderRadius: 'normal', boxShadow: 'card', p: 3 };
      var an = function () {
          return (an =
            Object.assign ||
            function (e) {
      ...
      var un = function (e) {
          var t = e.sx,
            ...
            i = void 0 === o ? 'h3' : o,
            a = e.loading,
            l = ln(e, ['sx', 'inheritColor', 'variant', 'loading']);
          return r.createElement(
            s,
            an({ as: i, variant: 'heading.' + i }, l, {
              sx: an(
                an(
                  an(
                    {
                ...
                a ? { letterSpacing: '0px', color: 'neutral_2 !important' } : {},
              ),
            }),
          );
        },
      ...
      var fn = function (e) {
          var t = e.reverseAlign,
            n = void 0 !== t && t,
            o = e.children,
            i = e.text,
            a = e.contents,
            u = e.username,
            c = sn(e, ['reverseAlign', 'children', 'text', 'contents', 'username']),
            s = r.useMemo(
              function () {
                return n ? 'primary' : 'secondary';
              },
              [n],
            );
          return r.createElement(
            l.Flex,
            cn({ flexDirection: n ? 'row-reverse' : 'row' }, c),
            r.createElement(
              g,
              cn({ variant: 'medium', username: u }, n ? { ml: 2 } : { mr: 2 }),
              !u && r.createElement(K, { icon: ['fas', 'robot'] }),
            ),
            r.createElement(
              l.Flex,
              { flexDirection: 'column', style: { maxWidth: '320px' } },
              a &&
                a.image &&
                r.createElement(te, { src: a.image, width: 1, sx: { borderRadius: '16px 16px 0 0' } }),
              r.createElement(
                hn,
                {
                  reverseAlign: n,
                  variant: s,
                  borderRadius: a && a.image ? '0 0 16px 16px' : null,
                  sx: i || o ? {} : { color: 'neutral_6', fontStyle: 'italic' },
                },
                i || 'There is no response text here',
              ),
              r.createElement(mn, { buttons: a && a.buttons }),
            ),
          );
        },
        pn = function () {
      ...
      var hn = function (e) {
        var t = e.sx,
          ...
          u = e.borderRadius,
          c = dn(e, ['sx', 'reverseAlign', 'variant', 'borderRadius']);
        return r.createElement(
          l.Box,
          pn(
            {
              ...
              width: [0, 'stretch'],
              fontSize: 2,
              variant: 'messageBubble.' + a,
              sx: pn(
                pn(
                  pn({ letterSpacing: 0, lineHeight: 'normal', overflowWrap: 'break-word' }, t || {}),
                  o ? { alignSelf: 'flex-end' } : { alignSelf: 'flex-start' },
                ),
                u
                  ? { borderRadius: u }
                  : o
        ...
        return o && 0 !== o.length
          ? r.createElement(
              ...
              Array.isArray(o) &&
                r.createElement(
                  l.Flex,
                  { mt: 2, px: '12px', flexWrap: 'wrap' },
                  o.map(function (e, n) {
                    return r.createElement(
                      E,
                      {
                        disabled: !t,
                        key: (e && e.payload) || 'new-button-' + n,
                        onClick: function (n) {
                          n.stopPropagation(), t && t(e ? e.payload : '');
                        },
                        mr: 1,
                        mb: 1,
                        variant: 'primary',
                      },
                      (e && e.title) || 'New Button',
                    );
                  }),
                ),
            )
      ...
      function bn(e) {
        var t = e.actions,
          ...
          s = e.imageStyle,
          f = void 0 === s ? {} : s,
          p = vn(e, ['actions', 'body', 'heading', 'image', 'imageAlt', 'imageWidth', 'imageStyle']);
        return r.createElement(
          l.Flex,
          gn(
            {
          ...
          i && r.createElement(te, { mb: 4, width: c, src: i, alt: a, style: f }),
          o && r.createElement(un, { variant: 'h4' }, o),
          r.createElement(
            oe,
            {
              as: 'div',
          ...
          t && r.createElement(l.Box, { mt: 3 }, t),
        );
      }
      bn.defaultProps = { bg: 'neutral_0' };
      var yn = bn;
      n(26);
      var wn = function () {
          return (wn =
        ...
        xn = {
          ...
          px: 3,
          py: '6px',
          '&.large': { fontSize: 2, py: '10px' },
          '&:hover': { bg: 'primary_1' },
          '&:disabled, &.disabled': { color: 'neutral_6', bg: 'neutral_3', boxShadow: 'none' },
        },
        En = {
          bg: 'transparent',
          border: 'none',
          ...
          lineHeight: 0,
          p: 2,
          '&:hover': { color: 'neutral_7' },
          '&.active': { color: 'primary_1' },
        },
        Cn = {
          primary: xn,
          primaryDark: wn(wn({}, xn), { boxShadow: 'none' }),
          login: wn(wn({}, xn), { letterSpacing: '1.1px !important', lineHeight: '28px' }),
          secondary: {
            bg: 'transparent',
            border: '1px solid',
            ...
            px: 3,
            py: '5px',
            '&.large': { fontSize: 2, py: '9px' },
            '&:hover': { borderColor: 'primary_1', color: 'primary_1' },
            '&:disabled, &.disabled': { borderColor: 'neutral_5', color: 'neutral_6' },
          },
          dark: {
            bg: 'neutral_8',
            borderRadius: 'normal',
          ...
          icon: {
            ...
            lineHeight: 0,
            p: '12px',
            '&.active': { bg: 'transparent', color: 'primary_2' },
            '&:hover': { bg: 'primary_2', color: 'neutral_0' },
          },
          headerIcon: {
            bg: 'neutral_0',
            border: 'none',
            ...
            lineHeight: 0,
            p: '28px',
            '&.active': { bg: 'primary_2', color: 'neutral_0' },
            '&:hover': {
              '&.active': { bg: 'primary_1', color: 'neutral_0' },
              bg: 'neutral_1',
              color: 'neutral_6',
            },
          },
          plainIcon: En,
          plainIconDark: wn(wn({}, En), { '&:hover': wn(wn({}, En['&:hover']), { color: 'neutral_1' }) }),
          barIcon: {
            bg: 'transparent',
            border: 'none',
            borderRadius: 0,
          ...
          onboardingIcon: wn(wn({}, xn), {
            ...
            width: '48px',
            height: '48px',
            '&:hover': { bg: 'neutral_1', color: 'neutral_7' },
            '&.active': { color: 'primary_1' },
          }),
        },
        kn = {
          alert: {
            primary: { bg: 'primary_2', color: 'neutral_0' },
            error: { bg: 'secondary_2', color: 'neutral_0' },
            success: { bg: 'cyan_3', color: '#56bdba', borderColor: 'cyan_2', border: 'solid 1px' },
            alertThatUsesColoursThatArentInTheStyleguide: {
              bg: '#e8fff7',
              color: '#56bdba',
              border: 'solid 1px',
              borderColor: '#88deca',
          ...
          messageBubble: {
            primary: { bg: 'primary_2', color: 'neutral_0' },
            secondary: { bg: 'neutral_3', color: 'neutral_8' },
            flagged: { bg: 'secondary_2', color: 'neutral_0' },
            neutral: { bg: 'neutral_0', color: 'neutral_8' },
            custom: { bg: 'neutral_3', color: 'neutral_8', padding: 0 },
          },
          separator: {
            left: { '& > :first-of-type': { pr: '12px' }, '&:before': { display: 'none' } },
            center: { '& > :first-of-type': { px: '12px' } },
            right: { '& > :first-of-type': { pl: '12px' }, '&:after': { display: 'none' } },
          },
        },
        Sn = {
          button: Cn,
          option: {
            default: { color: 'neutral_8', '&:hover': { bg: 'neutral_1' } },
            primary: {
              color: 'primary_2',
              '&:hover': {
                bg: 'neutral_1',
        ...
        On = {
          text: {
            bodyPrimary: { color: 'neutral_8', fontSize: 3, lineHeight: 'normal' },
            bodySecondary: { color: 'neutral_8', fontSize: 2, lineHeight: 'normal' },
            captionPrimary: { color: 'neutral_6', fontSize: 2, lineHeight: 'small' },
            captionSecondary: { color: 'neutral_6', fontSize: 0, lineHeight: 'tight' },
            metadata: { color: 'neutral_7', fontSize: 0, lineHeight: 'tight' },
            code: { color: 'neutral_8', fontFamily: 'IBM Plex Mono', fontSize: 1, lineHeight: 'normal' },
          },
          heading: {
            h1: { fontSize: 6 },
            h2: { fontSize: 4 },
        ...
        Pn = {
          breakpoints: ['0', '500px', '800px', '1200px', '1900px'],
          colors: _n,
          colours: _n,
          fontSizes: [11, 12, 13, 14, 16, 20, 24, 32, 48, 64, 72],
          fontWeights: Tn,
          gradients: { primary_1: 'linear-gradient(56deg, rgba(113, 22, 208, 0.95), #4e61e1)' },
          heights: [32, 40, 48, 56, 64],
          letterSpacings: [0.6, 0.7, 0.9, 1.4],
          lineHeights: { large: '36px', big: '24px', normal: '20px', small: '16px', tight: '12px' },
          space: [0, 4, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 128, 256, 512],
          fonts: {
            mono: '"IBM Plex Mono", "Courier New", Courier, monospace',
            sansSerif:
              '"Lato", -apple-system, BlinkMacSystemFont, "avenir next", avenir, "helvetica neue", helvetica, ubuntu, roboto, noto, "segoe ui", arial, sans-serif',
          },
          active: { background: _n.active },
          radii: { tiny: '2px', small: '4px', normal: '8px', large: '16px' },
          actions: {
            default: { color: _n.neutral_6 },
            incorrect: { color: _n.neutral_6, textDecoration: 'line-through' },
            correct: { color: _n.primary_2, fontWeight: Tn[1] },
          },
          shadows: {
            sm: '0 6px 21px 0 rgba(152, 152, 152, 0.06)',
            md: '0 3px 6px 0 rgba(96,97,149,0.20)',
            lg: '0 11px 43px 0 rgba(120, 119, 150, 0.1)',
            selectBox: '0 2px 8px 0 ' + _n.neutral_5,
            card: '0 2px 4px 0 rgba(207, 207, 207, 0.21)',
            button: '0 2px 4px 0 rgba(207, 207, 207, 0.67)',
          },
          menuItem: {
            default: {
              color: _n.neutral_6,
              backgroundColor: 'transparent',
              '&:hover': { color: _n.neutral_0, backgroundColor: _n.dark_2 },
            },
          },
          text: On,
          buttons: Sn,
        ...
        An = function (e) {
          var t = e.children;
          return r.createElement(tn, { theme: Pn }, t);
        },
        Mn = {
          prefix: 'fas',
          iconName: 'arrow-left',
        ...
        ar = {
          ...
          icon: [
            ...
            [],
            'f086',
            'M569.9 441.1c-.5-.4-22.6-24.2-37.9-54.9 27.5-27.1 44-61.1 44-98.2 0-80-76.5-146.1-176.2-157.9C368.4 72.5 294.3 32 208 32 93.1 32 0 103.6 0 192c0 37 16.5 71 44 98.2-15.3 30.7-37.3 54.5-37.7 54.9-6.3 6.7-8.1 16.5-4.4 25 3.6 8.5 12 14 21.2 14 53.5 0 96.7-20.2 125.2-38.8 9.1 2.1 18.4 3.7 28 4.8 31.5 57.5 105.5 98 191.8 98 20.8 0 40.8-2.4 59.8-6.8 28.5 18.5 71.6 38.8 125.2 38.8 9.2 0 17.5-5.5 21.2-14 3.6-8.5 1.9-18.3-4.4-25zM155.4 314l-13.2-3-11.4 7.4c-20.1 13.1-50.5 28.2-87.7 32.5 8.8-11.3 20.2-27.6 29.5-46.4L83 283.7l-16.5-16.3C50.7 251.9 32 226.2 32 192c0-70.6 79-128 176-128s176 57.4 176 128-79 128-176 128c-17.7 0-35.4-2-52.6-6zm289.8 100.4l-11.4-7.4-13.2 3.1c-17.2 4-34.9 6-52.6 6-65.1 0-122-25.9-152.4-64.3C326.9 348.6 416 278.4 416 192c0-9.5-1.3-18.7-3.3-27.7C488.1 178.8 544 228.7 544 288c0 34.2-18.7 59.9-34.5 75.4L493 379.7l10.3 20.7c9.4 18.9 20.8 35.2 29.5 46.4-37.1-4.2-67.5-19.4-87.6-32.4z',
          ],
        },
        lr = {
          prefix: 'fal',
        ...
        vr = {
          ...
          icon: [
            ...
            [],
            'f672',
            'M320,64A112.14,112.14,0,0,0,208,176a16,16,0,0,0,32,0,80.09,80.09,0,0,1,80-80,16,16,0,0,0,0-32Zm0-64C217.06,0,143.88,83.55,144,176.23a175,175,0,0,0,43.56,115.55C213.22,321,237.84,368.69,240,384l.06,75.19a15.88,15.88,0,0,0,2.69,8.83l24.5,36.84A16,16,0,0,0,280.56,512h78.85a16,16,0,0,0,13.34-7.14L397.25,468a16.17,16.17,0,0,0,2.69-8.83L400,384c2.25-15.72,27-63.19,52.44-92.22A175.9,175.9,0,0,0,320,0Zm47.94,454.31L350.84,480H289.12l-17.06-25.69,0-6.31h95.91ZM368,416H272l-.06-32H368Zm60.41-145.31c-14,15.95-36.32,48.09-50.57,81.29H262.22c-14.28-33.21-36.6-65.34-50.6-81.29A143.47,143.47,0,0,1,176.06,176C175.88,99,236.44,32,320,32c79.41,0,144,64.59,144,144A143.69,143.69,0,0,1,428.38,270.69ZM96,176a16,16,0,0,0-16-16H16a16,16,0,0,0,0,32H80A16,16,0,0,0,96,176ZM528,64a16.17,16.17,0,0,0,7.16-1.69l64-32A16,16,0,0,0,584.84,1.69l-64,32A16,16,0,0,0,528,64Zm96,96H560a16,16,0,0,0,0,32h64a16,16,0,0,0,0-32ZM119.16,33.69l-64-32A16,16,0,0,0,40.84,30.31l64,32A16.17,16.17,0,0,0,112,64a16,16,0,0,0,7.16-30.31Zm480,288-64-32a16,16,0,0,0-14.32,28.63l64,32a16,16,0,0,0,14.32-28.63ZM112,288a16.17,16.17,0,0,0-7.16,1.69l-64,32a16,16,0,0,0,14.32,28.63l64-32A16,16,0,0,0,112,288Z',
          ],
        },
        br = {
          prefix: 'fal',
        ...
        Br = function () {
          for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Vr(arguments[t]));
          return e;
        },
        Hr = [
          Yn,
      ...
      var Wr = {
          ...
          TRAINING: 'training',
          DEPLOYING: 'deploying',
          NEEDS_TO_BE_RETRAINED: 'needs_to_be_retrained',
          READY: 'ready',
        },
        Ur = { border: 0, margin: 0 };
      function $r(e) {
        var t = e.onTrainClick,
          n = e.placeholderImage;
        switch (e.state) {
          case Wr.READY:
          default:
            return r.createElement(yn, {
              image: n,
              imageStyle: Ur,
              heading: 'Talk to your assistant!',
              body: 'Your assistant has been trained! Type something to test it out...',
            });
          case Wr.NOT_TRAINED:
            return r.createElement(yn, {
              image: n,
              imageStyle: Ur,
              body: r.createElement(E, { large: !0, onClick: t }, 'Train'),
            });
          case Wr.TRAINING:
            return r.createElement(yn, {
              image: n,
              ...
              body: r.createElement(
                E,
                { large: !0 },
                r.createElement(K, { icon: ['fas', 'spinner'], spin: !0, mr: 2 }),
                'Training...',
              ),
            });
          case Wr.DEPLOYING:
            return r.createElement(yn, {
              ...
              body: 'Deploying model...',
            });
          case Wr.NEEDS_TO_BE_RETRAINED:
            return r.createElement(yn, {
              image: n,
              imageStyle: Ur,
              heading: 'You made some changes.',
              body: r.createElement(
                r.Fragment,
                null,
                r.createElement(l.Box, { mb: 4 }, 'Train a new model to talk to the updated assistant.'),
                r.createElement(E, { large: !0, onClick: t }, 'Train'),
              ),
            });
        }
      }
      function Yr(e) {
            ...
            function () {
              return (
                ...
                a.events
                  ...
                  .reverse()
                  .filter(function (e) {
                    return 'user' === e.event || 'bot' === e.event;
                  })
              );
            },
            [a],
        ...
        return r.createElement(
          l.Flex,
          { flexDirection: 'column', sx: { height: '100%' } },
          c && c.length > 0 && i == Wr.READY
            ? r.createElement(
                l.Flex,
                { flexDirection: 'column-reverse', sx: { height: '100%', overflow: 'auto' }, px: 4, py: 3 },
                c.map(function (e, t) {
                  return r.createElement(
                    l.Box,
                    { my: 2, key: t },
                    r.createElement(fn, {
                      username: 'user' === e.event ? u : null,
                      contents: e.data,
                      reverseAlign: 'user' === e.event,
                      text: e.text,
                    }),
                  );
                }),
            ...
            : r.createElement(
                ...
                r.createElement($r, { onTrainClick: n, placeholderImage: o, state: i }),
              ),
          i === Wr.READY &&
            r.createElement(
              l.Flex,
              { sx: { borderTop: 'solid 1px', borderColor: 'neutral_4', marginTop: 'auto' } },
              r.createElement(P, { onSendMessage: t }),
            ),
        );
      }
      var Qr = n(27),
