...
:::note Legacy Docs These docs are for Rasa Open Source 3.0 and later. You can find documentation for Rasa Open Source 2.x <a href="https://rasa.com/docs/rasa/2.x/" target="_blank" rel="nofollow noopener noreferrer">here</a>. :::
