...
```python (versioned_docs/version-3.x/data/test_classes/nlu_component_skeleton.py)
```
...
```python (versioned_docs/version-3.x/data/test_classes/graph_component_interface.py)
```
...
```python (versioned_docs/version-3.x/data/test_classes/registered_component.py)
```
...
```python (versioned_docs/version-3.x/data/test_classes/custom_graph_components/nlu_dense.py)
```
...
```python (versioned_docs/version-3.x/data/test_classes/custom_graph_components/nlu_sparse.py)
```
