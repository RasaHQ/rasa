...
```yaml-rasa (versioned_docs/version-2.2.x/sources/data/configs_for_docs/example_for_suggested_config.yml)
```
...
```yaml-rasa (versioned_docs/version-2.2.x/sources/data/configs_for_docs/example_for_suggested_config_after_train.yml)
```
