...
:::version-change Deprecated in 2.1
...
* **Configuration**
  ...
  :::version-change-inline Changed in 2.1
  Pre-trained weights have been renamed from `bert-base-uncased` to `rasa/LaBSE`.
  (TODO: not sure if it's the right comment here, or if we even need to document it)
  :::
...
* **Configuration**
  ...
  :::version-change-inline Changed in 2.1
  TODO: do we need to explain the config changes here?
  :::
...
+---------------------------------+------------------+--------------------------------------------------------------+
| split_entities_by_comma         | True             | New in 2.1 (TODO)                                            |
|                                 |                  | Splits a list of extracted entities by comma to treat each   |
...
* **Configuration**
  ...
  * `BILOU_flag` determines whether to use BILOU tagging or not. Default `True`.
  ...
  :::version-change-inline New in 2.1
...
```python (versioned_docs/version-2.x/sources/tests/nlu/example_component.py)
```
