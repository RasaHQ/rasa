...
Support for Spacy 3 was added. To install spaCy with its language model for the English language in prior versions of Rasa Open Source,
 you need to additionally run
