...
.. testcode::
    ...
    interpreter = Interpreter.load(model_directory,
                                   config.load("sample_configs/config_spacy.yml"))
...
.. testcode::
    ...
    interpreter = Interpreter.load(model_directory, cfg, builder)     # to use the builder, pass it as an arg when loading the model
    # the clone will share resources with the first model, as long as the same builder is passed!
    interpreter_clone = Interpreter.load(model_directory, cfg, builder)
