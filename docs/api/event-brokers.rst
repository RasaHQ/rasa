...
------ a
 a
All events are streamed to the broker as serialized dictionaries every time a
...
.. code-block:: python a
 ...
 a
 a
The host variable can be either a list of brokers addresses or a single one. a
...
machines, it's important to use ssl protocol to assure encryption of data and client a
