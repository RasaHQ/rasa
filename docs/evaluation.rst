...
The evaluation script `evaluate.py` allows you to test your models performance for intent classification and entity recognition. You invoke this script supplying test data, model, config file and evaluation mode arguments:

.. code-block:: bash

    python -m rasa_nlu.evaluate -d data/my_test.json -m models/my_model -c my_nlu_config.json --mode evaluation
