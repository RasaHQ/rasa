...
`here <https://github.com/RasaHQ/rasa/tree/master/examples/reminderbot/README.md>`_. a
 a
.. contents:: a
   :local: a
 a
...
For example, some moisture-sensor attached to a Raspberry Pi should inform your personal assistant that your favorite a
