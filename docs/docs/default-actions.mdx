...
now handles all [two-stage fallback behaviour](./fallback-handoff.mdx)
:::
...
the intent of their message. This action can be customised to be more personalised
to your specific use case.

<!-- TODO: should we show how to personalise this here? -->
