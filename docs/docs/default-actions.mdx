...
|`action_deactivate_loop`         |Deactivate the active loop and reset the requested slot. See also See also [Handling unhappy paths](./forms.mdx#writing-stories--rules-for-unhappy-form-paths).                                                                                                                                                                                                                                                                                                                                                             |
