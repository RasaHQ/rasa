...
Rasa Open Source triggers `action_unlikely_intent` via [`IntentTEDPolicy`](./policies.mdx#intenttedpolicy).
You can control how often this action is predicted by tuning the [`tolerance`](./policies.mdx#intenttedpolicy)
