...
You need to include the [ResponseSelector](./components/selectors.mdx#responseselector) component in your config. The component needs a tokenizer, a featurizer and an
