...
multiple policies in a single [`rasa.core.agent.Agent`](../agent.mdx#rasa.core.agent.Agent).
...
the full conversation history. See [Featurization of Conversations](../core-featurization.mdx#featurization-conversations) for details.
...
(see [Featurization of Conversations](../core-featurization.mdx#featurization-conversations) for details).
...
use `MaxHistoryTrackerFeaturizer` for **faster training**. See [Featurization of Conversations](../core-featurization.mdx#featurization-conversations) for
