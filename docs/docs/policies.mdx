...
:::caution
The `FallbackPolicy` is deprecated. Please see [Fallback Actions](./extra/fallback-actions.mdx) how to implement
its behavior using the [Rule Policy](./policies.mdx#rule-policy). If you previously used
...
:::caution
The `TwoStageFallbackPolicy` is deprecated. Please see [Fallback Actions](./extra/fallback-actions.mdx) how to implement
its behavior using the [Rule Policy](./policies.mdx#rule-policy). If you previously used
