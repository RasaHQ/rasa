...
1. Concatenate user input (user intent and entities) or user text processed through a user sequence transformer encoder,
   previous system actions or bot utterances processed through a bot sequence transformer encoder,
   slots and active forms for each time
   step into an input vector to pre dialogue transformer embedding layer.

2. Feed the input vector into a dialogue transformer encoder.

3. Apply a dense layer to the output of the dialogue transformer to get embeddings of a dialogue for each time step.
...
6. Concatenate the token output of the user sequence transformer encoder
...
* `sequence_number_of_transformer_layers`:
  This parameter sets the number of sequence transformer encoder layers to use (default: `1`).
  The number of sequence transformer encoder layers corresponds
  to the transformer blocks to use for the model.

* `sequence_transformer_size`:
  This parameter sets the number of units in the sequence transformer encoder (default: `128`).
  The vectors coming out of the sequence transformer encoders will have the given `sequence_transformer_size`.

* `dialogue_number_of_transformer_layers`:
  This parameter sets the number of the dialogue transformer encoder layers to use (default: `1`).
  The number of the dialogue transformer encoder layers corresponds
  to the transformer blocks to use for the model.

* `dialogue_transformer_size`:
  This parameter sets the number of units in the dialogue transformer encoder (default: `128`).
  The vectors coming out of the dialogue transformer encoders will have the given `dialogue_transformer_size`.
...
+---------------------------------------+-----------------------+--------------------------------------------------------------+
| sequence_transformer_size             | 128                   | Number of units in the sequence transformer encoder.         |
+---------------------------------------+-----------------------+--------------------------------------------------------------+
| sequence_number_of_transformer_layers | 1                     | Number of sequence transformer encoder layers.               |
+---------------------------------------+-----------------------+--------------------------------------------------------------+
| dialogue_transformer_size             | 128                   | Number of units in the dialogue transformer encoder.         |
+---------------------------------------+-----------------------+--------------------------------------------------------------+
| dialogue_number_of_transformer_layers | 1                     | Number of the dialogue transformer encoder layers.           |
+---------------------------------------+-----------------------+--------------------------------------------------------------+
| number_of_attention_heads             | 4                     | Number of attention heads in transformers.                   |
+---------------------------------------+-----------------------+--------------------------------------------------------------+
