...
For details on how to implement a custom action, see the [SDK documentation](https).
Any custom action that you want to use in your stories should be added into the
actions section of your [domain file](./domain.mdx).

<!-- TODO: put the right link in for the SDK docs above -->
