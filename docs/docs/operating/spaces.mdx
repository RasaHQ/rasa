...
potential for conflicts between intents, entities, and other [primitives](../building-classic-assistants/glossary.mdx#rasa-primitive) grows as well.
...
and deactivation of groups of [rasa primitives](../building-classic-assistants/glossary.mdx#rasa-primitive). Each of these groups is called a Space.
...
<img
  alt="two layer space hierarchy"
  src={useBaseUrl("/img/spaces_hierarchy.png")}
/>
...
classification components](../building-classic-assistants/components.mdx#intent-classifiers). It accesses the [tracker](../action-server/sdk-tracker.mdx)
...
[Lookup Tables](../building-classic-assistants/training-data-format.mdx#lookup-tables) and
[Synonyms](../building-classic-assistants/training-data-format.mdx#synonyms) work with spaces. However, they are not
