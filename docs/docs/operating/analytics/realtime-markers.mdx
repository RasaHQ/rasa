...
In Rasa Pro, [Markers](../../production/markers.mdx) are a powerful feature that allows
...
<img
  alt="flow of information with realtime markers"
  src={useBaseUrl("/img/analytics/realtime-markers.png")}
/>
...
Visit our [CLI page](../../building-assistants/command-line-interface.mdx#rasa-marker-upload)
...
Read more about it [here](../../production/markers.mdx/#extracting-markers)
