...
The recommended way to deploy an assistant is using Helm Chart option we support.
Both deploy Rasa X and your assistant. It is the easiest way to deploy your assistant,
allow you to connect Rasa OSS with Rasa X where you can view conversations and turn them into training data, and
is production-ready.
