...
The recommended way to deploy an assistant is using Helm Chart option we support. It is the easiest way to deploy your assistant,
it allows you in an easy way to connect Rasa OSS deployment with Rasa X deployment where you can view conversations and turn them into training data,
