...
To define and use a form, you will need to define:

* Slot mappings: The required info to collect
* Responses: How your bot should ask for each piece of information
* Rules: When the form should start, and what should happen after it is completed
...
You should include responses for after the form has been submitted:
...
responses:
  ...
  # responses after form is submitted
  utter_submit:
    - text: "All done!"
  utter_slots_values:
