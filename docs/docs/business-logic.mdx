...
# WHAT IS THIS PATTERN: collecting certain information before completing a query
# HOW TO IMPLEMENT: 
  ## TOOLS to use
### FormPolicy
### EntityExtractors 
### custom actions, validation functions
  ## DATA 
### rules for forms
### the inform intent
### using entities to autofill slots
...
or [SpacyEntityExtractor](./components/entity-extractors.mdx#spacyhttpextractor)), but for this tutorial
