...
Slots are your bot’s memory that you can use to influence how the dialogue engine makes
...
an unfeaturized slot. Note that, unlike featurized slots, unfeaturized slots should not
...
are useful for reducing the number of stories you have to write, however, they should
