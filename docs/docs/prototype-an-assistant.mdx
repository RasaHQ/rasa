...
<AssistantBuilder.Container
  values={[
    ...
    {label: '3. Forms', value: 'forms'},
    {label: '4. Stories', value: 'stories'},
...
MAC: What are the various things people might say to an assistant that can help them subscribe to a newsletter?
