...
[Read about best practices for writing stories](./writing-stories.mdx)
...
On the code block below, we have added a rule that triggers the
...
Please make sure you've [installed at least Rasa Open Source 2.0.0a5](installation.mdx) to develop
