...
A [response](../concepts/responses.mdx) is a message the assistant will send back to the user. This is
the action you will use most often, when you want the assistant to send text, images, buttons
or similar to the user.

## Custom Actions

A [custom action](../concepts/custom-actions.mdx) is an action that can run any code you want. This can be used to make an
