...
used in your [NLU data](../nlu-based-assistants/nlu-training-data.mdx) and [conversation training data](../nlu-based-assistants/training-data-format.mdx#conversation-training-data).
...
extracted by any [entity extractor](../nlu-based-assistants/components.mdx) in your
NLU pipeline.
...
If you are using the feature [Entity Roles and Groups](../nlu-based-assistants/nlu-training-data.mdx#entities-roles-and-groups) you also
...
For more information on form and how to define them, see [Forms](../nlu-based-assistants/forms.mdx).
...
[Model Configuration](../nlu-based-assistants/model-configuration.mdx).
:::
