...
In the upcoming release version 3.7 of Rasa Open Source, we’re removing this experimental feature. For documentation on the markers feature in Rasa Pro, please [click here](../operating/analytics/realtime-markers.mdx)
...
and surface relevant dialogues for review as part of Conversation Driven Development (CDD).
...
Rasa Pro supports real-time processing of markers, Read more about [Real-Time Markers](../operating/analytics/realtime-markers.mdx)
...
Visit our [CLI page](../building-assistants/command-line-interface.mdx#rasa-evaluate-markers) for more information on configuring the marker extraction and statistics computation process.
