...
more information about testing, see [Testing Your Assistant](../production/testing-your-assistant.mdx).
...
If you ran [test stories](../nlu-based-assistants/testing-your-assistant.mdx) in your CI pipeline,
