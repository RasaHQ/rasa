...
3. Set up a CI/CD pipeline.
    ...
    CDD leads to frequent, smaller updates to your bot as you gather insights from bot conversations. [Setting up a CI/CD pipeline](http://s)early on in development will enable you to act quickly on what you see in conversations.
