...
After following the basics of [prototyping an assistant](https://rasa.com/docs/rasa/prototype-an-assistant/), we’ll
...
* [Responding to simple intents](./chitchat-faqs.mdxrespond-with-memoization-policy) with the MemoizationPolicy
...
and then [prototype an assistant](https://rasa.com/docs/rasa/prototype-an-assistant/)
