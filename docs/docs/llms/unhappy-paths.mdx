...
[Flows](../building-assistants/flows.mdx) offer structured way to design conversation-driven business logic. While
flow designers primarily focus on linear [happy paths](../building-assistants/glossary.mdx#happy--unhappy-paths),
