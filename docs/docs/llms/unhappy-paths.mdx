...
[Flows](../flows.mdx) offer structured way to design conversation-driven business logic. While 
...
<Chat caption="Flow completion">
  ...
  <ChatBotText>You currently have 4021.20$ in your account.</ChatBotText>
  <ChatBotText>Is there anything else I can help you with?</ChatUserText>
</Chat>
