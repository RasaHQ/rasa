...
This feature is **experimental**. We introduce experimental features to
co-create with our customers. If you are interested in using this feature,
please contact us at [rasa.com/contact](https://rasa.com/contact).
...
1. **Few shot learning**: The intent classifier can be trained with only a few
   ...
   there are only a handfull of training examples available.
