...
[flows specification](../building-assistants/flows.mdx).
...
2. Add flows to your bot as per the [flows specification](../building-assistants/flows.mdx). This
...
- One flow can ["link" to another flow](../building-assistants/flows.mdx#link), which will initiate
