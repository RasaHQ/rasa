...
Your Azure OpenAI instance might have some limits on the number of text chunks you can pass at once to generate
embeddings. Thus it is also important to also configure a reasonable chunk_size based on your rate limits.
