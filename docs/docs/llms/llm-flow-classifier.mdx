...
You can specify the openai model to used for the `LLMFlowClassifier` by setting the
...
Defaults to `gpt-3.5-turbo`. The model name should be set to a chat model of 
