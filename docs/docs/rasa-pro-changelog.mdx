...
- Implemented PII (Personally Identifiable Information) management using Microsoft Presidio as the entity analyzer and
  ...
  Please read through the [PII Management](./security/pii-management.mdx) section in the official documentation to learn how to get started.

- Implemented support for real time evaluation of [Markers](./operating/analytics/realtime-markers.mdx) with the Analytics
...
- You can now process [Markers](./operating/analytics/realtime-markers.mdx) with the Analytics Data Pipeline in real-time, enabling you to gain valuable insights and improve the performance of your Rasa Assistant.
