...
# WHAT IS THIS PATTERN: users ask things that depend on previous convo turns to be correctly handled
# HOW TO IMPLEMENT: 
  ## TOOLS to use
### max_history
...
in the conversation below (extracted from a conversation on [Rasa X](https://rasa.com/docs/rasa-x/review-conversations/)):
