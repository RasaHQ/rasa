...
or using the [Mapping Policy](./policies.mdx#mapping-policy).
...
The easiest and most reliable way to connect this action with the intent is via the [Mapping Policy](./policies.mdx#mapping-policy).
