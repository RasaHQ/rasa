...
[Here](./slots#slot-classes) you can find the full list of slot types defined by
...
see [Custom Actions](./actions#custom-actions)).
...
For each response, you can have multiple **response variations** (see [Variations](./domains#variations)).
