...
* [Fallback Actions](./fallback-actions.mdx): Users might confront your assistant with unexpected messages.
  ...
  You can use the [FallbackClassifier](../nlu/components.mdx#fallbackclassifier)
...
TODO!!!!! This will need to be changed, TBD.
...
- rule: Rule which will wait for user message when it was applied
  ...
  - action_listen
```
TODO: Rewrite section to match removal of `...`
...
[Rules which Apply Anytime](./rules.mdx#rules-which-apply-anytime).
