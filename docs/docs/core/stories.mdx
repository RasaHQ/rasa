...
[use_entities](./domains.mdx#use-entities) attribute).
...
file for [ResponseSelector](../nlu/components.mdx#response-selector) model and will be ignored for training Core models.
...
You can read more about events [here](../api/events.mdx).
...
way to write these stories is to use [interactive learning](./interactive-learning.mdx).
...
into a single file for evaluation. Read more about [Testing Your Assistant](../user-guide/testing-your-assistant.mdx)
