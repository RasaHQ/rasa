...
multiple policies in a single [`rasa.core.agent.Agent`](../api/agent.mdx#rasa.core.agent.Agent).
...
the full conversation history. See [Featurization of Conversations](../api/core-featurization.mdx#featurization-conversations) for details.
...
(see [Featurization of Conversations](../api/core-featurization.mdx#featurization-conversations) for details).
...
use `MaxHistoryTrackerFeaturizer` for **faster training**. See [Featurization of Conversations](../api/core-featurization.mdx#featurization-conversations) for
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="rule-policy"></a>
...
[migration guide](../migration-guide.mdx#migrate-mapping-policy-to-rule-policy).
:::
...
:::caution
The `FallbackPolicy` is deprecated. Please see [Fallback Actions](./fallback-actions.mdx) how to implement
its behavior using the [Rule Policy](./policies.mdx#rule-policy). If you previously used
the `FallbackPolicy`, see the
[migration guide](../migration-guide.mdx#migrate-fallback-policy-to-rule-policy).
:::
...
|`fallback_action_name` |Name of the [fallback action](./fallback-actions.mdx) to be called if the confidence of intent or action is below the respective threshold |
...
:::caution
The `TwoStageFallbackPolicy` is deprecated. Please see [Fallback Actions](./fallback-actions.mdx) how to implement
its behavior using the [Rule Policy](./policies.mdx#rule-policy). If you previously used
the `TwoStageFallbackPolicy`, see the
[migration guide](../migration-guide.mdx#migrate-two-stage-policy-to-rule-policy).
:::
...
|`ambiguity_threshold`         |Min amount by which the confidence of the top intent must exceed that of the second highest ranked intent.                                                                                                           |
|`core_threshold`              |Min confidence needed to accept an action prediction from Rasa Core                                                                                                                                                  |
|`fallback_core_action_name`   |Name of the [fallback action](./fallback-actions.mdx) to be called if the confidence of Rasa Core action prediction is below the `core_threshold`. This action is to propose the recognized intents             |
|`fallback_nlu_action_name`    |Name of the [fallback action](./fallback-actions.mdx) to be called if the confidence of Rasa NLU intent classification is below the `nlu_threshold`. This action is called when the user denies the second time |
...
:::caution
This policy is deprecated. Please see [Forms](./forms.mdx) how to implement
its behavior using the [Rule Policy](./polices.mdx#rule-policy).
:::
