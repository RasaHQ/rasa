...
If you haven't installed Rasa yet, go to the [installation page](./llms/llm-installation.dx) and then return here. 
...
In your domain file, add the definition of this slot and the corresponding responses:
