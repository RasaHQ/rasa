...
Although Rasa's [Intent Classifier](./components.mdx) will
...
The [FallbackClassifier](./components.mdx#fallbackclassifier) will
...
When you add the [FallbackClassifier](./components.mdx#fallbackclassifier)  to
