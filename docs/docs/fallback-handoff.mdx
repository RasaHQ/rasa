...
# WHAT IS THIS PATTERN: handling out of scope/unknown user behaviour gracefully by falling back to an excuse or a human
# HOW TO IMPLEMENT: 
  ## TOOLS to use
### FallbackPolicies
### HumanHandoff
  ## DATA 
### out_of_scope intent
### probably no or few stories to add here
