...
Finally, you will need to write rules for what should happen for in out-of-scope request:
...
Core confidence falls below the configured threshold. Make sure to specify
