...
<figure align="center">
  <img
    alt="Number of sessions per month visualised in Metabase."
    src={useBaseUrl("/img/analytics/graph-number-sessions-month.png")}
    width="100%"
  />
  <figcaption>Number of sessions per month visualised in Metabase.</figcaption>
</figure>
...
<figure align="center">
  <img
    alt="Number of sessions per channel visualised in Metabase."
    src={useBaseUrl("/img/analytics/graph-number-sessions-channel.png")}
    width="100%"
  />
  <figcaption>Number of sessions per channel visualised in Metabase.</figcaption>
</figure>


## Top N intents

To improve your assistant, you could looking into the variety of intents your users express.
The query below selects the top 5 intents which could help you have a good perspective on that topic:
...
<figure align="center">
  <img
    alt="Top 5 intents visualised in Metabase."
    src={useBaseUrl("/img/analytics/graph-top-5-intents.png")}
    width="100%"
  />
  <figcaption>Top 5 intents visualised in Metabase.</figcaption>
</figure>
...
<figure align="center">
  <img
    alt="Intent distribution over time visualised in Metabase."
    src={useBaseUrl("/img/analytics/graph-intent-distribution.png")}
    width="100%"
  />
  <figcaption>Intent distribution over time visualised in Metabase.</figcaption>
</figure>


## Escalation rate

Escalation rate or human hand-off rate is a measure of how many conversations does the assistant pass to a human agent.
This metric can help you gain a better understanding of what happens during a conversation.
Let's say you have an intent named `handoff_to_support`. You'll get the escalation rate over time
...
<figure align="center">
  <img
    alt="Escalation rate visualised in Metabase."
    src={useBaseUrl("/img/analytics/graph-escalation-rate.png")}
    width="100%"
  />
  <figcaption>Escalation rate visualised in Metabase.</figcaption>
</figure>


## Abandonment rate

Abandonment rate can be defined in many different custom ways, however here we'll define it as a session ending
without a user message after a specific message was uttered by the bot, e.g. `utter_ask_name`.
...
<figure align="center">
  <img
    alt="Abandonment rate visualised in Metabase."
    src={useBaseUrl("/img/analytics/graph-abandonment-rate.png")}
    width="100%"
  />
  <figcaption>Abandonment rate visualised in Metabase.</figcaption>
</figure>
