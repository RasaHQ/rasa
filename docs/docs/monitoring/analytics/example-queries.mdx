...
Example queries using SQL are provided, together with an example visualization in Metabase.
...
<figure align="center">
  <img
    ...
    width="100%"
  />
  <figcaption>Number of sessions per channel visualized in Metabase.</figcaption>
</figure>
