...
- User Analytics: Who are the users of the bot, and how do they feel 
about it?  Examples: demographics, channels, sentiment analysis
- Usage Analytics:  How is the bot’s overall health and what kind of 
...
- Business Analytics: How is the bot performing with regard to business goals?
Examples: ROI of bot per LoB, time comparison of bot vs agent, containment rate
...
| Number of sessions | Usage Analytics | Gross traffic to bot |
