...
- This has an immediate knock-on effect on performance: streaming historical data directly to Redshift could take up to <PLACEHOLDER> times longer than streaming directly to or via the PostgreSQL RDS instance.
