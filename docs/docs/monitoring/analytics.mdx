...
Finally, when running the Analytics pipeline Docker container, set the [environment variable `RASA_ANALYTICS_DB_URL`](../deploy/deploy-rasa-pro-services.mdx#docker-container-configuration-references) to the PostgreSQL Amazon RDS DB instance URL.
