...
suggest you set the [`influence_conversation: false`](./domain.mdx#slots-and-conversation-behavior)
...
NLU pipeline.
If you are using the feature [Entity Roles and Groups](./nlu-training-data.mdx#entity-roles-and-groups) you also
...
You can specify whether or not a slot influences the conversation with the property
