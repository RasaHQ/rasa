...
You can verify if your domain is compliant with this requirement by running
CLI command [`rasa data validate`](./command-line-interface.mdx#rasa-data-validate).
