...
If the value itself is important, use the [slot type](./slot-types) that
...
[Customizing the session start action](../rasa-sdk#custom-session-start) shows you how to do that.
