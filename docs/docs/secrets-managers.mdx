...
description: Credentials used to authenticate to external services are safely stored in a secrets manager.
abstract: Credentials managers are used to safeguard credentials used to authenticate to external services.
---
