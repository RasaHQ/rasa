...
Testing your trained model on [test stories](./testing-your-assistant.mdx#writing-test-conversations) is the best way to have confidence in how your assistant
