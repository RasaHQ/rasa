...
abstract:
  This section explains when and how to deploy an assistant built with Rasa.
...
important happy paths or is what we call a [minimum viable assistant](../building-assistants/glossary.mdx). Then you can use incoming
...
- [Running an assistant locally on the command line](../building-assistants/command-line-interface.mdx#rasa-run)
