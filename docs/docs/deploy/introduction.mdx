...
important happy paths or is what we call a [minimum viable assistant](../concepts/glossary.mdx). Then you can use incoming
...
- [Running an assistant locally on the command line](../concepts/command-line-interface.mdx#rasa-run)
