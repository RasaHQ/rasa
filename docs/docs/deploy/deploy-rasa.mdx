...
abstract: This page explains how to deploy Rasa using Helm.
---
...
<Tabs groupId="oss-plus-deploy" values={[{"label": "Rasa Open Source", "value": "oss"}, {"label": "Rasa Pro", "value": "pro"}]} defaultValue="oss">
  <TabItem value="oss">
