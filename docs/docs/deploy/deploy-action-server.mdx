...
description: How to deploy your Rasa Action Server with Kubernetes/Openshift.
abstract: This page explains how to build an Action Server Image and deploy Rasa Action Server by using Helm.
---
...
## Connect Rasa Action Server with Rasa Open Source
