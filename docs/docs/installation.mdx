...
title: Installation
description: Install Rasa on premises to enable local and customizable Natural Language Understanding and Dialogue Management.
---
...
You can explore Rasa online using the Rasa Playground even before you install it.
...
**Install Rasa using pip (requires Python 3.7, or 3.8).**
...
:::caution
The command above will upgrade your pip to the latest version. We recommend using pip 21.3 or later due to performance improvements. Previous versions would take a long time to resolve dependencies.
:::
...
:::note
Due to the lack of official TensorFlow support for the Apple M1, Rasa is currently unable to train a model using M1.
:::
...
When you run Rasa for the first time, you’ll see a
...
This will install Rasa as well as spaCy and its language model
...
To upgrade your installed version of Rasa to the latest version from PyPI:
