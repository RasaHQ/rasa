...
You can explore Rasa online using the Rasa Playground even before you install.
...
:::note
Due to lack of official TensorFlow support for the Apple M1, Rasa is currently unable to train a model using M1.
:::
