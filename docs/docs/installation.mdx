...
1. Isolate your python project using a virtual environment.
...
2. Install Rasa Open Source using pip (requires Python 3.6, 3.7 or 3.8).
...
3. You are now ready to go! So what's next? You can create a new project by running:
...
:::note
Due to lack of official TensorFlow support for the Apple M1, Rasa Open Source is unable to train a model using M1.
:::
