...
You can find the method's signature [here](https://github.com/RasaHQ/rasa/blob/main/rasa/core/brokers/broker.py#L45).
...
You can find the method's signature [here](https://github.com/RasaHQ/rasa/blob/main/rasa/core/brokers/broker.py#L63).
- `is_ready`: determine whether or not the event broker is ready. You can find the method's signature [here](https://github.com/RasaHQ/rasa/blob/main/rasa/core/brokers/broker.py#L67).
- `close`: close the connection to an event broker. You can find the method's signature [here](https://github.com/RasaHQ/rasa/blob/main/rasa/core/brokers/broker.py#L75).
