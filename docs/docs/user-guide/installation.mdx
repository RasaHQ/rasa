...
* Having trouble installing? Read our [step-by-step installation guide](./installation#installation-guide).

* You can also [build Rasa Open Source from source](./installation#build-from-source).

* For advanced installation options such as building from source and installation instructions for
  custom pipelines, head over [here](./installation#pipeline-dependencies).
...
The page on [Choosing a Pipeline](../nlu/choosing-a-pipeline) will help you pick the right pipeline
for your assistant.
