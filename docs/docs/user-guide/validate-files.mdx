...
title: Validate Data
description: Check your domain, stories and intent files for possible errors.
---
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="test-story-files-for-conflicts"></a>
