...
The [ResponseSelector](../nlu/components#response-selector) NLU component is designed to make it easier to handle dialogue
elements like [Small Talk](../dialogue-elements/small-talk) and FAQ messages in a simple manner. By using the ResponseSelector,
...
* [Handling business logic](./building-assistants#handling-business-logic)

* [Handling unexpected user input](./building-assistants#handling-unexpected-user-input)

* [Failing gracefully](./building-assistants#failing-gracefully)

* [More complex contextual conversations](./building-assistants#more-complex-contextual-conversations)

Please make sure you’ve got all the data from the [Building a simple FAQ assistant](./building-assistants#build-faq-assistant) section before starting this part.
...
(e.g. [DucklingHTTPExtractor](../nlu/components#ducklinghttpextractor) or [SpacyEntityExtractor](../nlu/components#spacyentityextractor)), but for this tutorial
...
matter the context, you can use the [Mapping Policy](../core/policies#mapping-policy) to handle these. It will always
