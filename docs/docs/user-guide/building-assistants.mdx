...
description: How to build simple FAQ and contextual assistants
---
...
* [Responding to simple intents](respond-with-memoization-policy.mdx) with the MemoizationPolicy

* [Handling FAQs](faqs-response-selector.mdx) using the ResponseSelector
...
can later be included as part of a [CI/CD system](./setting-up-ci-cd.mdx). End-to-end [test conversations](./testing-your-assistant.mdx#end-to-end-testing)
...
The [ResponseSelector](../nlu/components.mdx#response-selector) NLU component is designed to make it easier to handle dialogue
elements like [Small Talk](../dialogue-elements/small-talk.mdx) and FAQ messages in a simple manner. By using the ResponseSelector,
...
When you’re ready to enhance your assistant with context, check out [Building a contextual assistant](./building-assistants.mdx#tutorial-contextual-assistants).
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="tutorial-contextual-assistants"></a>
...
* [Handling business logic](./building-assistants.mdx#handling-business-logic)

* [Handling unexpected user input](./building-assistants.mdx#handling-unexpected-user-input)

* [Failing gracefully](./building-assistants.mdx#failing-gracefully)

* [More complex contextual conversations](./building-assistants.mdx#more-complex-contextual-conversations)

Please make sure you’ve got all the data from the [Building a simple FAQ assistant](./building-assistants.mdx#build-faq-assistant) section before starting this part.
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="handling-business-logic"></a>
...
(e.g. [DucklingHTTPExtractor](../nlu/components.mdx#ducklinghttpextractor) or [SpacyEntityExtractor](../nlu/components.mdx#spacyentityextractor)), but for this tutorial
...
matter the context, you can use the [Mapping Policy](../core/policies.mdx#mapping-policy) to handle these. It will always
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="more-complex-contextual-conversations"></a>
