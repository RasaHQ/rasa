...
---
import Prototyper, { DownloadButton, TrainButton } from '@site/src/components/prototyper';
...
<Prototyper startPrototyperApi="https://trainer-service.prototyping.rasa.com/startPrototyping">
