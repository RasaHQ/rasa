...
installing anything.
You can also [install Rasa](./installation) and follow along in your command line.

The [Glossary](../glossary) contains an overview of the most common terms you’ll see in the Rasa documentation.
...
your assistant. You can find all the details of the data format in [Training Data Format](../nlu/training-data-format).
...
The `policies` key defines the [policies](../core/policies) that the Core model will use.
...
You can see the full details in [Stories](../core/stories).
...
The next thing we need to do is define a [Domain](../core/domains).
...
from the `responses` section. See [Custom Actions](../core/actions#custom-actions)
...
```
See [Testing Your Assistant](./testing-your-assistant) to learn more about how to evaluate your model as you improve it.
...
* Learn how to implement business logic using [forms](../core/forms)

* Learn how to integrate other APIs using [custom actions](../core/actions)

* Learn how to connect your bot to different [messaging apps](./messaging-and-voice-channels)

* Learn about customizing the [components](../nlu/components) in your NLU pipeline

* Read about custom and built-in [entities](../nlu/entity-extraction)
