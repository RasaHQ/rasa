...
:::note
[Custom Actions](../core/actions#custom-actions) are not executed as part of end-to-end tests. If your custom
...
You can [split your NLU training data](./command-line-interface#train-test-split)
