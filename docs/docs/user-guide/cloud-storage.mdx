...
title: Cloud Storage
description: Handle Rasa models on premise or in your private cloud for GDPR-compliant intent recognition and entity extraction.
---
...
* Other Remote Storage
  ...
  ```bash
  rasa run --remote-storage rasa.nlu.persistor.Persistor
  ```
