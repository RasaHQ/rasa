...
|`rasa run`              |Starts a Rasa server with your trained model. See the [Configuring the HTTP API](./configuring-http-api.mdx) docs for details. |
...
[Session configuration](../core/domains.mdx#session-config).
...
For more information on the additional parameters, see [Configuring the HTTP API](./configuring-http-api.mdx).
See the Rasa [HTTP API](../api/http-api.mdx) docs for detailed documentation of all the endpoints.
...
Check out more details in [Evaluating an NLU Model](./testing-your-assistant.mdx#nlu-evaluation) and [Evaluating a Core Model](./testing-your-assistant.mdx#core-evaluation).
