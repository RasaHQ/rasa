...
|`rasa run`              |Starts a Rasa server with your trained model. See the [Configuring the HTTP API](./configuring-http-api) docs for details. |
...
[Session configuration](../core/domains#session-config).
...
For more information on the additional parameters, see [Configuring the HTTP API](./configuring-http-api).
See the Rasa [HTTP API](../api/http-api) docs for detailed documentation of all the endpoints.
...
Check out more details in [Evaluating an NLU Model](./testing-your-assistant#nlu-evaluation) and [Evaluating a Core Model](./testing-your-assistant#core-evaluation).
