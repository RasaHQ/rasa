...
Just like in the [tutorial](../rasa-tutorial.mdx), you’ll use the `rasa init` command to create a project.
...
with different dependencies installed. See [Choosing a Pipeline](../../nlu/choosing-a-pipeline.mdx) for more dependency information
...
To create more sophisticated assistants, you will want to use [Custom Actions](../../core/actions.mdx#custom-actions).
