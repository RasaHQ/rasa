...
[Deploying Your Rasa Assistant](../how-to-deploy#deploying-your-rasa-assistant) to learn how to deploy your model.
...
Just like in the [tutorial](../rasa-tutorial), you’ll use the `rasa init` command to create a project.
...
with different dependencies installed. See [Choosing a Pipeline](../../nlu/choosing-a-pipeline) for more dependency information
...
To create more sophisticated assistants, you will want to use [Custom Actions](../../core/actions#custom-actions).
...
model you created with Rasa X via one of our [recommended deployment methods](../how-to-deploy#recommended-deployment-methods).
Or, you can do a [Rasa-only deployment in Docker Compose](./deploying-in-docker-compose#deploying-rasa-in-docker-compose).
