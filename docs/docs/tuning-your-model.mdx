...
If you want to use custom components in your pipeline, see [Custom NLU Components](../custom-nlu-components.mdx).
...
See [Comparing NLU Pipelines](../testing-your-assistant#comparing-nlu-pipelines) for more information.
...
do sentiment analysis, check out [Custom NLU Components](../custom-nlu-components.mdx).
...
create your own [custom tokenizer](../custom-nlu-components.mdx).
...
[SpacyFeaturizer](./components/featurizers.mdx#spacyfeaturizer) also provides word embeddings in many different languages (see [Pre-trained Word Vectors](./language-support.mdx#pretrained-word-vectors)),
