...
abstract: Rasa Open Source will provide you with a suggested NLU config on initialisation of the project, but as your project grows, it's likely that you will need to adjust your config to suit your training data.
---
