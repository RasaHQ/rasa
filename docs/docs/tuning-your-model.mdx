...
To do this, you need to access the `diagnostic_data` field of the [Message](reference/rasa/nlu/training_data/message.md)
and [Prediction](reference/rasa/core/policies/_policy.md#predict_action_probabilities) objects, which contain
