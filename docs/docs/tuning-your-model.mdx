...
your pipeline, training and testing will fail if you set the environment variable
`TF_DETERMINISTIC_OPS=1`, because there is no deterministic GPU implementation of
