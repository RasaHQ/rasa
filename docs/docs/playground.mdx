...
[Learn more about NLU data and its format](./building-classic-assistants/training-data-format.mdx)
...
[Learn more about responses](./building-assistants/responses.mdx)
...
[Stories](./building-classic-assistants/stories.mdx) are example conversations that train an assistant to respond correctly depending on what the user has said previously in the conversation.
...
[Learn more about forms here](./building-classic-assistants/forms.mdx)
...
[Learn more about rules and how to write them.](./building-classic-assistants/rules.mdx)
...
[Rasa’s CLI](./building-assistants/command-line-interface.mdx),
[Domains](./building-assistants/domain.mdx),
[Actions](./building-assistants/actions.mdx),
and your config’s [Pipeline](./building-classic-assistants/tuning-your-model.mdx) and [Policies](./building-classic-assistants/policies.mdx).
