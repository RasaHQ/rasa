...
<ChatBotText>I need to know how many people are in your party to ensure the restaurant can accommodate you.</ChatBotText>
<ChatBotText>How many people?</ChatBotText>
</Chat>
...
(read more about how [slots influence the assistant's behavior](./domain.mdx#slots-and-conversation-behavior)).
