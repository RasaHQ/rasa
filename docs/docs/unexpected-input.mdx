...
<ChatUserText>I want to talk to sales</ChatUserText>
<ChatBotText>Sure, we can book a sales call! Let's get to know each other first.</ChatBotText>
<ChatBotText>What's your job?</ChatBotText>
<ChatUserText>Why do you need to know that?</ChatUserText>
<ChatBotText>Your job function helps us in understanding how we can talk to you best.</ChatBotText>
<ChatBotText>Do you still want to talk to sales?</ChatBotText>
</Chat>
