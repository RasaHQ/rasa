---
id: tensorflow_usage
sidebar_label: TensorFlow Configuration
title: TensorFlow Configuration
description: Find out how to configure your environment for efficient usage of TensorFlow inside Rasa Open Source.
---

<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="tensorflow-usage"></a>
