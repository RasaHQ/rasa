...
Below is the specification of the [`rasa.nlu.components.Component`](./custom-nlu-components.mdx#rasa.nlu.components.Component) class with the methods you’ll need to implement.
...
Also be sure to read the section on the [Component Lifecycle](../nlu/choosing-a-pipeline.mdx#component-lifecycle).
