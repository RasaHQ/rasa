...
```yaml (docs/sources/data/configs_for_docs/example_for_suggested_config.yml)
```
...
```yaml (docs/sources/data/configs_for_docs/example_for_suggested_config_after_train.yml)
```
