---
id: core-featurization
sidebar_label: Featurization of Conversations
title: Featurization of Conversations
description: Find out how to apply machine learning algorithms to conversational AI using vector representations of conversations with Rasa.
---
