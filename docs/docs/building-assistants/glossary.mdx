...
An element in the an assistant's [NLU pipeline](../building-classic-assistants/tuning-your-model.mdx#how-to-choose-a-pipeline) in the [Model Configuration](./model-configuration.mdx).
