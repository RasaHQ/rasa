...
used in your [NLU data](<(../building-classic-assistants/nlu-training-data.mdx)>) and [conversation training data](./training-data-format.mdx#conversation-training-data).
