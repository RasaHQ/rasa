...
used in your [NLU data](<(../building-classic-assistants/nlu-training-data.mdx)>) and [conversation training data](../building-classic-assistants/training-data-format.mdx#conversation-training-data).
...
extracted by any [entity extractor](../building-classic-assistants/components.mdx) in your
NLU pipeline.
...
If you are using the feature [Entity Roles and Groups](<(../building-classic-assistants/nlu-training-data.mdx)#entities-roles-and-groups>) you also
...
user's age, but which will _not_ influence the flow of the conversation. This means
...
The specific value of a `text` slot (e.g. _Bangalore_ or _New York_ or _Hong Kong_)
...
for up to 6 people. In this case you want the _value_ of the
...
For more information on form and how to define them, see [Forms](../building-classic-assistants/forms.mdx).
...
[Model Configuration](../building-classic-assistants/model-configuration.mdx).
:::
