...
[`GraphComponent`](../building-assistants/custom-graph-components.mdx#the-graphcomponent-interface)
...
[graphs](../building-assistants/custom-graph-components.mdx#graph-components).
