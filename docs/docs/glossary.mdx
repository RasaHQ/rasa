...
## [Event](./api/events)
  ...
  All conversations in Rasa are represented as a sequence of events. For instance, a `UserUttered` represents a user entering a message, and an `ActionExecuted` represents the assistant executing an action. You can learn more about them [here](./api/events).
...
## [Rasa NLU](./nlu/about#about-rasa-nlu)
...
## [Pipeline](./nlu/choosing-a-pipeline)
...
## [Template / Response / Utterance](./core/responses)
