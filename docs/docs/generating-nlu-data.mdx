...
See [Regular Expression Features](./training-data-format.mdx#regular-expression-features)
...
possibilities (see [Entity Synonyms](./training-data-format.mdx#entity-synonyms)).
