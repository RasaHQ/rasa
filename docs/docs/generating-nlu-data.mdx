...
training examples, depending on what features you've added to your
[NLU pipeline](./components/featurizers.mdx). When different intents contain similar
...
entities like "How do I migrate to Rasa from IBM Watson?" A simple approach would
