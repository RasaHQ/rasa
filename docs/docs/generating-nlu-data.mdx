...
:::caution
Data augmentation is not a replacement for messages from actual users.
...
initial training dataset with synthetic examples. You should always remove the
synthetic data once you have collected a sufficient amount of real user data to train
an effective model. The process for adding augmented data to your model is:
