...
One common case of contextual interjections is during slot filling for [form](./building-classic-assistants/forms.mdx), where the user
...
<Chat caption="A contextual interjection">
  ...
  <ChatBotText>
    I need to know how many people are in your party to ensure the restaurant
    can accomodate you.
  </ChatBotText>
  <ChatBotText>How many people?</ChatBotText>
</Chat>
...
(read more about how [slots influence the assistant's behaviour](../building-assistants/domain.mdx#slots-and-conversation-behavior)).
