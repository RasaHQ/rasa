...
is the special [`action_unlikely_intent`](../building-assistants/default-actions.mdx#action_unlikely_intent) action.
...
any action. Otherwise, it triggers an [`action_unlikely_intent`](../building-assistants/default-actions.mdx#action_unlikely_intent)
...
See the [guide on custom graph components](../building-assistants/custom-graph-components.mdx) for a complete guide on custom policies.
