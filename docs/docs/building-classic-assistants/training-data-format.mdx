...
The [domain](../concepts/glossary.mdx#domain) uses
...
[NLU](../concepts/glossary.mdx#nlu) training data consists of example user utterances categorized by
[intent](../concepts/glossary.mdx#intent). Training examples can also include [entities](../concepts/glossary.mdx#entity). Entities are structured
...
Training examples are grouped by [intent](../concepts/glossary.mdx#intent) and listed under the
...
If you want to specify [retrieval intents](../concepts/glossary.mdx#retrieval-intent), then your NLU examples will look as follows:
...
[Entities](../concepts/glossary.mdx#entity) are structured pieces of information that can be extracted from a user's message.
...
A [form](../concepts/glossary.mdx#form) is a specific kind of custom action that contains the logic to loop over
...
Once defined, you should specify the [happy path](../concepts/glossary.mdx#happy--unhappy-paths)
