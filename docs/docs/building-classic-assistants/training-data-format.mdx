...
The [domain](../building-classic-assistants/glossary.mdx#domain) uses
...
[NLU](../building-classic-assistants/glossary.mdx#nlu) training data consists of example user utterances categorized by
[intent](../building-classic-assistants/glossary.mdx#intent). Training examples can also include [entities](../building-classic-assistants/glossary.mdx#entity). Entities are structured
...
Training examples are grouped by [intent](../building-classic-assistants/glossary.mdx#intent) and listed under the
...
If you want to specify [retrieval intents](../building-classic-assistants/glossary.mdx#retrieval-intent), then your NLU examples will look as follows:
...
[Entities](../building-classic-assistants/glossary.mdx#entity) are structured pieces of information that can be extracted from a user's message.
...
A [form](../building-classic-assistants/glossary.mdx#form) is a specific kind of custom action that contains the logic to loop over
...
Once defined, you should specify the [happy path](../building-classic-assistants/glossary.mdx#happy--unhappy-paths)
