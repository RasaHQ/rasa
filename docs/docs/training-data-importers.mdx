...
[TrainingDataImporter](./training-data-importers.mdx#training-data-importers-trainingfileimporter):
...
from rasa.shared.nlu.interpreter import RegexInterpreter, NaturalLanguageInterpreter
...
class MyImporter(TrainingDataImporter):
    ...
    async def get_stories(
        ...
        return await YAMLStoryReader.read_from_file(path_to_stories, await self.get_domain())
