...
* **Description**
  ...
  neural network architecture and optimization as the [DIETClassifier](../components/intent-classifiers.mdx#diet-classifier).
...
* **Configuration**
  ...
  The algorithm includes almost all the hyperparameters that [DIETClassifier](../components/intent-classifiers.mdx#diet-classifier) uses.
