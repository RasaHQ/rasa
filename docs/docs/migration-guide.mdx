...
You can also use [slot validation actions](./slot-validation-actions.mdx) to define custom validation of slots with
predefined mappings or custom extraction and validation of slots with custom mappings.
