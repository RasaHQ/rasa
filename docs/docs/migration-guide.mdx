...
The following classes have moved from `rasa.core` to `rasa.shared.core`:

| Rasa 1.0                             | Rasa 2.0                          |
| ------------------------------------ | --------------------------------- |
| rasa.core.events                     | rasa.shared.core.events           |
| rasa.core.trackers                   | rasa.shared.core.trackers         |
| rasa.core.channels.channel.RestInput | rasa.core.channels.rest.RestInput |
| Rasa 1.0                             | Rasa 2.0                          |
| ------------------------------------ | --------------------------------- |
| rasa.core.events                     | rasa.shared.core.events           |
| rasa.core.trackers                   | rasa.shared.core.trackers         |
