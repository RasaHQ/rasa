...
wherever the instructions say to use `https://<host>:<port>/webhooks/<CHANNEL>/webhook`,
use `https://yyyyyy.ngrok.io/webhooks/<CHANNEL>/webhook`, replacing `yyyyyy` with the randomly generated
sequence displayed in the ngrok URL in your terminal.
