...
title: Actions
abstract: After each user message, the dialogue manager will predict an action that the assistant should perform next. This page gives you an overview of the different types of actions you can use.
---
...
## Retrieval Actions
A [retrieval action](./retrieval-actions.mdx) is a special type of response, where the dialogue manager relies
on a secondary NLU classifier to send a message back to the user. You should use this to
handle any chitchat or FAQs in your assistant.
## Forms
[Forms](./forms.mdx) are a special type of custom action, designed to handle business logic. If you have
any conversation designs where you expect the assitant to ask for a specific set of
information, you should use this.
## Default Actions
...
customise these to personalise your assitant.
