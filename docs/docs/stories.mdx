...
abstract: Rasa stories are a type of training data used to train your assistant's dialogue management
...
Because fo this, events such as setting a slot or activating/deactivating a form have to be
