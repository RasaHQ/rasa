...
You can mix training data in end-to-end format with labeled training data which has `intent`s and `action`s specified. This means stories can have steps defined by actions
and other steps defined by user or bot utterances directly.
