...
The `language` field specifies the language of the text to be anonymized. Note that you can only specify one language
per anonymization pipeline because the assumption made was that an assistant will be developed for a single language.
