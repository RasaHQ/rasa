---
id: dialogue-elements
sidebar_label: Dialogue Elements
title: Dialogue Elements
description: Dialogue elements are an abstraction layer for your conversational AI platform which describe common, recurring patterns in chatbot conversations.
---
...
<img alt="image" src={useBaseUrl("/img/intents-user-goals-dialogue-elements.png")} />
