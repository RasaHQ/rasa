...
title: Small Talk
description: Learn to handle greetings, off-topic chitchat, and other small talk in your bot using features provided by Rasa's open source chat assistant platform.
---
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="greetings"></a>
...
See [Explaining Possibilities](./guiding-users.mdx#explaining-possibilities) for how to handle out-of-scope input.
