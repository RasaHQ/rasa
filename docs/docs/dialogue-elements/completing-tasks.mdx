...
See [Greetings](./small-talk.mdx#greetings).
...
```
See [Handling conditional slot logic](../core/forms.mdx#conditional-logic) for details on how to use forms to implement business logic.
