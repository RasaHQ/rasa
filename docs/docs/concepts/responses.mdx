...
If you are using [retrieval intents](../building-classic-assistants/glossary.mdx#retrieval-intent) in your assistant, you also need to add responses
...
training examples](../building-classic-assistants/training-data-format.mdx#training-examples) to learn more.
:::
...
This is useful when you want to use the [NLG server](../production/nlg.mdx) to generate the response.
