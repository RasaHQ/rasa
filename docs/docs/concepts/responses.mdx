...
If you are using [retrieval intents](../nlu-based-assistants/glossary.mdx#retrieval-intent) in your assistant, you also need to add responses
...
training examples](../nlu-based-assistants/training-data-format.mdx#training-examples) to learn more.
:::
