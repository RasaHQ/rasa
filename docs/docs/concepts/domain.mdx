...
If you are building an NLU-based assistant, refer to [this page](../nlu-based-assistants/domain.mdx) to see how
...
Every responses is also an [action](#actions), meaning that it can be used directly in
...
[Actions](./actions.mdx) are the things your bot can do.
...
Rasa also has [default actions](./default-actions.mdx) which you do not
need to list in your domain.
