...
The *Command Generator* is part of Rasa's new 
...
The `CommandGenerator` component performs *Dialogue Understanding*. 
In the CALM approach, *Dialogue Understanding* aims to represent how the end user
