...
See a full list of NLU-based components [here](../buil-based-assistants/components.mdx).
...
See a full list of NLU-based policies [here](../buil-based-assistants/policies.mdx).
