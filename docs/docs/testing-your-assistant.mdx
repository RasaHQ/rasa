...
abstract: Rasa Open Source lets you test dialogues end-to-end by running through
  test conversations. In addition to full test conversatons, you can
...
Testing your assistant requires you to write test conversations, which include
...
By default Rasa Open Source saves test conversations to `tests/test_stories.yml`.
...
`rasa test` report recall, precision, and f1 measure for each entity type that
your trainable entity extractors are trained to recognize.

:::caution incorrect entity annotationd
...
specific policy, you want to measure how well your dialogue model will generalise
