...
abstract: Rasa Open Source lets you test dialogues end-to-end by running through
  test conversations. In addition, you can
  also test the dialogue management and the natural language understanding(NLU) model
  separately.
---
...
In addition to intent classifiers, `rasa test` also evaluates response selectors, producing a
