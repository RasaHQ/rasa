...
with different dependencies installed. See [Additional Dependencies](../installation/step-by-step-guide.mdx#additional-dependencies) for more dependency information
