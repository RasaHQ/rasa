...
with different dependencies installed. See [Additional Dependencies](../installation/rasa-open-source/step-by-step-guide.mdx#additional-dependencies) for more dependency information
