...
[Deploying Your Rasa Assistant](../deploy/introduction.mdx) to learn how to deploy your model.
...
model you created via one of our [recommended deployment methods](../deploy/introduction.mdx#recommended-deployment-methods).
