...
A Rasa action server runs [custom actions](../building-assistants/custom-actions.mdx) for a Rasa Open Source
...
of [responses](../building-assistants/responses.mdx) and [events](./events.mdx).
