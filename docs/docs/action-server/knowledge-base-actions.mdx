...
In order to query the knowledge base to list any kind of object, the user's request needs to include the object type.
...
attribute of interest. The user is not required to query the knowledge base to list any kind of object prior to this.
