...
The body of the `POST` request sent to your NLG endpoint will look somewhat
like this:
...
Rasa will then sent this response back to the user.
...
Just like domain [responses](./responses.mdx), a response needs to contain at the very least
