...
If the `from_entity` mapping is unique for some slot then
it can also be used extract this slot from a given entity
even if this slot wasn't requested by the form.
