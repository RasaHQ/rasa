...
Note that if you use the `global_not_intent` parameter then the keyword `required_slots`
should precede the definition of slot mappings as shown in the above example.
