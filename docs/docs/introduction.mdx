...
Coming from Rasa Open Source 2.x? Check out our [2.x to 3.x migration guide](migration-guide.mdx).

:::note Legacy Docs
These docs are for Rasa Open Source 3.0 and later. You can find documentation for Rasa
