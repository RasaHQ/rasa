...
[How to Choose a Pipeline](./choosing-a-pipeline#how-to-choose-a-pipeline) for recommended starting configurations, or
[Pipeline Templates (deprecated)](./choosing-a-pipeline#pipeline-templates) for more information.
...
check out [How to Choose a Pipeline](./choosing-a-pipeline#how-to-choose-a-pipeline). For more information about a deprecated pipeline template,
expand it below.
...
See [Pre-trained Word Vectors](./language-support#pretrained-word-vectors) for more information about loading spacy language models.
...
can replace the `WhitespaceTokenizer` with your own tokenizer. We support a number of different [tokenizers](./components#tokenizers),
or you can [create your own](../api/custom-nlu-components).
...
[here](./language-support#mitie). This will give you the file path to pass to the `model` parameter.
