...
* **Description**
  ...
  This component extract entities using the [lookup tables](nlu-training-data.mdx#synonyms) and [regexes](nlu-training-data.mdx#regular-expressions-for-entity-extraction) defined in the training data.
