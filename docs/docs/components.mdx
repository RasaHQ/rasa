...
* **Description**
  ...
  Include a [tokenizer](./components.mdx#tokenizers) and [LanguageModelFeaturizer](./components.mdx#languagemodelfeaturizer) to utilize the output of this
...
* **Requires**
  ...
  `tokens` and [HFTransformersNLP](./components.mdx#hftransformersnlp).
...
* **Configuration**
  ...
  Include [HFTransformersNLP](./components.mdx#hftransformersnlp) and a [Tokenizer](./components.mdx#tokenizers) components before this component. Use
  [HFTransformersNLP](./components.mdx#hftransformersnlp) to ensure tokens are correctly set for all components throughout the pipeline.
...
:::caution Deprecated
The `LanguageModelTokenizer` is deprecated. The [HFTransformersNLP](./components.mdx#hftransformersnlp) now implements
its behaviour. Any [tokenizer](./components.mdx#tokenizers) can be used in its place; this must be placed before the
[HFTransformersNLP](./components.mdx#hftransformersnlp) Component.
:::

:::caution Deprecated
The `ConveRTokenizer` is deprecated. The [ConveRTFeaturizer](./components.mdx#convertfeaturizer) now implements
its behaviour. Any [tokenizer](./components.mdx#tokenizers) can be used in its place.
:::