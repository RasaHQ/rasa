...
* **Configuration**
  ...
  **Configuring for incremental training**
  ...
  To account for additional patterns added during [incremental training](./command-line-interface.mdx#incremental-training), configure the `number_additional_patterns` parameter while training the base model from scratch:
...
* **Configuration**
  ...
  **Configuring for incremental training**
  ...
  To account for the extra vocabulary that new training examples will
  bring in during [incremental training](./command-line-interface.mdx#incremental-training), configure the `additional_vocabulary_size` parameter while training the base model from scratch:
