...
* **Configuration**
  ...
  [installing MITIE](./installation/rasa-open-source/step-by-step-guide.mdx#dependencies-for-mitie).
...
* **Configuration**
  ...
  [installing SpaCy](./installation/rasa-open-source/step-by-step-guide.mdx#dependencies-for-spacy).
