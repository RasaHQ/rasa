...
* **Configuration**
  ...
  `BertGeneration`, `Bartphor`, `Bertweet`, `BlenderbotSmall`, `ByT5`, `Canine`, `CLIP`, `CTRL`, `LayoutLMv2`,
  `LayoutXLM`, `LED`, `MBart50`, `Perceiver`, `Phobert`, `Reformer`, `Speech2Text`, `Speech2Text2`, `T5`, `Tapas`,
  `TransfoXL`, `Wav2Vec2CTC`, `Wav2Vec2`, `XLMProphetNet`
