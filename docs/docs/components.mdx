...
* **Configuration**
  ...
  [installing MITIE](./installation/step-by-step-guide.mdx#dependencies-for-mitie).
...
* **Configuration**
  ...
  [installing SpaCy](./installation/step-by-step-guide.mdx#dependencies-for-spacy).
