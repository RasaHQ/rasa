...
* **Configuration**
  ...
  not work due to how Rasa's internal tokenization interacts with the HuggingFace tokenizers. If you encounter an issue
  with a specific model other than the ones listed in the table above, please let us know on
