...
* **Configuration**
  ...
  **Configuring for incremental training**
  ...
  If not configured by the user, the component will account for a minimum of 1000 additional
  vocabulary slots and a maximum of half the current vocabulary size.
