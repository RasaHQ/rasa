...
* **Configuration**
  ...
  **Configuring for incremental training**
  ...
  This component needs to account for the additional patterns added during [incremental training](./command-line-interface.mdx#incremental-training).
  Use `number_additional_patterns` to configure this number while training the base model from scratch:
...
* **Configuration**
  ...
  **Configuring for incremental training**
  ...
  This component needs to account for the extra vocabulary that new training examples will
  bring in during the process of [incremental training](./command-line-interface.mdx#incremental-training).
  Use `additional_vocabulary_size` while training the base model from scratch to account for this:
  ...
  As the above example shows, you can define these values for each of
  `text` (user message), `response` (bot messages used by `ResponseSelector`) and
  `action_text` (text of bot actions). If you are building a shared
