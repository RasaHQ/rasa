...
[migration guide](migration-guide#custom-policies-and-custom-components) for a
...
See the [guide on custom components](custom-graph-components) for a full guide on this.
