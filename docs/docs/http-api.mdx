...
:::caution
Using multiple worker processes does not work when using the 
[SocketIO channel](https://rasa.com/docs/rasa/reference/rasa/core/channels/socketio). Instead, use multiple 
containers or pods with a single Sanic worker to scale up.
