...
You define you markers in a marker configuration file written in `YAML`.
...
By default, the script will process the marker definitions provided in the `marker.yml` file. To specify a different marker configuration file, use the optional `--config` argument.
...
The next two sections give more detail about the formats of the extracted markers and computed statistics.
