...
Here is an example of the extracted markers output file (for a markers configuration file containing two markers: `marker_mood_expressed` and `marker_cheer_up_failed`):

```
sender_id,session_idx,marker,event_id,num_preceding_user_turns
