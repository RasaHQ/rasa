...
of that entity. Each of the regexes provide the intent classifier or entity extractor with an extra binary feature, 
which says if the regex was found or not. 
...
this regex is used for and is the title of the corresponding pattern feature. 
