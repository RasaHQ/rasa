...
In addition to the entity name, you can annotate an entity with [synonyms](nlu-training-data.mdx#synonyms), [roles, or groups](nlu-training-data.mdx#entity-roles-and-groups).
...
for, see the section on [entity roles and groups](./nlu-training-data.mdx#entity-roles-and-groups).
