...
[Synonyms](./nlu-training-data.mdx#synonyms) provide a way to normalize your training data by mapping an
...
Read more about when and how to use regular expressions with each component on the [NLU Training Data page](./nlu-training-data.mdx).
...
Read more about using lookup tables on the [NLU Training Data page](./nlu-training-data.mdx).
