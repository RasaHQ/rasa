...
Instead, you can simply put the text of the user message directly in the stories,
by using `user:` key.
...
use `bot:` key followed by the text that you want your bot to say.
