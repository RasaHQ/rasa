...
The `next` field in steps allows to link steps together and create 
branching logic. 
...
proceed to different steps. This allows you to create complex
...
The slot needs to be defined in the domain file. See the [domain
documentation](./domain.mdx) for more information. Additionaly, the slot
