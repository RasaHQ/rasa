...
<img alt="LUIS Export" src="../../img/luis_export.png" width="240" />
...
in LUIS.
LUIS’s `patterns` feature is very similar to Rasa NLU’s [regex features](../nlu/training-data-format/#regular-expression-features)
