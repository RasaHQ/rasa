...
<img caption="Selecting Export a" src={useBaseUrl("/img/luis_export.png")}
alt="Opening the menu in the top right corner of LUIS Applications reveals
the Export app option." width="240" />
