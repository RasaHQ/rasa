...
<br />
<br />Let's get started with migrating your application from Dialogflow to Rasa (you can find a more detailed tutorial <a className="reference external" href="http://blog.rasa.com/how-to-migrate-your-existing-google-dialogflow-assistant-to-rasa/" target="_blank">here</a>):## Step 1: Export your data from Dialogflow

Navigate to your agent’s settings by clicking the gear icon.



<img alt="Dialogflow Export" src="../../img/dialogflow_export.png" width="240" />

Click on the ‘Export and Import’ tab and click on the ‘Export as ZIP’ button.



<img alt="Dialogflow Export 2" src="../../img/dialogflow_export_2.png" width="675" />
...
In Dialogflow, there is a concept called `Fulfillment`. In Rasa we call this a [Custom Action](../core/actions/#custom-actions).
