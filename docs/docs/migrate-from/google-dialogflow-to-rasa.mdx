...
<img alt="Dialogflow: selecting settings" src={useBaseUrl("/img/dialogflow_export.png")} width="240" />

Click on the 'Export and Import' tab and click on the 'Export as ZIP' button.



<img alt="Dialogflow: selecting Export and Import" src={useBaseUrl("/img/dialogflow_export_2.png")} width="675" />
