...
<img caption="Selecting settings" src={useBaseUrl("/img/dialogflow_export.png")} width="240"
alt="In DialogFlow, the gear icon that indicates settings sits next to the dropdown menu for
...
<img caption="Selecting Export and Import" src={useBaseUrl("/img/dialogflow_export_2.png")} width="675"
