...
:::tip Disable Log colors
If you prefer that Rasa do not print colored logs, you can just assign any value to the NO_COLOR environment variable. That will disable colors.
:::
