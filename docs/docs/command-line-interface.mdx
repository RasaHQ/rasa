...
|`rasa evaluate markers` |Applies markers to existing tracker store.                                                                                                |
...
This command allows you to apply the [markers](./markers.mdx) you defined in your marker configuration file,
to pre-existing dialogues stored in your [tracker store](./tracker-stores.mdx):
