...
you can use [Rasa Webchat](#webchat-widget), a widget which you can incorporate into your existing webpage by adding an HTML snippet.
...
Once you've set up your SocketIO channel you can use the official Rasa Webchat Widget on any webpage.
...
For more information you can check out the [full documentation](https://webchat-docs.rasa.com/).

Alternatively, if you want to embed the widget in a React app, there is
[a library in the NPM package repository](https://www.npmjs.com/package/@rasahq/rasa-webchat).
