...
For more information, including how to fully customize the widget to fit in with your website, you can check out the [full documentation](https://chat-widget-docs.rasa.com/).
