...
to test your bot](https://rasa.com/docs/rasa-x/share-assistant/#share-your-bot).
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="rest-channels"></a>
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="callbackinput"></a>
