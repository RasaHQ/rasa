...
<Image
  img={twilioWebhook}
  caption="Set Twilio Webhook"
  alt="Screenshot of Twilio Console to Set Webhook"
  max-width="500px"
/>
...
<Image
  img={twilioSipWebhook}
  caption="Set Twilio SIP Domain Webhook"
  alt="Screenshot of Twilio Console to Set Webhook"
  max-width="500px"
/>
...
[channel-specific variations](../building-assistants/responses.mdx#channel-specific-response-variations) where
necessary.
...
[channel specific responses](../building-assistants/responses.mdx#channel-specific-response-variations) for all
