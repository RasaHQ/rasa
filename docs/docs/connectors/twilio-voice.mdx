...
[channel-specific variations](../concepts/responses.mdx#channel-specific-response-variations) where
necessary.
...
[channel specific responses](../concepts/responses.mdx#channel-specific-response-variations) for all
