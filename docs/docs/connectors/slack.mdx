...
for direct messages and app mentions, i.e. _@app_name_.
...
1. To create the app go to [Your Apps](https://api.slack.com/apps "The Your Apps section of your Slack interface") and click
   ...
   <Image
     ...
     alt="Create New Slack App Screenshot"
     max-width="500px"
   />
...
2. Head over to **OAuth & Permissions** and scroll down to **Scopes**. Scopes give
   ...
   <Image
     img={scopesImg}
     caption="Set up Slack Permissions"
     alt="Set up Slack Permissions Screenshot"
     max-width="500px"
   />
...
3. On the **OAuth & Permissions** page, click **Install App to Workspace** to add
   ...
   <Image
     img={installAppImg}
     caption="Install Slack App"
     alt="Install Slack App Screenshot"
     max-width="500px"
   />
...
2. To send messages directly to your bot using the slack UI, head to **App Home**,
   ...
   <Image
     ...
     alt="Allow users to send Slash commands and messages from the messages tab"
     max-width="500px"
   />
...
4. As a last step, you'll need to **Subscribe to bot events** on the same page.
   ...
   <Image
     ...
     alt="Subscribe to Bot Events Screenshot"
     max-width="500px"
   />
...
<Image
  img={interactivityImg}
  caption="Enabling Interactivity"
  alt="Interactivity Screenshot"
  max-width="500px"
/>
