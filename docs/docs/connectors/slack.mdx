...
2. Configure the webhook by heading to **Event Subscriptions** and
   ...
   are using ngrok, your url should look like `https://92832de0.ngrok.io/webhooks/slack/webhook`. If you're
   using Rasa X, your url should look like `https://<host>/core/webhooks/slack/webhook`.
