...
Your bot can reply with text messages like with any other channel. The text-to-speech engine will convert it and deliver it as a voice message to the user.
...
We will look at one example ehere so you understand how these work and how to use them.
