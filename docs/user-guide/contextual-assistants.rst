...
After following the basics of setting up an assistant in the `Rasa Tutorial <https://rasa.com/docs/rasa/user-guide/rasa-tutorial/>`_
and walking through `Building an FAQ Assistant <https://rasa.com/docs/rasa/user-guide/faq-assistants/>`_ we'll now walk through
building a bot that can handle contextual conversations.
