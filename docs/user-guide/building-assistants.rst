...
When you’re ready to enhance your assistant with context, check out build-contextual-assistant_.
...
Please make sure you’ve got all the data from the build-faq-assistant_ before starting this tutorial.
