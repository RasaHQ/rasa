...
html_theme_options = {
    ...
    'fixed_sidebar': True,
    'product': 'NLU',
    "base_url": "https://legacy-docs.rasa.com/docs/nlu/",
}
#html_theme_options = {}
...
latex_documents = [
    (master_doc, 'rasa_nlu.tex', u'rasa\\_nlu Documentation',
     u'Alan Nichol', 'manual'),
]
...
man_pages = [
    (master_doc, 'rasa_nlu', u'rasa_nlu Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rasa_nlu', u'rasa_nlu Documentation',
     author, 'rasa_nlu', 'One line description of project.',
     'Miscellaneous'),
]
