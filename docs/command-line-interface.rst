...
``rasa run``               Starts a server with your model. See the :ref:`_section_http` docs for details.
...
In case you have a combined Rasa model but nevertheless want see what your model
