...
module.exports = {
  ...
  themeConfig: {
    announcementBar: {
      ...
      content: 'These docs are for version 2.0.0rc4 of Rasa Open Source. <a href="https://legacy-docs-v1.rasa.com/">Docs for the stable 1.x series can be found here.</a>',
