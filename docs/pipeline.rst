...
:Description:
    ...
    .. note:: If the model language is not English or other languages that words can be split by white-space. A language-specific tokenizer is required in the pipeline before this component (e.g. using ``tokenizer_jieba`` for Chinese language)
