...
@pytest.fixture(scope="session")
async def trained_intent_ted_policy_moodbot_path(trained_async: Callable) -> Text:
    return await trained_async(
        domain="data/test_moodbot/domain.yml",
...
@pytest.fixture(scope="session")
async def intent_ted_policy_moodbot_agent(
    trained_intent_ted_policy_moodbot_path: Text,
) -> Agent:
    return await load_agent(model_path=trained_intent_ted_policy_moodbot_path)
