...
) -> Callable[[Dict[Text, Any]], DucklingEntityExtractorGraphComponent]:
    def inner(config: Dict[Text, Any]) -> DucklingEntityExtractorGraphComponent:
        return DucklingEntityExtractorGraphComponent.create(
            config={
                **DucklingEntityExtractorGraphComponent.get_default_config(),
...
def test_duckling_entity_extractor_with_multiple_extracted_dates(
    create_duckling: Callable[[Dict[Text, Any]], DucklingEntityExtractorGraphComponent]
):
