...
async def test_find_conflicts_in_short_history():
    trackers, domain = await _setup_trackers_for_testing(
        "data/test_domains/default.yml", "data/test_yaml_stories/stories_conflicting_1.yml"
    )
...
async def test_find_conflicts_checkpoints():
    trackers, domain = await _setup_trackers_for_testing(
        "data/test_domains/default.yml", "data/test_yaml_stories/stories_conflicting_2.yml"
    )
...
async def test_find_conflicts_or():
    trackers, domain = await _setup_trackers_for_testing(
        "data/test_domains/default.yml", "data/test_yaml_stories/stories_conflicting_3.yml"
    )
...
async def test_find_conflicts_slots_that_break():
    trackers, domain = await _setup_trackers_for_testing(
        "data/test_domains/default.yml", "data/test_yaml_stories/stories_conflicting_4.yml"
    )
