...
def test_pika_message_property_app_id(monkeypatch: MonkeyPatch):
    ...
    monkeypatch.setattr(PikaEventBroker, "run", lambda _: None)
    ...
    assert not _get_message_properties().app_id
    ...
    assert _get_message_properties().app_id == rasa_environment
