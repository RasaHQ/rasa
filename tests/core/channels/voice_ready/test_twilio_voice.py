...
async def test_twilio_receive_answer(stack_agent: Agent):
    ...
    assert response.body == b'<?xml version="1.0" encoding="UTF-8"?><Response />'
...
async def test_twilio_receive_no_response(stack_agent: Agent):
    ...
    assert (
        response.body
        == b'<?xml version="1.0" encoding="UTF-8"?><Response><Gather action="/webhooks/twilio_voice/webhook" actionOnEmptyResult="true" enhanced="false" input="speech" speechModel="default" speechTimeout="5"><Say voice="woman">i didn\'t get that</Say></Gather></Response>'  # noqa: E501
    )
