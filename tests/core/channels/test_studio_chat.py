...
def test_tracker_as_dump_runs(default_tracker: DialogueStateTracker):
...
async def test_studio_chat_handle_tracker_update(
    ...
    default_agent.tracker_store.save(default_tracker)
    ...
    assert len(retrieved_tracker.events) == 1
