...
from rasa.core.domain import Domain, SessionConfig, KEY_END_TO_END_UTTERANCES
...
"""
    ...
    actual = domain.action_for_name("Hi", None)
...
"""
    ...
    e2e_action = domain.action_for_name("Hi", None)
