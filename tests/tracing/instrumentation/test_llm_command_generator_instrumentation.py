...
async def test_tracing_llm_command_generator_default_attrs(
    ...
    await mock_llm_command_generator.invoke_llm(
...
@pytest.mark.usefixtures("mock_configuration")
async def test_tracing_llm_command_generator_prompt_tokens_llm_model_group_router_openai(  # noqa: E501
    default_model_storage: ModelStorage,
    tracer_provider: TracerProvider,
    span_exporter: InMemorySpanExporter,
    previous_num_captured_spans: int,
...
@pytest.mark.usefixtures("mock_configuration")
async def test_tracing_llm_command_generator_prompt_tokens_router_group_no_openai(
    default_model_storage: ModelStorage,
    tracer_provider: TracerProvider,
    span_exporter: InMemorySpanExporter,
    previous_num_captured_spans: int,
