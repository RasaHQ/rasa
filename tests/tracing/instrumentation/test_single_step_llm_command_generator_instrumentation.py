...
@pytest.fixture
def mock_llm_factory(fake_llm_client: LLMClient) -> Generator[Mock, None, None]:
...
def test_tracing_single_llm_command_generator_check_commands_against_startable_flows(
    default_model_storage: ModelStorage,
    tracer_provider: TracerProvider,
    span_exporter: InMemorySpanExporter,
    previous_num_captured_spans: int,
...
@pytest.mark.usefixtures("mock_configuration")
async def test_tracing_single_step_llm_command_generator_prompt_tokens_llm_model_group_router_openai(  # noqa: E501
    default_model_storage: ModelStorage,
    tracer_provider: TracerProvider,
    span_exporter: InMemorySpanExporter,
    previous_num_captured_spans: int,
...
@pytest.mark.usefixtures("mock_configuration")
async def test_tracing_single_step_llm_command_generator_prompt_tokens_router_group_no_openai(  # noqa: E501
    default_model_storage: ModelStorage,
    tracer_provider: TracerProvider,
    span_exporter: InMemorySpanExporter,
    previous_num_captured_spans: int,
