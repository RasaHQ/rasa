...
@pytest.mark.parametrize(
    ...
    [
        (LLM_COMMAND_GENERATOR_CPU_USAGE_METRIC_NAME, Histogram),
        (LLM_COMMAND_GENERATOR_MEMORY_USAGE_METRIC_NAME, Histogram),
        (LLM_COMMAND_GENERATOR_PROMPT_TOKEN_USAGE_METRIC_NAME, Histogram),
        (LLM_COMMAND_GENERATOR_LLM_RESPONSE_DURATION_METRIC_NAME, Histogram),
        (ENTERPRISE_SEARCH_POLICY_LLM_RESPONSE_DURATION_METRIC_NAME, Histogram),
        (INTENTLESS_POLICY_LLM_RESPONSE_DURATION_METRIC_NAME, Histogram),
        (
            CONTEXTUAL_RESPONSE_REPHRASER_LLM_RESPONSE_DURATION_METRIC_NAME,
            Histogram,
        ),
