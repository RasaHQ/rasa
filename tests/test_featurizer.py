...
from rasa_core.featurizers import Featurizer, \
    BinaryStateFeaturizer, ProbabilisticStateFeaturizer
import numpy as np
...
# TODO featurizers changed quite a lot, testing StateFeaturizer
def test_binary_featurizer_handles_on_non_existing_features():
    f = BinaryStateFeaturizer()
...
def test_probabilistic_featurizer_handles_on_non_existing_features():
    f = ProbabilisticStateFeaturizer()
