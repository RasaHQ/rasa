...
from rasa_core.featurizers import Featurizer, \
    BinaryFeaturizeMechanism, ProbabilisticFeaturizeMechanism
import numpy as np
...
# TODO featurizers changed quite a lot, testing FeaturizeMechanism
def test_binary_featurizer_handles_on_non_existing_features():
    f = BinaryFeaturizeMechanism()
...
def test_probabilistic_featurizer_handles_on_non_existing_features():
    f = ProbabilisticFeaturizeMechanism()
