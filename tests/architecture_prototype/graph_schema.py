...
nlu_train_graph_schema = {
    ...
    "train_classifier": {
        "uses": DIETClassifier,
        "fn": "train",
        "config": {"epochs": 10, "random_seed": 42},
...
full_model_train_graph_schema = {
    ...
    "create_e2e_lookup": {
        ...
        "fn": "convert",
        "config": {},
        "needs": {"messages": "core_add_count_features2",},
        "persist": False,
    },
...
predict_graph_schema = {
    ...
    "add_lexical_features": {
        ...
        "needs": {"messages": "add_regex_features",},
    },
    "add_count_features1": {
        "uses": CountVectorsFeaturizer,
        "constructor_name": "load",
        ...
        "needs": {"messages": "add_lexical_features",},
    },
    "add_count_features2": {
        "uses": CountVectorsFeaturizer,
        "constructor_name": "load",
        ...
        "needs": {"messages": "add_count_features1",},
    },
    "classify": {
        "uses": DIETClassifier,
        "fn": "process",
        ...
        "needs": {"messages": "add_count_features2"},
    },
    "synonym_mapper": {
        "uses": EntitySynonymMapper,
        "constructor_name": "load",
    ...
    "response_selector": {
        ...
        "needs": {"messages": "synonym_mapper"},
    },
    "fallback_classifier": {
        "uses": FallbackClassifier,
        "fn": "process",
        "config": {},
        "needs": {"messages": "response_selector"},
    },
    "load_history": {
        "uses": TrackerLoader,
        "fn": "load",
    ...
    "add_parsed_nlu_message": {
        ...
        "needs": {
            ...
            "parsed_messages": "fallback_classifier",
            "domain": "load_domain",
        },
        "config": {},
        "persist": False,
    ...
    "core_add_regex_features": {
        ...
        "needs": {"messages": "core_tokenize",},
    },
    "core_add_lexical_features": {
        "uses": LexicalSyntacticFeaturizer,
        "constructor_name": "load",
        "fn": "process",
        "config": {"resource_name": "core_train_lexical_featurizer",},
        "needs": {"messages": "core_add_regex_features",},
    },
    "core_add_count_features1": {
        "uses": CountVectorsFeaturizer,
        "constructor_name": "load",
        ...
        "needs": {"messages": "core_add_lexical_features",},
    },
    "core_add_count_features2": {
        "uses": CountVectorsFeaturizer,
        "constructor_name": "load",
        ...
        "needs": {"messages": "core_add_count_features1",},
    },
    "create_e2e_lookup": {
        "uses": MessageToE2EFeatureConverter,
        "fn": "convert",
