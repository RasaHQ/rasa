...
## [3.2.0] - 2022-06-14
### Deprecations and Removals
- [#10989](https://github.com/rasahq/rasa/issues/10989): [NLU training data](https://rasa.com/docs/rasa-pro/nlu-based-assistants/nlu-training-data.mdx) in JSON format is deprecated and will be
...
- [#8868](https://github.com/rasahq/rasa/issues/8868): Follow through on deprecation warnings for the `Domain`. Most importantly this will
  enforce the schema of the [`forms` section](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) in the domain file.
...
- [#9803](https://github.com/rasahq/rasa/issues/9803): Rasa Open Source now uses the [model configuration](https://rasa.com/docs/rasa-pro/nlu-based-assistants/model-configuration.mdx) to build a
  ...
  [migration guide](https://rasa.com/docs/rasa-pro/migration-guide.mdx#custom-policies-and-custom-components).
...
- [#9782](https://github.com/rasahq/rasa/issues/9782): Updates [quick install documentation](https://rasa.com/docs/rasa-pro/installation/python/installation.mdx) with optional venv step, better pip install instructions, & M1 warning
...
- [#9045](https://github.com/rasahq/rasa/issues/9045): The option `model_confidence=linear_norm` is deprecated and will be removed in Rasa Open Source `3.0.0`.
  ...
  we also recommend to [re-tune the thresholds for fallback components](https://rasa.com/docs/rasa-pro/nlu-based-assistants/fallback-handoff.mdx#fallbacks).
...
### Features
- [#8724](https://github.com/rasahq/rasa/issues/8724): Added `sasl_mechanism` as an optional configurable parameters for the [Kafka Producer](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#kafka-event-broker).
- [#8913](https://github.com/rasahq/rasa/issues/8913): Introduces a new policy called [`UnexpecTEDIntentPolicy`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#unexpected-intent-policy).
  ...
  `UnexpecTEDIntentPolicy` helps you review conversations
   ...
   [`action_unlikely_intent`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/default-actions.mdx#action_unlikely_intent) action.
  ...
  - [`IntentMaxHistoryTrackerFeaturizer`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#3-intent-max-history)
  ...
  - A new default action called [`action_unlikely_intent`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/default-actions.mdx#action_unlikely_intent).
...
- [#8232](https://github.com/rasahq/rasa/issues/8232): Users don't need to specify an additional buffer size for sparse featurizers anymore during incremental training.
  ...
  This means there's no need to specify `additional_vocabulary_size` for [`CountVectorsFeaturizer`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#countvectorsfeaturizer) or
  `number_additional_patterns` for [`RegexFeaturizer`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#regexfeaturizer). These parameters are now deprecated.
...
- [#8295](https://github.com/rasahq/rasa/issues/8295): Speed up the contradiction check of the [`RulePolicy`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#rule-policy)
  by a factor of 3.
- [#8801](https://github.com/rasahq/rasa/issues/8801): Change the confidence score assigned by [`FallbackClassifier`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#fallbackclassifier) to fallback intent to be the same as the fallback threshold.
...
### Bugfixes
- [#8364](https://github.com/rasahq/rasa/issues/8364): Fixed a bug where [`ListSlot`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#list-slot)s were filled with single items
  in case only one matching entity was extracted for this slot.

  Values applied to [`ListSlot`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#list-slot)s will be converted to a `List`
...
- [#261](https://github.com/rasahq/rasa/issues/261): In forms, the keyword `required_slots` should always precede the definition of slot mappings and the lack of it is deprecated.
  Please see the [migration guide](https://rasa.com/docs/rasa-pro/migration-guide.mdx) for more information.
...
- [#8180](https://github.com/rasahq/rasa/issues/8180): Allows a Rasa bot to be connected to a Twilio Voice channel. More details in the [Twilio Voice docs](https://rasa.com/docs/rasa-pro/connectors/twilio-voice.mdx)
...
- [#261](https://github.com/rasahq/rasa/issues/261): Added an optional `ignored_intents` parameter in forms.
  ...
  - To use it, add the `ignored_intents` parameter  in your `domain.yml` file after the forms name and provide a list of intents to ignore. Please see [Forms](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) for more information.
...
### Features
- [#8892](https://github.com/rasahq/rasa/issues/8892): Added `sasl_mechanism` as an optional configurable parameters for the [Kafka Producer](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#kafka-event-broker).
...
- [#7869](https://github.com/rasahq/rasa/issues/7869): Upgraded Rasa to be compatible with spaCy 3.0.
  ...
  **Fallback**
  ...
  correct spaCy model. We've also added a warning to the [SpaCyNLP](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#spacynlp)
...
- [#8335](https://github.com/rasahq/rasa/issues/8335): Added partition_by_sender flag to [Kafka Producer](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#kafka-event-broker) to optionally associate events with Kafka partition based on sender_id.
...
- [#8258](https://github.com/rasahq/rasa/issues/8258): Fixed the bug that events from previous conversation sessions would be re-saved in the [`SQLTrackerStore`](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx#sqltrackerstore) or [`MongoTrackerStore`](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx#mongotrackerstore) when `retrieve_events_from_previous_conversation_sessions` was true.
...
- [#6484](https://github.com/rasahq/rasa/issues/6484): NLG Server
  ...
  `rasa.core.agent`
  - The terminology `template` is deprecated and replaced by `response`. Support for `template` from the NLG response will be removed in Rasa Open Source 3.0.0. Please see [here](https://rasa.com/docs/rasa-pro/production/nlg.mdx) for more details.
  ...
  Response Selector
  - The field `template_name` will be deprecated in Rasa Open Source 3.0.0. Please use `utter_action` instead. Please see [here](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#selectors) for more details.
  - The field `response_templates` will be deprecated in Rasa Open Source 3.0.0. Please use `responses` instead. Please see [here](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#selectors) for more details.
...
- [#8100](https://github.com/rasahq/rasa/issues/8100): Improved the [lock store](https://rasa.com/docs/rasa-pro/production/lock-stores.mdx) debug log message when the process has to
...
### Features
- [#8860](https://github.com/rasahq/rasa/issues/8860): Added `sasl_mechanism` as an optional configurable parameters for the [Kafka Producer](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#kafka-event-broker).
...
- [#8014](https://github.com/rasahq/rasa/issues/8014): Setting `model_confidence=cosine` in `DIETClassifier`, `ResponseSelector` and `TEDPolicy` is deprecated and will no longer be available. This was introduced in Rasa Open Source version `2.3.0` but post-release experiments suggest that using cosine similarity as model's confidences can change the ranking of predicted labels which is wrong.
  ...
  ```
  This should ease up [tuning fallback thresholds](https://rasa.com/docs/rasa-pro/nlu-based-assistants/fallback-handoff.mdx#fallbacks) as confidences for wrong predictions are better distributed across the range `[0, 1]`.
  ...
  `model_confidence=cosine` is removed from the configuration generated by [auto-configuration](https://rasa.com/docs/rasa-pro/nlu-based-assistants/model-configuration.mdx#suggested-config).
...
- [#7420](https://github.com/rasahq/rasa/issues/7420): User message metadata can now be accessed via the default slot
  ...
  [custom `action_session_start`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/default-actions.mdx#customization).
...
- [#7616](https://github.com/rasahq/rasa/issues/7616): Added two new parameters `constrain_similarities` and `model_confidence` to machine learning (ML) components - [DIETClassifier](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#dietclassifier), [ResponseSelector](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#dietclassifier) and [TEDPolicy](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#ted-policy).
  ...
  The default [auto-configuration](https://rasa.com/docs/rasa-pro/nlu-based-assistants/model-configuration.mdx#suggested-config) is changed to use `constrain_similarities=True` and `model_confidence=cosine` in ML components so that new users start with the recommended configuration.
...
- [#7848](https://github.com/rasahq/rasa/issues/7848): Added support to configure `exchange_name` for [pika event broker](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#pika-event-broker).
...
### Bugfixes
- [#7764](https://github.com/rasahq/rasa/issues/7764): Fixes a bug in [forms](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) where the next slot asked was not consistent after returning to a form from an unhappy path.
...
### Improvements
- [#7520](https://github.com/rasahq/rasa/issues/7520): Improve the warning in case the [RulePolicy](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#rule-policy) or the deprecated
...
- [#7684](https://github.com/rasahq/rasa/issues/7684): Fixed a problem when using the `POST /model/test/intents` endpoint together with a
  [model server](https://rasa.com/docs/rasa-pro/production/model-storage.mdx#load-model-from-server). The error looked as follows:
...
### Bugfixes
- [#7557](https://github.com/rasahq/rasa/issues/7557): Fixed a problem where a [form](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) wouldn't reject when the
  `FormValidationAction` re-implemented `required_slots`.
- [#7585](https://github.com/rasahq/rasa/issues/7585): Fixed an error when using the [SQLTrackerStore](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx#sqltrackerstore)
...
- [#7458](https://github.com/rasahq/rasa/issues/7458): Interfaces for `Policy.__init__` and `Policy.load` have changed.
  See [migration guide](https://rasa.com/docs/rasa-pro/migration-guide.mdx#rasa-21-to-rasa-22) for details.
- [#7495](https://github.com/rasahq/rasa/issues/7495): Deprecate training and test data in Markdown format. This includes:
  ...
  from the [migration guide](https://rasa.com/docs/rasa-pro/migration-guide.mdx#rasa-21-to-rasa-22):
...
- [#6971](https://github.com/rasahq/rasa/issues/6971): Incremental training of models in a pipeline is now supported.
  ...
  training](https://rasa.com/docs/rasa-pro/command-line-interface.mdx#incremental-training).

  Added a configuration parameter `additional_vocabulary_size` to
  [`CountVectorsFeaturizer`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#countvectorsfeaturizer)
  and `number_additional_patterns` to [`RegexFeaturizer`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#regexfeaturizer).
...
- [#7496](https://github.com/rasahq/rasa/issues/7496): Make [TED Policy](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#ted-policy) an end-to-end policy. Namely, make it possible to train TED on stories that contain
...
- [#7408](https://github.com/rasahq/rasa/issues/7408): Temporary directories which were created during requests to the [HTTP API](https://rasa.com/docs/rasa-pro/production/http-api.mdx)
...
### Deprecations and Removals
- [#7136](https://github.com/rasahq/rasa/issues/7136): The [`Policy`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx) interface was changed to return a `PolicyPrediction` object when
  ...
  :::
- [#7263](https://github.com/rasahq/rasa/issues/7263): The [Pika Event Broker](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#pika-event-broker) no longer supports
  ...
  The method [`Event Broker.close`](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx) was changed to be asynchronous.
...
### Features
- [#7136](https://github.com/rasahq/rasa/issues/7136): [Policies](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx) can now return obligatory and optional events as part of their
...
- [#5715](https://github.com/rasahq/rasa/issues/5715): If you are using the feature [Entity Roles and Groups](https://rasa.com/docs/rasa-pro/nlu-based-assistants/nlu-training-data.mdx#entities-roles-and-groups), you should now also list the roles and groups
  ...
  [Entity Roles and Groups influencing dialogue predictions](https://rasa.com/docs/rasa-pro/nlu-based-assistants/nlu-training-data.mdx#entity-roles-and-groups-influencing-dialogue-predictions).
- [#6285](https://github.com/rasahq/rasa/issues/6285): Predictions of the [`FallbackClassifier`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#fallbackclassifier) are
  ignored when
  [evaluating the NLU model](https://rasa.com/docs/rasa-pro/nlu-based-assistants/testing-your-assistant.mdx#evaluating-an-nlu-model)
  Note that the `FallbackClassifier` predictions still apply to
  [test stories](https://rasa.com/docs/rasa-pro/nlu-based-assistants/testing-your-assistant.mdx#writing-test-stories).
...
- [#6498](https://github.com/rasahq/rasa/issues/6498): Adding configurable prefixes to Redis [Tracker](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx) and [Lock Stores](https://rasa.com/docs/rasa-pro/production/lock-stores.mdx) so that a single Redis instance (and logical DB) can support multiple conversation trackers and locks.
...
- [#6860](https://github.com/rasahq/rasa/issues/6860): Fetching test stories from the HTTP API endpoint
  ...
  of the
  [conversation session](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#session-configuration).

  Added a new boolean query parameter `all_sessions` (default: `false`) to the
  [HTTP API](https://rasa.com/docs/rasa-pro/production/http-api.mdx) endpoint for fetching test stories
  ...
  kwarg for the [Tracker Store](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx) class is deprecated and will be
...
- [#6966](https://github.com/rasahq/rasa/issues/6966): Added warning for when an option is provided for a [component](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx) that is not listed as a key in the defaults for that component.
- [#6977](https://github.com/rasahq/rasa/issues/6977): [Forms](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) no longer reject their execution before a potential custom
...
- [#7068](https://github.com/rasahq/rasa/issues/7068): Slot mappings for [Forms](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) in the domain are now optional. If you do not
  provide any slot mappings as part of the domain, you need to provide
  [custom slot mappings](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx#custom-slot-mappings) through a custom action.
  ...
  The action for [forms](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) can now be overridden by defining a custom action
...
- [#7122](https://github.com/rasahq/rasa/issues/7122): Add validations for [slot mappings](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx#slot-mappings).
...
- [#7263](https://github.com/rasahq/rasa/issues/7263): The [Pika Event Broker](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#pika-event-broker) was reimplemented with
...
- [#7278](https://github.com/rasahq/rasa/issues/7278): The confidence of the [`FallbackClassifier`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#fallbackclassifier)
...
- [#6721](https://github.com/rasahq/rasa/issues/6721): Fixed bug where slots with `influence_conversation=false` affected the action
  ...
  [HTTP API](https://rasa.com/docs/rasa-pro/production/http-api.mdx).
...
- [#7033](https://github.com/rasahq/rasa/issues/7033): - Fix `YAMLStoryReader` not being able to represent [`OR` statements](https://rasa.com/docs/rasa-pro/nlu-based-assistants/stories.mdx#or-statements) in conversion mode.
...
- [#6453](https://github.com/rasahq/rasa/issues/6453): Removed support for `queue` argument in `PikaEventBroker` (use `queues` instead).
  ...
  Removed several config options for [TED Policy](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#ted-policy), [DIETClassifier](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#dietclassifier) and [ResponseSelector](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#responseselector):
...
- [#6809](https://github.com/rasahq/rasa/issues/6809): [Slots](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#slots) of type `unfeaturized` are
  ...
  [migration guide](https://rasa.com/docs/rasa-pro/migration-guide.mdx#unfeaturized-slots).
- [#6934](https://github.com/rasahq/rasa/issues/6934): [Conversation sessions](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#session-configuration) are now enabled by default
  if your [Domain](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx) does not contain a session configuration.
  ...
  ```
- [#6952](https://github.com/rasahq/rasa/issues/6952): Using the [default action](https://rasa.com/docs/rasa-pro/nlu-based-assistants/default-actions.mdx) `action_deactivate_form` to deactivate
  the currently active loop / [Form](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) is deprecated.
...
- [#5510](https://github.com/rasahq/rasa/issues/5510): You can now define what kind of features should be used by what component
  (see [Choosing a Pipeline](https://rasa.com/docs/rasa-pro/nlu-based-assistants/tuning-your-model.mdx)).
  ...
  [DIETClassifier](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#dietclassifier) what features from which
...
- [#5957](https://github.com/rasahq/rasa/issues/5957): Add new entity extractor `RegexEntityExtractor`. The entity extractor extracts entities using the lookup tables
  and regexes defined in the training data. For more information see [RegexEntityExtractor](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#regexentityextractor).
...
- [#6065](https://github.com/rasahq/rasa/issues/6065): Add support for [rules](https://rasa.com/docs/rasa-pro/nlu-based-assistants/rules.mdx) data and [forms](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) in YAML
  format.
- [#6066](https://github.com/rasahq/rasa/issues/6066): The NLU `interpreter` is now passed to the [Policies](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx) during training and
...
- [#6088](https://github.com/rasahq/rasa/issues/6088): Added the new dialogue policy RulePolicy which will replace the old “rule-like”
  ...
  [rules documentation](https://rasa.com/docs/rasa-pro/nlu-based-assistants/rules.mdx) for more information.

  Added new NLU component [FallbackClassifier](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#fallbackclassifier)
...
- [#5368](https://github.com/rasahq/rasa/issues/5368): Changed the project structure for Rasa projects initialized with the
  [CLI](https://rasa.com/docs/rasa-pro/command-line-interface.mdx) (using the `rasa init` command):
...
- [#5805](https://github.com/rasahq/rasa/issues/5805): The debug-level logs when instantiating an
  [SQLTrackerStore](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx#sqltrackerstore)
...
- [#6123](https://github.com/rasahq/rasa/issues/6123): Add support for proxy use in [slack](https://rasa.com/docs/rasa-pro/connectors/slack.mdx) input channel.
...
- [#6323](https://github.com/rasahq/rasa/issues/6323): [Response selector templates](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#responseselector) now support all features that
...
- [#6613](https://github.com/rasahq/rasa/issues/6613): Added telemetry reporting. Rasa uses telemetry to report anonymous usage information.
  ...
  [telemetry documentation](https://rasa.com/docs/rasa-pro/telemetry/telemetry.mdx).
...
- [#6809](https://github.com/rasahq/rasa/issues/6809): [Slots](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#slots) of any type can now be ignored during a conversation.
  ...
  [documentation for slots](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#slots) for more information.

  A new slot type [`any`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#any-slot) was added. Slots of this type can store
...
- [#5737](https://github.com/rasahq/rasa/issues/5737): Pinned the library version for the Azure
  [Cloud Storage](https://rasa.com/docs/rasa-pro/production/model-storage.mdx#load-model-from-cloud) to 2.1.0 since the
...
- [#6535](https://github.com/rasahq/rasa/issues/6535): [Forms](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx) with slot mappings defined in `domain.yml` must now be a
...
- [#6819](https://github.com/rasahq/rasa/issues/6819): Update ["Validating Form Input" section](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx#validating-form-input) to include details about
...
### Features
- [#8876](https://github.com/rasahq/rasa/issues/8876): Added `sasl_mechanism` as an optional configurable parameter for the [Kafka Producer](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#kafka-event-broker).
...
### Improvements
- [#8345](https://github.com/rasahq/rasa/issues/8345): Improved the [lock store](https://rasa.com/docs/rasa-pro/production/lock-stores.mdx) debug log message when the process has to queue because other messages have to be processed before this item.
...
- [#6226](https://github.com/rasahq/rasa/issues/6226): Added more debugging logs to the [Lock Stores](https://rasa.com/docs/rasa-pro/production/lock-stores.mdx) to simplify debugging in case of
...
* [#5976](https://github.com/rasahq/rasa/issues/5976): Fix server crashes that occurred when Rasa Open Source pulls a model from a
  [model server](https://rasa.com/docs/rasa-pro/production/model-storage.mdx#load-model-from-server) and an exception was thrown during
...
* [#5758](https://github.com/rasahq/rasa/issues/5758): Fixed a bug in [`rasa export`](https://rasa.com/docs/rasa-pro/command-line-interface.mdx#rasa-export)) which caused Rasa Open Source to only migrate conversation events from the last [Session configuration](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#session-configuration).
...
* [#3765](https://github.com/rasahq/rasa/issues/3765): Add support for entities with roles and grouping of entities in Rasa NLU.
  ...
  For more details see [Entities Roles and Groups](https://rasa.com/docs/rasa-pro/nlu-based-assistants/nlu-training-data.mdx#entities-roles-and-groups).
  ...
  `from_entity` (see [Forms](https://rasa.com/docs/rasa-pro/nlu-based-assistants/forms.mdx)).

  :::note
  Composite entities are currently just supported by the [DIETClassifier](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#dietclassifier) and [CRFEntityExtractor](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#crfentityextractor).
...
* [#5465](https://github.com/rasahq/rasa/issues/5465): Update training data format for NLU to support entities with a role or group label.
  ...
  For more information about the new data format see [Training Data Format](https://rasa.com/docs/rasa-pro/nlu-based-assistants/training-data-format.mdx).
...
* [#5578](https://github.com/rasahq/rasa/issues/5578): Added `socketio` to the compatible channels for [Reminders and External Events](https://rasa.com/docs/rasa-pro/nlu-based-assistants/reaching-out-to-user.mdx).
...
* [#5533](https://github.com/rasahq/rasa/issues/5533): Support for
  ...
  [SQLTrackerStore](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx#sqltrackerstore). The `SQLTrackerStore`
...
* [#5492](https://github.com/rasahq/rasa/issues/5492): Fix an issue where the deprecated `queue` parameter for the [Pika Event Broker](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#pika-event-broker)
...
* [#5258](https://github.com/rasahq/rasa/issues/5258): Added `PikaEventBroker` ([Pika Event Broker](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#pika-event-broker)) support for publishing to
...
* [#5446](https://github.com/rasahq/rasa/issues/5446): The endpoint `PUT /conversations/<conversation_id>/tracker/events` no longer
  ...
  see [Session configuration](https://rasa.com/docs/rasa-pro/nlu-based-assistants/domain.mdx#session-configuration)) in addition to the events which were sent in the request
...
* [#5215](https://github.com/rasahq/rasa/issues/5215): Fixed issue related to storing Python `float` values as `decimal.Decimal` objects
  ...
  Added a new docs section on [DynamoTrackerStore](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx#dynamotrackerstore).
...
* [#2237](https://github.com/rasahq/rasa/issues/2237): Restructure the “Evaluating models” documentation page and rename this page to [Testing Your Assistant](https://rasa.com/docs/rasa-pro/nlu-based-assistants/testing-your-assistant.mdx).
...
* [#5404](https://github.com/rasahq/rasa/issues/5404): Explain how to run commands as `root` user in Rasa SDK Docker images since version
  ...
  [Building an Action Server Image](https://rasa.com/docs/rasa-pro/deploy/deploy-action-server.mdx#building-an-action-server-image).
...
* [#5065](https://github.com/rasahq/rasa/issues/5065): Add [LexicalSyntacticFeaturizer](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#lexicalsyntacticfeaturizer) to sparse featurizers.
...
* [#5187](https://github.com/rasahq/rasa/issues/5187): Integrate language models from HuggingFace's [Transformers](https://github.com/huggingface/transformers) Library.
  ...
  Add [LanguageModelTokenizer](https://rasa.com/docs/rasa/2.x/components#languagemodeltokenizer) and [LanguageModelFeaturizer](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#languagemodelfeaturizer) which use the information from
...
* [#5225](https://github.com/rasahq/rasa/issues/5225): Added a new CLI command `rasa export` to publish tracker events from a persistent
  tracker store using an event broker. See [Export Conversations to an Event Broker](https://rasa.com/docs/rasa-pro/command-line-interface.mdx#rasa-export), [Tracker Stores](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx)
  and [Event Brokers](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx) for more details.

* [#5230](https://github.com/rasahq/rasa/issues/5230): Refactor how GPU and CPU environments are configured for TensorFlow 2.0.

  Please refer to the documentation on [Configuring TensorFlow](https://rasa.com/docs/rasa-pro/nlu-based-assistants/tuning-your-model.mdx#configuring-tensorflow) to understand
...
* [#5266](https://github.com/rasahq/rasa/issues/5266): Added a new NLU component [DIETClassifier](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#dietclassifier) and a new policy [TEDPolicy](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#ted-policy).

  DIET (Dual Intent and Entity Transformer) is a multi-task architecture for intent classification and entity
  recognition. You can read more about this component in the [DIETClassifier](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#dietclassifier) documentation.
  The new component will replace the `EmbeddingIntentClassifier` and the
  [CRFEntityExtractor](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#crfentityextractor) in the future.
  Those two components are deprecated from now on.
  See [migration guide](https://rasa.com/docs/rasa-pro/migration-guide.mdx#rasa-17-to-rasa-18) for details on how to
  switch to the new component.

  [TEDPolicy](https://rasa.com/docs/rasa-pro/nlu-based-assistants/policies.mdx#ted-policy) is the new name for EmbeddingPolicy.
...
* [#5211](https://github.com/rasahq/rasa/issues/5211): Messages sent to the [Pika Event Broker](https://rasa.com/docs/rasa-pro/production/event-brokers.mdx#pika-event-broker) are now persisted. This guarantees
...
* [#5197](https://github.com/rasahq/rasa/issues/5197): Fixed incompatibility of Oracle with the [SQLTrackerStore](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx#sqltrackerstore), by using a `Sequence`
  for the primary key columns. This does not change anything for SQL databases other than Oracle.
  If you are using Oracle, please create a sequence with the instructions in the [SQLTrackerStore](https://rasa.com/docs/rasa-pro/production/tracker-stores.mdx#sqltrackerstore) docs.
...
* [#4902](https://github.com/rasahq/rasa/issues/4902): The `EmbeddingPolicy`, `EmbeddingIntentClassifier`, and `ResponseSelector` now by default normalize confidence
  levels over the top 10 results. See [Rasa 1.6 to Rasa 1.7](https://rasa.com/docs/rasa-pro/migration-guide.mdx#rasa-16-to-rasa-17) for more details.
...
* [#4957](https://github.com/rasahq/rasa/issues/4957): To [use custom features in the `CRFEntityExtractor`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#crfentityextractor)
...
* [#4935](https://github.com/rasahq/rasa/issues/4935): Preparation for an upcoming change in the `EmbeddingIntentClassifier`:
  ...
  a matrix of size (token-length x feature-dimension). See [Text Featurizers](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#featurizers).
  ...
  See [passing custom features to the `CRFEntityExtractor`](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#crfentityextractor)
  ...
  Read more: [Text Featurizers](https://rasa.com/docs/rasa-pro/nlu-based-assistants/components.mdx#featurizers) .
