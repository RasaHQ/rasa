...
Rasa Pro is an open core product that extends Rasa Pro. With over 50 million downloads, Rasa Pro is the most popular open source framework for building chat and voice-based AI assistants.

Rasa Pro extends Rasa Pro with CALM, a generative AI-native approach to developing assistants, combined with enterprise-ready analytics, security, and observability capabilities. A paid license is required to run Rasa Pro, but all Rasa Pro code is visible to end users and can be customized as needed.
