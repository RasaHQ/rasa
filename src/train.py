...
def create_argparser():
    ...
    parser.add_argument('-b', '--backend', default=None, choices=['mitie', 'spacy_sklearn'],
                        help='which backend to use to interpret text (default: None i.e. use built in keyword matcher).')
