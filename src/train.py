...
parser.add_argument('--backend', required=True, choices=['mitie','sklearn'],help='which backend to use to interpret text (default: None i.e. use built in keyword matcher).')
parser.add_argument('--path', required=True,help="path where to save model files")
parser.add_argument('--data', required=True,help="file containing training data")
