...
To understand what the labels `role` and `group` are for, see section [Entities Roles and Groups](/docs/nlu/entity-extraction#entities-roles-groups).
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="lookup-tables"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="entity-synonyms"></a>
...
`EntitySynonymMapper` component (see [Components](/docs/nlu/components)).
