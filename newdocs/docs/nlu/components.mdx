...
out [Custom NLU Components](/docs/api/custom-nlu-components).
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="mitienlp"></a>
...
* **Configuration**
  ...
  [installing MITIE](/docs/user-guide/installation#install-mitie).


<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="spacynlp"></a>
...
* **Configuration**
  ...
  [installing SpaCy](/docs/user-guide/installation#install-spacy).


<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="hftransformersnlp"></a>
...
* **Description**
  ...
  Include [LanguageModelTokenizer](/docs/nlu/components#languagemodeltokenizer) and [LanguageModelFeaturizer](/docs/nlu/components#languagemodelfeaturizer) to utilize the output of this
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="tokenizers"></a>
...
* `intent_split_symbol` sets the delimiter string to split the intent labels, default is underscore
  ...
  :::note
  All tokenizers add an additional token `__CLS__` to the end of the list of tokens when tokenizing
  text and responses.

  :::

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="whitespacetokenizer"></a>
...
* **Requires**
  ...
  [MitieNLP](/docs/nlu/components#mitienlp)
...
* **Requires**
  ...
  [SpacyNLP](/docs/nlu/components#spacynlp)
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="converttokenizer"></a>
...
* **Description**
  ...
  Creates tokens using the ConveRT tokenizer. Must be used whenever the [ConveRTFeaturizer](/docs/nlu/components#convertfeaturizer) is used.
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="languagemodeltokenizer"></a>
...
* **Requires**
  ...
  [HFTransformersNLP](/docs/nlu/components#hftransformersnlp)



* **Description**

  Creates tokens using the pre-trained language model specified in upstream [HFTransformersNLP](/docs/nlu/components#hftransformersnlp) component.
  Must be used whenever the [LanguageModelFeaturizer](/docs/nlu/components#languagemodelfeaturizer) is used.
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="text-featurizers"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="mitiefeaturizer"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="spacyfeaturizer"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="convertfeaturizer"></a>
...
* **Requires**
  ...
  [ConveRTTokenizer](/docs/nlu/components#converttokenizer)
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="languagemodelfeaturizer"></a>
...
* **Requires**
  ...
  [HFTransformersNLP](/docs/nlu/components#hftransformersnlp) and [LanguageModelTokenizer](/docs/nlu/components#languagemodeltokenizer)
...
* **Description**
  ...
  Creates features for entity extraction, intent classification, and response selection.
  Uses the pre-trained language model specified in upstream [HFTransformersNLP](/docs/nlu/components#hftransformersnlp) component to compute vector
  representations of input text.
...
* **Configuration**
  ...
  Include [HFTransformersNLP](/docs/nlu/components#hftransformersnlp) and [LanguageModelTokenizer](/docs/nlu/components#languagemodeltokenizer) components before this component. Use
  [LanguageModelTokenizer](/docs/nlu/components#languagemodeltokenizer) to ensure tokens are correctly set for all components throughout the pipeline.
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="regexfeaturizer"></a>
...
* **Description**
  ...
  Regex features for entity extraction are currently only supported by the [CRFEntityExtractor](/docs/nlu/components#crfentityextractor) and the
  [DIETClassifier](/docs/nlu/components#diet-classifier) components!
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="countvectorsfeaturizer"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="lexicalsyntacticfeaturizer"></a>
...
* **Requires**
  ...
  `tokens` for user message and [MitieNLP](/docs/nlu/components#mitienlp)
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="keyword-intent-classifier"></a>
...
* **Description**
  ...
  [Choosing a Pipeline](/docs/nlu/choosing-a-pipeline).
...
* **Description**
  ...
  You can find the detailed description of the [DIETClassifier](/docs/nlu/components#diet-classifier) under the section
...
* **Requires**
  ...
  [MitieNLP](/docs/nlu/components#mitienlp) and `tokens`
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="spacyentityextractor"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="crfentityextractor"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="ducklinghttpextractor"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="response-selector"></a>
...
* **Description**
  ...
  a set of candidate responses. The prediction of this model is used by [Retrieval Actions](/docs/core/retrieval-actions).
  It embeds user inputs and response labels into the same space and follows the exact same
  neural network architecture and optimization as the [DIETClassifier](/docs/nlu/components#diet-classifier).
  ...
  `0.0`. This might happen if you only use the [CountVectorsFeaturizer](/docs/nlu/components#countvectorsfeaturizer) with a `word` analyzer
...
* **Configuration**
  ...
  The algorithm includes almost all the hyperparameters that [DIETClassifier](/docs/nlu/components#diet-classifier) uses.
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="diet-classifier"></a>
