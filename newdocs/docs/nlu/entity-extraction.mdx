...
some training data.
See [Training Data Format](/docs/nlu/training-data-format) for details on how to include entities in your training data.

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="entities-roles-groups"></a>
...
See [Training Data Format](/docs/nlu/training-data-format) for details on how to define entities with roles and groups in your training data.
...
:::note
Composite entities are currently only supported by the [DIETClassifier](/docs/nlu/components#diet-classifier) and [CRFEntityExtractor](/docs/nlu/components#crfentityextractor).
...
[Forms](/docs/core/forms) or use [Custom Actions](/docs/core/actions#custom-actions) to extract the corresponding entity directly from the tracker.
...
(see [DucklingHTTPExtractor](/docs/nlu/components#ducklinghttpextractor)).

## Regular Expressions (regex)

You can use regular expressions to help the CRF model learn to recognize entities.
In your training data (see [Training Data Format](/docs/nlu/training-data-format)) you can provide a list of regular expressions, each of which provides
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="entity-extraction-custom-features"></a>
