...
extracted by any [entity extractor](/docs/nlu/entity-extraction) in your
NLU pipeline.
...
[Slots](/docs/core/slots) hold information you want to keep track of during a conversation.
...
[Here](/docs/core/slots#slot-classes) you can find the full list of slot types defined by
Rasa Core, along with syntax for including them in your domain file.

[Actions](/docs/core/actions) are the things your bot can actually do.
...
see [Custom Actions](/docs/core/actions#custom-actions)).

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="domain-responses"></a>
...
For each response, you can have multiple **response variations** (see [Variations](/docs/core/domains#variations)).
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="variations"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="use-entities"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="session-config"></a>
...
[Customizing the session start action](/docs/api/rasa-sdk#custom-session-start) shows you how to do that.
