...
- SKIPPED CLASS DOCUMENTATION -You can also create your own custom action to use as a fallback (see
[custom actions](/docs/core/actions#custom-actions) for more info on custom actions). If you
...
The implementation of both actions can be overwritten with [custom actions](/docs/core/actions#custom-actions).
