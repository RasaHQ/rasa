...
or using the [Mapping Policy](/docs/core/policies#mapping-policy).
...
[trigger_intent endpoint](../../api/http-api/#operation/triggerConversationIntent) of your conversation.
