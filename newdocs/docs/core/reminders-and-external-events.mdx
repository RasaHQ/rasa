...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="reminders"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="scheduling-reminders-guide"></a>
...
We could make this connection by providing training stories (recommended for more complex assistants), or using the [Mapping Policy](/docs/core/policies#mapping-policy).
...
using the [CallbackInput](/docs/user-guide/connectors/your-own-website#callbackinput) channel to send messages to a [webhook](https://en.wikipedia.org/wiki/Webhook).

:::

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="cancelling-reminders-guide"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="external-event-guide"></a>
...
The easiest and most reliable way to connect this action with the intent is via the [Mapping Policy](/docs/core/policies#mapping-policy).

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="getting-conversation-id"></a>

### Getting the Conversation ID

The first thing we need is the Session ID of the conversation that your sensor should send a notification to.
An easy way to get this is to define a custom action (see [Custom Actions](/docs/core/actions#custom-actions)) that displays the ID in the conversation.
For example:
...
informs the Pi about the conversation id when your conversation starts (see [Customizing the session start action](/docs/api/rasa-sdk#custom-session-start)).

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="responding-to-external-events"></a>
