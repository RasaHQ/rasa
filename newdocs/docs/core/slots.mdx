...
(see details in [Domains](/docs/core/domains))
...
The second option is to set slots by returning events in [custom actions](/docs/core/actions#custom-actions).
...
[`rasa.core.events.SlotSet`](/docs/api/events#rasa.core.events.SlotSet) event:
...
stories using [Interactive Learning with Forms](/docs/core/interactive-learning#section-interactive-learning-forms) rather than writing them.

:::

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="slot-classes"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="unfeaturized-slot"></a>
