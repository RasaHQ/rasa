...
1. Responses are normally stored in your domain file, see [here](/docs/core/domains#domain-responses)

2. Retrieval action responses are part of the training data, see [here](/docs/core/retrieval-actions)

3. You can also create a custom NLG service to generate responses, see [here](/docs/core/responses#custom-nlg-service)

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="in-domain-responses"></a>
...
documentation about the domain file format: [Responses](/docs/core/domains#domain-responses).

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="custom-nlg-service"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="external-events"></a>
...
the Rasa examples directory or look into [Reminders and External Events](/docs/core/reminders-and-external-events).
