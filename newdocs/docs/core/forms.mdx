...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="section-unhappy"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="conditional-logic"></a>
