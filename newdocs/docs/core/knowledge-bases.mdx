...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="knowledge-base-actions"></a>
...
<img alt="image" src="../../img/knowledge-base-example.png" />
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="create-knowledge-base"></a>
...
(see [Creating Your Own Knowledge Base](/docs/core/knowledge-bases#custom-knowledge-base)).
...
If it doesn’t, you’ll have to [customize your InMemoryKnowledgeBase](/docs/core/knowledge-bases#customize-in-memory-knowledge-base).
...
* we will use [synonyms](/docs/nlu/training-data-format#entity-synonyms) extensively
...
* `object_type`: Whenever a training example references a specific object type from your knowledge base, the object type should
  be marked as an entity. Use [synonyms](/docs/nlu/training-data-format#entity-synonyms) to map e.g. `restaurants` to `restaurant`, the correct
...
* `mention`: If the user refers to an object via “the first one”, “that one”, or “it”, you should mark those terms
  ...
  in [resolving mentions](/docs/core/knowledge-bases#resolve-mentions).
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="create-action-query-knowledge-base"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="resolve-mentions"></a>
...
it is important that you use [Entity Synonyms](/docs/nlu/training-data-format#entity-synonyms) to map “the first one” in your NLU data to “1”:
...
`KnowledgeBase` implementation (see [Customizing the InMemoryKnowledgeBase](/docs/core/knowledge-bases#customize-in-memory-knowledge-base)).
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="customize-in-memory-knowledge-base"></a>
...
* `set_ordinal_mention_mapping()`: The ordinal mention mapping is needed to resolve an ordinal mention, such as
  ...
  If you want to learn more about how this mapping is used, check out [Resolve Mentions](/docs/core/knowledge-bases#resolve-mentions).
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="custom-knowledge-base"></a>
...
[Customizing the InMemoryKnowledgeBase](/docs/core/knowledge-bases#customize-in-memory-knowledge-base).
