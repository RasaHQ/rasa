...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="implicit-confirmation"></a>
...
```
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="explicit-confirmation"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="explaining-possibilities"></a>
