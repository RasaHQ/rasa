...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="simple-questions"></a>
...
```
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="unhappy-paths"></a>
