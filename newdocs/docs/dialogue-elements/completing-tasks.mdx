...
See [Greetings](/docs/dialogue-elements/small-talk#greetings).
...
```
See [Handling conditional slot logic](/docs/core/forms#conditional-logic) for details on how to use forms to implement business logic.
