...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="sql-tracker-store"></a>
...
* **Oracle Configuration**
  ...
  ```python
  docker build . -t rasa-oracle:1.11.0a3-oracle-full
  ```
  ...
  Read more about [Deploying Your Rasa Assistant](/docs/user-guide/how-to-deploy#deploying-your-rasa-assistant).


<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="redis-tracker-store"></a>
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="mongo-tracker-store"></a>
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="tracker-stores-dynamo"></a>
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="custom-tracker-store"></a>
