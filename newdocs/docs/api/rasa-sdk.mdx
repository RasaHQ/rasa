...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="custom-action-example"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="custom-session-start"></a>
...
the different types of events, see [Events](/docs/api/events). There is an example of a `SlotSet` event
[above](/docs/api/rasa-sdk#custom-action-example). The action itself will automatically be added to the
