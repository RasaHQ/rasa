...
sidebar_label: Training Data Importers
...
[TrainingDataImporter](/docs/api/training-data-importers#training-data-importers-trainingfileimporter):
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="training-data-importers-trainingfileimporter"></a>
