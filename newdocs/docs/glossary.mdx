...
[Entity](/docs/nlu/entity-extraction)
...
[Event](/docs/api/events)
  ...
  All conversations in Rasa are represented as a sequence of events. For instance, a `UserUttered` represents a user entering a message, and an `ActionExecuted` represents the assistant executing an action. You can learn more about them [here](/docs/api/events).

[Form](/docs/core/forms)
...
[Interactive Learning](/docs/core/interactive-learning)
...
[Rasa NLU](/docs/nlu/about#about-rasa-nlu)
...
[Pipeline](/docs/nlu/choosing-a-pipeline)
...
[Template / Response / Utterance](/docs/core/responses)
