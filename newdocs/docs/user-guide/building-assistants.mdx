---
id: building-assistants
sidebar_label: 'Tutorial: Building Assistants'
title: 'Tutorial: Building Assistants'
---
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="build-faq-assistant"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="respond-with-memoization-policy"></a>
...
can later be included as part of a [CI/CD system](/docs/user-guide/setting-up-ci-cd). End-to-end [test conversations](/docs/user-guide/testing-your-assistant#end-to-end-testing)
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="faqs-response-selector"></a>

### Response Selectors

The [ResponseSelector](/docs/nlu/components#response-selector) NLU component is designed to make it easier to handle dialogue
elements like [Small Talk](/docs/dialogue-elements/small-talk) and FAQ messages in a simple manner. By using the ResponseSelector,
...
When you’re ready to enhance your assistant with context, check out [Building a contextual assistant](/docs/user-guide/building-assistants#tutorial-contextual-assistants).
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="tutorial-contextual-assistants"></a>
...
* [Handling business logic](/docs/user-guide/building-assistants#handling-business-logic)

* [Handling unexpected user input](/docs/user-guide/building-assistants#handling-unexpected-user-input)

* [Failing gracefully](/docs/user-guide/building-assistants#failing-gracefully)

* [More complex contextual conversations](/docs/user-guide/building-assistants#more-complex-contextual-conversations)

Please make sure you’ve got all the data from the [Building a simple FAQ assistant](/docs/user-guide/building-assistants#build-faq-assistant) section before starting this part.
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="handling-business-logic"></a>
...
(e.g. [DucklingHTTPExtractor](/docs/nlu/components#ducklinghttpextractor) or [SpacyEntityExtractor](/docs/nlu/components#spacyentityextractor)), but for this tutorial
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="handling-unexpected-user-input"></a>
...
matter the context, you can use the [Mapping Policy](/docs/core/policies#mapping-policy) to handle these. It will always
...
<img alt="Greeting Interjection" src="../../img/greet_interjection.png" width="240" />
...
<img alt="Generic Interjections" src="../../img/generic_interjection.png" width="240" />
...
<img alt="Generic Interjection Handled" src="../../img/generic_interjection_handled.png" width="240" />
...
<img alt="Contextual Interjection" src="../../img/contextual_interjection.png" width="240" />
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="failing-gracefully"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="more-complex-contextual-conversations"></a>
