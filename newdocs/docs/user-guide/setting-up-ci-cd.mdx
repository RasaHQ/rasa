...
[Data validation](/docs/user-guide/validate-files) verifies that there are no mistakes or
...
Data validation includes [story structure validation](/docs/user-guide/validate-files#test-story-files-for-conflicts).
...
If it passes the CI tests, then you can also [upload the trained model](/docs/user-guide/setting-up-ci-cd#uploading-a-model)
to your server as part of the continuous deployment process .

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="test-the-assistant"></a>

### Test the Assistant

Testing your trained model on [test conversations](/docs/user-guide/testing-your-assistant#end-to-end-testing) is the best way to have confidence in how your assistant
...
[test your action code](/docs/user-guide/setting-up-ci-cd#testing-action-code) in a seperate step.
...
[full NLU evaluation](/docs/user-guide/testing-your-assistant#nlu-evaluation). You’ll want to compare
...
set approach, it is best to [shuffle and split your data](/docs/user-guide/command-line-interface#train-test-split) using `rasa data split` as part of this CI step, as
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="testing-action-code"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="uploading-a-model"></a>

### Deploy your Rasa Model

If you ran [end-to-end tests](/docs/user-guide/setting-up-ci-cd#test-the-assistant) in your CI pipeline,
...
You can automate
[building and uploading a new image for your action server](/docs/user-guide/how-to-deploy#building-an-action-server-image),
