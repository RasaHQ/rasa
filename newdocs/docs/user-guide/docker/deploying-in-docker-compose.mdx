...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="deploying-rasa-in-docker-compose"></a>

If you would like to deploy your assistant without Rasa X, you can do so by deploying it in Docker Compose.
To deploy Rasa X and your assistant together, see the [Recommended Deployment Methods](/docs/user-guide/how-to-deploy#recommended-deployment-methods).
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="docker-compose-configuring-channels"></a>

## Configuring Channels

To run your AI assistant in production, don’t forget to configure your required
[Messaging and Voice Channels](/docs/user-guide/messaging-and-voice-channels) in `credentials.yml`. For example, to add a
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="running-multiple-services"></a>
...
an action server image, see [Building an Action Server Image](/docs/user-guide/how-to-deploy#building-an-action-server-image).
...
corresponds to a [configured channel](/docs/user-guide/docker/deploying-in-docker-compose#docker-compose-configuring-channels):
...
[Tracker Store](/docs/api/tracker-stores).
...
* [RedisTrackerStore](/docs/api/tracker-stores#redis-tracker-store)

* [MongoTrackerStore](/docs/api/tracker-stores#mongo-tracker-store)

* [Custom Tracker Store](/docs/api/tracker-stores#custom-tracker-store)
