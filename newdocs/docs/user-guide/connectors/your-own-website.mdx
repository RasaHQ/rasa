...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="rest-channels"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="callbackinput"></a>
