...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="end-to-end-testing"></a>
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="nlu-evaluation"></a>
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="comparing-nlu-pipelines"></a>
...
<a aria-hidden="true" tabIndex="-1" className="anchor enhancedAnchor" id="core-evaluation"></a>
