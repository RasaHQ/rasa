...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="end-to-end-testing"></a>
...
:::note
[Custom Actions](/docs/core/actions#custom-actions) are not executed as part of end-to-end tests. If your custom
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="nlu-evaluation"></a>

## Evaluating an NLU Model

A standard technique in machine learning is to keep some data separate as a *test set*.
You can [split your NLU training data](/docs/user-guide/command-line-interface#train-test-split)
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="comparing-nlu-pipelines"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="core-evaluation"></a>
