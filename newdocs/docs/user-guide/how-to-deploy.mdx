...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="deploying-your-rasa-assistant"></a>
...
Then, when you’re ready to make your assistant available via one or more [Messaging and Voice Channels](/docs/user-guide/messaging-and-voice-channels),
you can easily add them to your existing deployment set up.

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="recommended-deployment-methods"></a>
...
<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="rasa-only-deployment"></a>
...
* [Building a Rasa Assistant Locally](/docs/user-guide/rasa-tutorial)

* [Building a Rasa Assistant in Docker](/docs/user-guide/docker/building-in-docker)

* [Deploying a Rasa Open Source Assistant in Docker Compose](/docs/user-guide/docker/deploying-in-docker-compose)


## Deploying Your Action Server

<a aria-hidden="true" tabindex="-1" class="anchor enhancedAnchor" id="building-an-action-server-image"></a>
...
* [Rasa Open Source Only](/docs/user-guide/docker/deploying-in-docker-compose#running-multiple-services)
