...
test: clean
	...
	OMP_NUM_THREADS=1 TF_CPP_MIN_LOG_LEVEL=2 poetry run pytest tests -k test_train_persist_load_with_composite_entities -n $(JOBS) --cov rasa --ignore $(INTEGRATION_TEST_FOLDER)
