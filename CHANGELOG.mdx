...
- [#9782](https://github.com/rasahq/rasa/issues/9782): Updates [quick install documentation](./installation/rasa-open-source/quick-installation.mdx) with optional venv step, better pip install instructions, & M1 warning
