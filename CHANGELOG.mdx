...
### Features
- [#8685](https://github.com/rasahq/rasa/issues/8685): Added `sasl_mechanism`, `sasl_kerberos_domain_name`, and `sasl_kerberos_service_name` as optional configurable parameters for the Kafka Producer.
