...
- [#6323](https://github.com/rasahq/rasa/issues/6323): [Response selector templates](retrieval-actions.mdx) now support all features that 
...
- [#6466](https://github.com/rasahq/rasa/issues/6466): [Response Selectors](retrieval-actions.mdx) are now trained on retrieval intent labels by default instead of the actual response text. For most models, this should improve training time and accuracy of the `ResponseSelector`.
...
- [#5784](https://github.com/rasahq/rasa/issues/5784), [#5788](https://github.com/rasahq/rasa/issues/5788), [#6199](https://github.com/rasahq/rasa/issues/6199)
