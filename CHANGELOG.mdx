...
* [#3765](https://github.com/rasahq/rasa/issues/3765): Add support for entities with roles and grouping of entities in Rasa NLU.
  ...
  :::note
  Composite entities are currently just supported by the [DIETClassifier](././components.mdx#crfentityextractor).
...
* [#5187](https://github.com/rasahq/rasa/issues/5187): Integrate language models from HuggingFace's [Transformers](https://github.com/huggingface/transformers) Library.
  ...
  Add [LanguageModelTokenizer](././components.mdx#languagemodelfeaturizer) which use the information from
...
* [#5266](https://github.com/rasahq/rasa/issues/5266): Added a new NLU component [DIETClassifier](././components.mdx#ted-policy).
