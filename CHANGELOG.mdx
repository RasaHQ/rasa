...
* [#5187](https://github.com/rasahq/rasa/issues/5187): Integrate language models from HuggingFace's [Transformers](https://github.com/huggingface/transformers) Library.
  ...
  Add [LanguageModelTokenizer](./components.mdx#languagemodelfeaturizer) which uses the information from
...
* [#5266](https://github.com/rasahq/rasa/issues/5266): Added a new NLU component [DIETClassifier](./components.mdx#dietclassifier) and a new policy [TEDPolicy](./components.mdx#ted-policy).
