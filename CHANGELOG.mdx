...
- [#8913](https://github.com/rasahq/rasa/issues/8913): Introduces a new policy called [`UnexpecTEDIntentPolicy`](./nlu-based-assistants/policies.mdx#unexpected-intent-policy).
  ...
  [`action_unlikely_intent`](./concepts/default-actions.mdx#action_unlikely_intent) action.
  ...
  - A new default action called [`action_unlikely_intent`](./concepts/default-actions.mdx#action_unlikely_intent).
